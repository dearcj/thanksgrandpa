...
function OpenInNewTab(a){window.open(a,"_blank").focus()}function clone(a){return JSON.parse(JSON.stringify(a))}function sqlDate(a){return a.getUTCFullYear()+"-"+("00"+(a.getUTCMonth()+1)).slice(-2)+"-"+("00"+a.getUTCDate()).slice(-2)+" "+("00"+a.getUTCHours()).slice(-2)+":"+("00"+a.getUTCMinutes()).slice(-2)+":"+("00"+a.getUTCSeconds()).slice(-2)}function superRand(a){for(var b=0,c=0;c<a;++c)b+=Math.random();return b/a}
...
null,null,{id:c.id,equipped:!0},function(a){console.log("SCORE UPDATED "+a);a&&a.crystals&&a.money&&(PlayerData.inst.playerItem.crystals=a.crystals,PlayerData.inst.playerItem.money=a.money,PlayerData.inst.items_enabled.push({id_item:c.id,id_player:PlayerData.inst.playerItem.id}),shopStage.updateStatsPanel(),PlayerData.inst.equipItem(c,!0),shopStage.pl.updateAppearence(!0,!1,null,null,null),shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos),shopStage.updateStatsPanel());
shopStage.transScreen.parent.removeChild(shopStage.transScreen);shopStage.transScreen=null})):charStage.openPremiumWindow()};
ShopStage.prototype.createItemBtn=function(a){function b(b){PlayerData.inst.equipItem(a,!1);shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos)}function c(a){shopStage.buyItem(a,!0)}function d(b){PlayerData.inst.equipItem(a,!0);shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos)}function e(a){shopStage.buyItem(a,!1)}var f=new PIXI.DisplayObjectContainer,
...
ShopStage.prototype.updateEnergyText=function(){var a=CObj.getById("tfdelay");if(a&&1>PlayerData.inst.playerItem.energy){if(Math.round(PlayerData.inst.playerItem.energy)<Math.round(PlayerData.inst.maxEnergy)){var b=dateDiff(new Date(PlayerData.inst.playerItem.updateDate),1/PlayerData.inst.epm*(1-PlayerData.inst.playerItem.energy),!0);0>b.d&&(a.text="");a.text=b.timeString}else a.text="";a.gfx.visible=!0}else a.gfx.visible=!1};ShopStage.prototype.process=function(){this.updateEnergyText();CObj.processAll()};
function ComixStage(){CustomStage.apply(this)}extend(ComixStage,CustomStage);
...
CPlayer.prototype.updateAppearence=function(a,b,c,d,e,f){c&&this.gfx.state.setAnimationByName(0,c,!0);b?this.gfx.skeleton.setAttachment("board","board"):this.gfx.skeleton.setAttachment("board",null);b=null;c="gun0";if(a)for(a=0;a<PlayerData.inst.items_enabled.length;++a){if(PlayerData.inst.items_enabled[a].equipped){var g=PlayerData.inst.getItemById(PlayerData.inst.items_enabled[a].id_item);g.type==tApp+tHat&&(b=g.gfx);g.type==tWeapon&&(c=g.gfx)}}else this.gfx.skeleton.setAttachment("gun",null);d&&
(c=d);this.gfx.skeleton.setAttachment("gun",c);e&&(b=e);this.gfx.skeleton.setAttachment("hat",b);f&&this.gfx.skeleton.setAttachment("head",f)};
...
xp:22E3},{crystals:3,money:3E3,xp:23E3},{crystals:3,money:3E3,xp:24E3},{crystals:3,money:3E3,xp:25E3},{crystals:3,money:3E3,xp:26E3},{crystals:3,money:3E3,xp:27E3},{crystals:3,money:3E3,xp:28E3},{crystals:3,money:3E3,xp:29E3},{crystals:3,money:3E3,xp:31E3},{crystals:3,money:3E3,xp:32E3},{crystals:3,money:3E3,xp:33E3},{crystals:3,money:3E3,xp:34E3},{crystals:3,money:3E3,xp:35E3}];this.items={};this.achs={};this.score=0;PlayerData.inst=this;PlayerData.inst.login();window.onbeforeunload=function(a){PlayerData.inst.updateEnergy(!0);
PlayerData.inst.saveRunProgress(!0);PlayerData.inst.savePlayerItems();PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=a.rank;PlayerData.inst.savePlayerData()});PlayerData.inst.savePlayerData()}};PlayerData.prototype.addNotification=function(a,b){};
PlayerData.prototype.comboCheck=function(){if(this.playerItem.combodate){var a=(new Date).getTime()-(new Date(this.playerItem.updateDate)).getTime(),a=a/1E3/60;1740<a?this.playerItem.combodate=(new Date).toString():(a=(new Date).getTime()-this.playerItem.combodate,a/=1E3,a/=60,4320<a&&this.progressAch("Gold medal 8",1,!1),14400<a&&this.progressAch("Gold medal 9",1,!1))}else this.playerItem.combodate=this.playerItem.updateDate};
...
PlayerData.prototype.updateEnergy=function(a){this.playerItem&&(a=new Date(this.playerItem.updateDate),a=(new Date).getTime()-a.getTime(),this.playerItem.updateDate=sqlDate(new Date),a=a/1E3/60,0<a&&(this.playerItem.energy+=a*this.epm,console.log(this.playerItem.energy),this.playerItem.energy>this.maxEnergy&&(this.playerItem.energy=this.maxEnergy),0>this.playerItem.energy&&(this.playerItem.energy=0)),SM.inst.currentStage!=charStage&&SM.inst.currentStage!=shopStage||shopStage.updateStatsPanel(),setTimeout(function(){PlayerData.inst.updateEnergy()},
PlayerData.inst.delayEnergyMS))};PlayerData.prototype.createAchProgress=function(a){for(a=0;a<this.achs.length;++a){for(var b=!1,c=0;c<this.achs_progress.length;++c)if(this.achs[a].id==this.achs_progress[c].id_ach){b=!0;break}b||this.achs_progress.push({id_ach:this.achs[a].id,id_player:this.playerItem.id,progress:0})}};incMetric=function(a){};PlayerData.prototype.getEventById=function(a){for(var b=0;b<this.events.length;++b)if(this.events[b].id==a)return this.events[b];return null};
...
PlayerData.dbInit=function(){console.log("dbInit start. Connecting to azure");window.vkparams={};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&(vkparams.viewerid=vkparams.viewerid.toString());if(!vkparams.viewerid||!VK)vkparams.viewerid="2882845",MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0;else if("282617259"!=vkparams.viewerid)return;vkparams.gamerid=vkparams.userid||vkparams.viewerid;
vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");new PlayerData};
