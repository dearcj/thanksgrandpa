var CG_GROUND=1,CG_MONSTER=2,CG_PLAYER=4,CG_BULLET=8;function noc(a,b){a.click=null;a.tap=null}function onc(a,b){a.click=b;a.tap=b}function extractName(a){return a.name?(a.name+" "+a.last_name).substring(0,16):"\u0410\u043d\u043e\u043d\u0438\u043c"}function findByProp(a,b,c){for(var d=a.length,e=0;e<d;++e)if(a[e][b]==c)return a[e];return null}function getRand(a){return a[Math.floor(Math.random()*a.length)]}function OpenInNewTab(a){window.open(a,"_blank").focus()}
function clone(a){return JSON.parse(JSON.stringify(a))}function superRand(a){for(var b=0,c=0;c<a;++c)b+=Math.random();return b/a}function dateDiff(a,b,c){a=(new Date).getTime()-a.getTime();a=(6E4*b-a)/1E3;b=Math.floor(a/3600);a%=3600;var d=Math.floor(a/60);a%=60;var e=Math.floor(a%60);c=(c?"":(10>b?"0"+b:b)+" : ")+((10>d?"0"+d:d)+" : "+(10>e?"0"+e:e));return{d:a,m:d,h:b,s:e,timeString:c}}
...
a.rank;PlayerData.inst.savePlayerData()});PlayerData.inst.saveRunProgress();CObj.getById("bshare").click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b "+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432.\nhttps://vk.com/app4654201",attachments:["photo-90523698_359515843","https://vk.com/app4654201"]},function(a){})};for(c=0;5>c;++c)a(c);azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:5,skip:scoreStage.skip},
method:"post"}).done(function(a){a=a.result;for(var c=0;c<Math.min(5,a.length);++c)CObj.getById("tf"+(c+1).toString()+"2").text=extractName(a[c]),CObj.getById("tf"+(c+1).toString()+"3").text=a[c].maxdistance.toString(),b>a[c].maxdistance&&(CObj.getById("b"+(c+1).toString()).gfx.visible=!0,CObj.getById("b"+(c+1).toString()).text="\u042f \u0442\u0435\u0431\u044f \u0443\u0434\u0435\u043b\u0430\u043b",function(a,c){CObj.getById("b"+(a+1).toString()).click=function(){VK.api("wall.post",{owner_id:c.platformid,
message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b "+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432. *id"+c.platformid+"("+c.name+") "+c.last_name+",  \u043d\u0438\u043a\u043e\u0433\u0434\u0430 \u043d\u0435 \u043f\u043e\u0431\u044c\u0435\u0448\u044c \u043c\u043e\u0439 \u0440\u0435\u043a\u043e\u0440\u0434!!\nhttps://vk.com/app4654201",attachments:["photo-90523698_359515827","https://vk.com/app4654201"]},function(a){})}}(c,a[c]));for(a=c;5>a;++a)CObj.getById("b"+(a+1).toString()).gfx.visible=
!0,CObj.getById("b"+(a+1).toString()).text="\u041f\u0440\u0438\u0433\u043b\u0430\u0441\u0438\u0442\u044c \u0432 \u0438\u0433\u0440\u0443",CObj.getById("b"+(a+1).toString()).click=function(){VK.callMethod("showInviteBox")}},function(a){})};GameStage.prototype.sessionEnd=function(){"game"==gameStage.state&&(gameStage.state="endsession",gameStage.pause(),gameStage.fadeScreen(),gameStage.shAfterLife(),incMetric("DIED on pattern="+MM.inst.patterns[MM.inst.currentPattern.pid].mons))};
...
ShopStage.prototype.buyItem=function(a,b){var c=a.target.btn.item;!b&&0<c.price&&PlayerData.inst.playerItem.money>=c.price||b&&0<c.pricecrys&&PlayerData.inst.playerItem.crystals>=c.pricecrys?(shopStage.transScreen=SM.inst.addDisableWindow("\u041f\u0420\u041e\u0412\u041e\u0414\u0418\u0422\u0421\u042f \u0422\u0420\u0410\u041d\u0417\u0410\u041a\u0426\u0418\u042f\n\u041f\u041e\u0416\u0410\u041b\u0423\u0419\u0421\u0422\u0410 \u041f\u041e\u0414\u041e\u0416\u0414\u0418\u0422\u0415"),ZSound.Play("buy"),azureclient.invokeApi("buy_item",
{body:{id_item:c.id,id_player:PlayerData.inst.playerItem.id},method:"post"}).done(function(a){incMetric("BUY ITEM"+c.name);b&&0<c.pricecrys?PlayerData.inst.playerItem.crystals-=c.pricecrys:PlayerData.inst.playerItem.money-=c.price;PlayerData.inst.items_enabled.push({id_item:c.id,id_player:PlayerData.inst.playerItem.id});shopStage.updateStatsPanel();PlayerData.inst.equipItem(c,!0);shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos);
shopStage.updateStatsPanel();shopStage.transScreen.parent.removeChild(shopStage.transScreen);shopStage.transScreen=null;PlayerData.inst.savePlayerData()})):charStage.openPremiumWindow()};
...
function ScoreStage(){CustomStage.apply(this)}extend(ScoreStage,CustomStage);ScoreStage.prototype.updateFriends=function(){PlayerData.inst.savePlayerData();azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:scoreStage.showRecords,skip:scoreStage.skip},method:"post"}).done(function(a){scoreStage.updateSB(a.result)},function(a){})};
...
h=crsp("buy small button");b.push(h);b[d].platformid=a[d].platformid;""!=c&&(c+=",");c+=a[d].platformid;if(3>scoreStage.skip+d){var l;0==scoreStage.skip+d&&(l="1st place");1==scoreStage.skip+d&&(l="2nd place");2==scoreStage.skip+d&&(l="3rd place");var m=crsp(l);m.x=4;m.y=10;m.scale.x=.8;m.scale.y=.8;e.addChild(m)}h.y=10;h.x=35;e.x=20;e.y=15+28*d;g.x=55;k.x=370;e.addChild(h);e.addChild(g);e.addChild(f);e.addChild(k);scoreStage.container.addChild(e)}VK&&""!=c&&VK.api("users.get",{user_ids:c,fields:"photo"},
function(a){for(var c=0;c<a.response.length;++c){var d=a.response[c].photo;if(!a.response||0==a.response.length)break;var e=b[c];e.loader=new PIXI.ImageLoader(d);(function(a,b){a.loader.onLoaded=function(){var c=new PIXI.Sprite(PIXI.TextureCache[b]);c.scale.x=.5;c.scale.y=.5;c.anchor.x=.5;c.anchor.y=.5;a.addChild(c)}})(e,d);e.loader.load()}})};
...
.1,!1);this.btnReward.destroy();this.btnReward=null;PlayerData.inst.savePlayerEvents(this.eventpl);shopStage.updateStatsPanel();this.acting=!1};CEActionGUI.prototype.endAction=function(){this.progressbg.visible=!1;this.acting=this.progressfore.visible=!1;this.eventpl.reward_ready=!0;PlayerData.inst.savePlayerEvents(this.eventpl);this.addRewardButton()};
...
.6,{y:h+.05,ease:Elastic.easeOut});new TweenMax(g.scale,.4,{x:k+.05,ease:Elastic.easeOut})};g.mouseout=function(){new TweenMax(g.scale,.6,{y:h,ease:Elastic.easeOut});new TweenMax(g.scale,.4,{x:k,ease:Elastic.easeOut})};onc(g,function(){f.ready&&!a.reward_ready&&f.startAction()});this.progressbg.interactive=!0;onc(this.progressbg,this.onclick);null==this.eventpl.lastused&&(this.pos=1);c=CTextField.createTextField({fontFamily:"dedgamedesc",tint:"0x1111111",text:b.desc,fontSize:20,align:"center"});c.x=
50;c.y=-55;this.gfx.addChild(c);this.eventpl.reward_ready&&this.addRewardButton();this.progressbg.visible=!1;this.progressfore.visible=!1};
...
xp:22E3},{crystals:3,money:3E3,xp:23E3},{crystals:3,money:3E3,xp:24E3},{crystals:3,money:3E3,xp:25E3},{crystals:3,money:3E3,xp:26E3},{crystals:3,money:3E3,xp:27E3},{crystals:3,money:3E3,xp:28E3},{crystals:3,money:3E3,xp:29E3},{crystals:3,money:3E3,xp:31E3},{crystals:3,money:3E3,xp:32E3},{crystals:3,money:3E3,xp:33E3},{crystals:3,money:3E3,xp:34E3},{crystals:3,money:3E3,xp:35E3}];this.items={};this.achs={};this.score=0;PlayerData.inst=this;PlayerData.inst.azureLogin();window.onbeforeunload=function(a){PlayerData.inst.updateEnergy(!0);
PlayerData.inst.saveRunProgress(!0);PlayerData.inst.savePlayerItems();PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=a.rank;PlayerData.inst.savePlayerData()});PlayerData.inst.savePlayerData()}};PlayerData.prototype.addNotification=function(a,b){window.azureclient.getTable("tb_notifications").insert({message:a,platformid:b})};
...
PlayerData.prototype.updateScore=function(a){azureclient.invokeApi("update_score",{body:{id_player:PlayerData.inst.playerItem.id,score:PlayerData.inst.playerItem.maxdistance},method:"post"}).done(function(b){a&&a(JSON.parse(b.response))})};
PlayerData.prototype.loadData=function(a){checkDb();this.loadCount=0;console.log("PlayerData.loadData");PlayerData.inst.events=JSON.parse(eventsVar);PlayerData.inst.loadCount++;PlayerData.inst.achs=JSON.parse(achsVar);PlayerData.inst.loadCount++;PlayerData.inst.items=JSON.parse(itemsVar);PlayerData.inst.loadCount++;window.azureclient.getTable("tb_ach_player").read().done(function(b){PlayerData.inst.achs_progress=b;PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_item_player").read().done(function(b){PlayerData.inst.items_enabled=
b;for(var c=b=!1,d=-1,e=0;e<PlayerData.inst.items_enabled.length;++e)"68AFAEDC-B3E0-401E-9E1A-E272084F2E11"==PlayerData.inst.items_enabled[e].id_item&&(d=e,b=!0),PlayerData.inst.items_enabled[e].equipped&&(c=!0);!c&&b&&(PlayerData.inst.items_enabled[d].equipped=!0);b||(c=!0,0<PlayerData.inst.items_enabled.length&&(c=!1),PlayerData.inst.items_enabled.push({id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.inst.pid,equipped:c}));PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&
a&&a()},function(a){});window.azureclient.getTable("tb_edevent_player").read().done(function(b){PlayerData.inst.eventsplayer=b;PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){})};PlayerData.prototype.saveAllData=function(){this.savePlayerData();this.savePlayerItems();this.savePlayerEvents();this.savePlayerAchs()};
...
PlayerData.prototype.savePlayerItems=function(a){for(var b=0;b<this.items_enabled.length;++b)a&&a.id!=PlayerData.inst.items_enabled[b].id||window.azureclient.getTable("tb_item_player").update(PlayerData.inst.items_enabled[b]).done(function(a){},function(a){})};PlayerData.prototype.savePlayerData=function(a){window.azureclient.getTable("tb_players").update(this.playerItem).done(function(b){PlayerData.inst.playerItem=b;console.log("DATA SAVED");a&&a()},function(b){PlayerData.inst.savePlayerData(a)})};
...
PlayerData.prototype.getVKfriends=function(){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";console.log("Gettin vk friends");vkparams.friendsids=[];vkparams.friendsIngameIDs=[];vkparams.novk?"?lhst=1922"==window.location.search&&this.loadData(this.loadEnd):VK.api("friends.getAppUsers",{},function(a){vkparams.friendsIngameIDs=[];if(a.response&&a.response.length){a=a.response;for(var b=0;b<a.length;++b)vkparams.friendsIngameIDs.push(a[b].toString());0<vkparams.friendsIngameIDs.length?
azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:15},method:"post"}).done(function(a){vkparams.friendsIngame=a.result;vkparams.friendsIngameIDs=[];if(a.result){for(var b=0;b<a.result.length;++b)vkparams.friendsIngameIDs.push(a.result[b].platformid.toString());PlayerData.inst.getVKuserData()}},function(a){PlayerData.inst.getVKuserData()}):PlayerData.inst.getVKuserData()}else PlayerData.inst.getVKuserData()})};
PlayerData.prototype.azureLogin=function(){console.log("LOGIN VK USER ID = "+vkparams.viewerid.toString());azureclient.invokeApi("login",{body:{platformid:vkparams.viewerid,ref:vkparams.refferer},method:"post"}).done(function(a){console.log(JSON.stringify(a.result));vkparams.registered=a.result.registered;vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.result.userId.split(":")[1];PlayerData.inst.playerItem=a.result.playerItem;PlayerData.inst.playerItem.crystals||
(PlayerData.inst.playerItem.crystals=0);console.log("Player item read from login"+JSON.stringify(PlayerData.inst.playerItem));azureclient.currentUser={userId:a.result.userId,mobileServiceAuthenticationToken:a.result.token};vkparams.id=PlayerData.inst.playerItem.id;PlayerData.inst.getVKfriends()},function(a){PlayerData.inst.azureLogin()})};
PlayerData.dbInit=function(){console.log("dbInit start. Connecting to azure");window.azureclient=new WindowsAzure.MobileServiceClient("https://thanksdad.azure-mobile.net/","DRoaNHnoaCjxrhkbpOzHxGEHOFgGLS75");window.vkparams={};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&(vkparams.viewerid=vkparams.viewerid.toString());vkparams.viewerid&&VK||(vkparams.viewerid="CARLAPA2882845ww",MOBILE&&(vkparams.viewerid=
Cocoon.Device.getDeviceId()),vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");new PlayerData};
