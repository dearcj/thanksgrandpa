...
!vkparams.friendsIngame||e>=vkparams.friendsIngame.length?g.click=function(){VK.callMethod("showInviteBox")}:(function(a,b,c){console.log(a.toString()+" / "+b.toString());c.click=function(){VK.api("wall.post",{owner_id:b,message:a+", \u0432\u043e\u0437\u0432\u0440\u0430\u0449\u0430\u0439\u0441\u044f \u0432 \u0438\u0433\u0440\u0443, \u0434\u0440\u0443\u0436\u0438\u0449\u0435\nhttps://vk.com/app4654201",attachments:["photo282617259_360326325","https://vk.com/app4654201"]},function(a){})}}(vkparams.friendsIngame[e].name,
vkparams.friendsIngame[e].vkapi,g),""!=b&&(b+=","),b+=vkparams.friendsIngame[e].vkapi.toString(),g.vkapi=vkparams.friendsIngame[e].vkapi,c.push(g))}VK&&""!=b&&VK.api("users.get",{user_ids:b,fields:"photo"},function(a){if(a.response)for(var b=0;b<a.response.length;++b){var d=a.response[b].photo;if(!a.response||0==a.response.length)break;var e=c[b];e.loader=new PIXI.ImageLoader(d);(function(a,b){a.loader.onLoaded=function(){var c=new PIXI.Sprite(PIXI.TextureCache[b]);c.anchor.x=.5;c.anchor.y=.5;a.addChild(c);
charStage.icons.push(c)}})(e,d);e.loader.load()}});a.x=215;a.y=SCR_HEIGHT-50;SM.inst.guiLayer.addChild(a);return a};
