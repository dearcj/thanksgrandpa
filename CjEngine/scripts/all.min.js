...
uploadPhoto=function(a,b){var c=getDedImage(b),c=c.replace(/^data:image\/(png|jpg);base64,/,"");VK.api(b?"photos.getProfileUploadServer":"photos.getWallUploadServer",{uid:a},function(a){a=a.response.upload_url;getParameterByName("hash",a);getParameterByName("rhash",a);$.ajax({type:"POST",url:"upload.php",data:{uploadUrl:a,photo:c},dataType:"text"}).success(function(a){a=JSON.parse(a);b?VK.api("photos.saveProfilePhoto",{server:a.server,photo:a.photo,hash:a.hash},function(a){console.log("SSS")},function(a){console.log("SSS")}):
VK.api("photos.saveWallPhoto",{uid:vkparams.viewerid,server:a.server,photo:a.photo,hash:a.hash},function(a){a.response&&VK.api("wall.post",{owner_id:vkparams.viewerid,message:"\u0421\u043f\u0430\u0441\u0438\u0431\u043e \u0434\u0435\u0434\u0443 \u0437\u0430 \u0441\u0435\u043b\u0444\u0438",attachments:a.response[0].id},function(a){console.log("SSS")},function(a){console.log("SSS")})});console.log("")}).error(function(a){console.log("")})})};
