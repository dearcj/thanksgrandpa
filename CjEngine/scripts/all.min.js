...
CharStage.prototype.updateMusicButton=function(a){ZSound.available?a.gfx.gotoAndStop(0):a.gfx.gotoAndStop(1);localStorage.sound_state=ZSound.available;a.click=function(){ZSound.available?ZSound.Mute():ZSound.UnMute();ZSound.available?a.gfx.gotoAndStop(0):a.gfx.gotoAndStop(1)}};
...
PlayerData.prototype.saveRunProgress=function(a){if(SM.inst.currentStage==gameStage&&!gameStage.progressSaved){var b=Math.round(PlayerData.inst.playerItem.maxdistance);LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(b=Math.round(LauncherBG.inst.distance));gameStage.progressSaved=!0;PlayerData.inst.playerItem.money+=Math.round(PlayerData.inst.score);PlayerData.inst.playerItem.maxdistance=b;null==a&&PlayerData.inst.savePlayerData();PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=parseInt(a.rank);
