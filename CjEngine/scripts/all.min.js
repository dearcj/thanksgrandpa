...
CObj.getById("tfprev").text=Math.round(LauncherBG.inst.distance).toString()+" \u043c";var b=Math.round(PlayerData.inst.playerItem.maxdistance);LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(b=Math.round(LauncherBG.inst.distance));CObj.getById("tfrec").text=b.toString()+" \u043c";CObj.getById("bmenu").click=function(){gameStage.doProcess=!0;SM.inst.openStage(charStage)};for(var c=1;5>=c;++c)CObj.getById("b"+c.toString()).gfx.visible=!1,CObj.getById("b"+c.toString()).text="";PlayerData.inst.saveRunProgress(!0);
PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=a.rank});PlayerData.inst.savePlayerData();CObj.getById("bshare").click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b "+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432.\nhttps://vk.com/app4654201",attachments:["photo-90523698_359515843","https://vk.com/app4654201"]},function(a){})};for(c=0;5>c;++c)a(c);azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,
...
{owner_id:c.platformid,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b "+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432. *id"+c.platformid+"("+c.name+") "+c.last_name+",  \u043d\u0438\u043a\u043e\u0433\u0434\u0430 \u043d\u0435 \u043f\u043e\u0431\u044c\u0435\u0448\u044c \u043c\u043e\u0439 \u0440\u0435\u043a\u043e\u0440\u0434!!\nhttps://vk.com/app4654201",attachments:["photo-90523698_359515827","https://vk.com/app4654201"]},function(a){})}}(c,a[c]));for(a=c;5>a;++a)CObj.getById("b"+
