...
incMetric("ACH GAINED "+this.achs[d].name));return a};PlayerData.prototype.loadEnd=function(){for(var a=!1,b=0;b<PlayerData.inst.items.length;++b)if(PlayerData.inst.items[b].type==tWeapon){var c;a:{for(c=0;c<PlayerData.inst.items_enabled.length;++c)if(PlayerData.inst.items_enabled[c].id_item==PlayerData.inst.items[b].id){c=PlayerData.inst.items_enabled[c];break a}c=void 0}if(c&&"1"==c.equipped){a=!0;break}}a||PlayerData.inst.equipItem(PlayerData.inst.baseWeapIt,"1");window.dbinit=!0;onAssetsLoaded()};
