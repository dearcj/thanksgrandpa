...
vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");var a=getCookie("LOGIN_DATA"),a=a.substring(3,a.length);JSON.parse(a);window.onbeforeunload=function(a){}}};PlayerData.prototype.addNotification=function(a,b){};
