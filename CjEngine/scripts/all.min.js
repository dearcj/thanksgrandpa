...
uploadPhoto=function(a){VK.api("photos.getWallUploadServer",{uid:a},function(a){console.log("GET WALL UPLOAD SERV")},function(a){console.log("ERROR GET WALL UPLOAD SERV")})};PauseTimer=function(){};PauseTimer.paused=!1;PauseTimer.pauseStartedAt=0;PauseTimer.totalPauseTime=0;PauseTimer.getTimer=function(){return window.time-PauseTimer.totalPauseTime};PauseTimer.isPaused=function(){return PauseTimer.paused};
PauseTimer.pause=function(){PauseTimer.pauseStartedAt=PauseTimer.getTimer();TweenMax.pauseAll();PauseTimer.paused=!0};PauseTimer.resume=function(){PauseTimer.paused&&(PauseTimer.totalPauseTime+=window.time-PauseTimer.pauseStartedAt,TweenMax.resumeAll(),PauseTimer.paused=!1)};var loadingState="prepreload";window.openSponsorWindow=null;window.focus();var assetsLoaded=0,preloaderAsset=["preloader.png"];window.loader=new PIXI.AssetLoader(preloaderAsset);window.loader.onComplete=preloaderLoaded;window.loader.load();
dbInit();window.addScale=1;window.SCR_WIDTH=800;window.SCR_HEIGHT=600;window.SCR_SCALE=1;window.FRAME_RATE=60;window.renderer=new PIXI.autoDetectRenderer(SCR_WIDTH,SCR_HEIGHT);$(document).bind("contextmenu",function(){return!1});VK.init({apiId:4654201},function(){console.log("INIT OK")},function(){console.log("INIT FAILED")},"5.27");function order(a){var b={type:"item",item:a};window.currentOrder=a;VK.callMethod("showOrderBox",b)}
