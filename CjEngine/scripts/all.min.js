...
CharStage.prototype.onShowContinue=function(){PlayerData.inst.comboCheck();PlayerData.inst.checkItemAchs();3<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 26",1,!1);5<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 27",1,!1);10<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 28",1,!1);15<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 29",1,!1);20<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 30",1,!1);charStage.doProcess=
!0;charStage.updateNotifications();charStage.skip=0;charStage.tab="total";charStage.showRecords=10;PlayerData.inst.eventsplayer.sort(function(a,c){return PlayerData.inst.getEventById(a.id_edevent).reqlvl-PlayerData.inst.getEventById(c.id_edevent).reqlvl});MOBILE||(CObj.getById("frprev").click=function(){charStage.skipFriends-=5;0>charStage.skipFriends&&(charStage.skipFriends=0);charStage.frp.parent.removeChild(charStage.frp);charStage.frp=charStage.createFriendsPanel()},CObj.getById("frnext").click=
function(){charStage.skipFriends+=5;charStage.frp.parent.removeChild(charStage.frp);charStage.frp=charStage.createFriendsPanel()});MOBILE?(CObj.getById("bshop").deltaHoverY=46,CObj.getById("bsofa").deltaHoverY=30):CObj.getById("btnachs").deltaHoverY=15;CObj.getById("bbuy1").click=charStage.openPremiumWindow;CObj.getById("bbuy2").click=charStage.openPremiumWindow;CObj.getById("tname").text=vkparams.first_name.toUpperCase()+" "+vkparams.last_name.toUpperCase();CObj.getById("bpubl").click=function(){OpenInNewTab("https://vk.com/thanksgrandpa")};
