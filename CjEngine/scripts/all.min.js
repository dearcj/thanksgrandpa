...
ShopStage.prototype.process=function(){shopStage.updateStatsPanel();this.updateEnergyText();CObj.processAll()};function ScoreStage(){CustomStage.apply(this)}extend(ScoreStage,CustomStage);ScoreStage.prototype.updateFriends=function(){PlayerData.inst.savePlayerData();azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:scoreStage.showRecords,skip:scoreStage.skip},method:"post"}).done(function(a){scoreStage.updateSB(a.result)},function(a){})};
