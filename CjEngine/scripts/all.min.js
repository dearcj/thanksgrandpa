...
function onAssetsLoaded(){if(window.dbinit&&1==ZSound.loaded&&window.gfxLoaded){rp(preloaderBg);loadingState="game";rp(loadingScreen);preloaderBg=loadingScreen=null;PIXI.TextureCache["1st plan.png"].destroy(!0);window.progressMask=null;window.addEventListener("orientationchange",orientchange,!1);orientchange();setTimeout("window.scrollTo(0, 1)",10);var a=document.getElementById("vk_ads_55316");a&&a.parentNode.removeChild(a);PlayerData.inst.updateEnergy();vkparams.registered?SM.inst.openStage(window.comixStage):
SM.inst.openStage(window.charStage)}}function orientchange(){switch(window.orientation){case 0:addRotationText();break;case 90:removeRotationText();break;case -90:removeRotationText()}}function removeRotationText(){document.body.removeChild(window.rotatebg);window.rotatebg=null;document.body.removeChild(window.icorotate);window.icorotate=null}
