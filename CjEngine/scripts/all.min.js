...
ease:Circ.easeOut}),c=new PIXI.Sprite(PIXI.Texture.fromFrame("bodrost text.png"));c.anchor.x=.5;c.anchor.y=.5;c.x=SCR_WIDTH/2;c.y=SCR_HEIGHT/2-108;SM.inst.guiLayer.addChild(c);a.gfx.interactive=!0;onc(a.gfx,function(){b.pause();var c=function(){b.resume();ZSound.Play("vzbodritsa");TweenMax.killTweensOf(a);removeafterlife();gameStage.removeFade();gameStage.unpause();gameStage.state="game";incMetric("USED REVEAL");PlayerData.inst.playerItem.crystals-=gameStage.revealPrice;gameStage.revealPrice*=2;gameStage.player.reveal();
...
CObj.getById("bshare").click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b "+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432.\nhttps://vk.com/app4654201",attachments:["photo-90523698_359515843","https://vk.com/app4654201"]},function(a){})};for(c=0;5>c;++c)a(c);azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:5,skip:scoreStage.skip},method:"post"}).done(function(a){a=a.result;for(var c=0;c<Math.min(5,
a.length);++c)CObj.getById("tf"+(c+1).toString()+"2").text=extractName(a[c]),CObj.getById("tf"+(c+1).toString()+"3").text=a[c].maxdistance.toString(),b>a[c].maxdistance&&(CObj.getById("b"+(c+1).toString()).gfx.visible=!0,CObj.getById("b"+(c+1).toString()).text="\u042f \u0442\u0435\u0431\u044f \u0443\u0434\u0435\u043b\u0430\u043b",function(a,c){CObj.getById("b"+(a+1).toString()).click=function(){VK.api("wall.post",{owner_id:c.platformid,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b "+
...
GameStage.prototype.updateScore=function(){gameStage.scoreObj&&(gameStage.scoreObj.text=PlayerData.inst.score.toString())};function getChar(a){return null==a.which?32>a.keyCode?null:String.fromCharCode(a.keyCode):0!=a.which&&0!=a.charCode?32>a.which?null:String.fromCharCode(a.which):null}
...
{body:{id_item:c.id,id_player:PlayerData.inst.playerItem.id},method:"post"}).done(function(a){incMetric("BUY ITEM"+c.name);b&&0<c.pricecrys?PlayerData.inst.playerItem.crystals-=c.pricecrys:PlayerData.inst.playerItem.money-=c.price;shopStage.updateStatsPanel();PlayerData.inst.equipItem(c,!0);shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos);shopStage.updateStatsPanel();shopStage.transScreen.parent.removeChild(shopStage.transScreen);
shopStage.transScreen=null;PlayerData.inst.savePlayerData()})):charStage.openPremiumWindow()};
...
"\u043f\u0438\u0441\u0442\u043e\u043b\u0435\u0442","\u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435",{visualWidth:10,dw:.1,speed:60.5,sound:"ochered",queue:5,queueDelay:110,life:1,acc:.17,accIncrease:.05,accRecoil:.12,recoil:.5,magcap:50,delay:520,damage:55,unlockprice:10,reloadTime:2200},"asd",[{name:"\u0422\u043e\u0447\u043d\u044b\u0439 \u0441\u0442\u0432\u043e\u043b",param:"recoil",valuesUpgr:[10,20,30,40],level:0},{name:"\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u043c\u0430\u0433\u0430\u0437\u0438\u043d",
...
CBooster.prototype.onDeactivate=function(){rp(this.tf);this.tf=null;this.activate=!1;var a=CBooster.list.indexOf(this);0<=a&&CBooster.list.splice(a,1);var b=this;new TweenMax(this.gfx,.5,{alpha:0,onComplete:function(){b.destroy()}})};CBooster.prototype.removeBoosterItem=function(){for(var a=0;a<PlayerData.inst.items_enabled.length&&PlayerData.inst.items_enabled[a].id!=this.ieid;++a);a<PlayerData.inst.items_enabled.length&&PlayerData.inst.items_enabled.splice(this.ieid,1)};
...
PlayerData.inst.saveRunProgress(!0);PlayerData.inst.savePlayerData();PlayerData.inst.updateScore()}};PlayerData.prototype.addNotification=function(a,b){window.azureclient.getTable("tb_notifications").insert({message:a,platformid:b})};
...
CObj.getById("levnum").text=PlayerData.inst.playerItem.lvl.toString();CObj.getById("btnclose").click=function(){LevelManager.removeLastLevel();b?gameStage.unpause():(shopStage.updateStatsPanel(),charStage.closeEventsWnd())}},SM.inst.fontLayer));SM.inst.currentStage==gameStage&&gameStage.updateXP()};
...
PlayerData.prototype.updateEnergy=function(a){if(this.playerItem){var b=(new Date).getTime()-this.playerItem.updateDate.getTime();this.playerItem.updateDate=new Date;b=b/1E3/60;if(0<b){var c=this.playerItem.energy;this.playerItem.energy+=b*this.epm;console.log(this.playerItem.energy);this.playerItem.energy>this.maxEnergy&&(this.playerItem.energy=this.maxEnergy);0>this.playerItem.energy&&(this.playerItem.energy=0);null==a&&Math.floor(c)!=Math.floor(this.playerItem.energy)&&this.savePlayerData()}SM.inst.currentStage!=
charStage&&SM.inst.currentStage!=shopStage||shopStage.updateStatsPanel();setTimeout(function(){PlayerData.inst.updateEnergy()},PlayerData.inst.delayEnergyMS)}};PlayerData.prototype.createAchProgress=function(a){for(a=0;a<this.achs.length;++a){for(var b=!1,c=0;c<this.achs_progress.length;++c)if(this.achs[a].id==this.achs_progress[c].id_ach){b=!0;break}b||this.achs_progress.push({id_ach:this.achs[a].id,id_player:this.playerItem.id,progress:0})}};incMetric=function(a){};
PlayerData.prototype.getEventById=function(a){for(var b=0;b<this.events.length;++b)if(this.events[b].id==a)return this.events[b];return null};PlayerData.prototype.updateScore=function(){azureclient.invokeApi("update_score",{body:{id_player:PlayerData.inst.playerItem.id,score:PlayerData.inst.playerItem.maxdistance},method:"post"}).done(function(){})};
PlayerData.prototype.loadData=function(a){checkDb();this.loadCount=0;console.log("PlayerData.loadData");window.azureclient.getTable("tb_achs").read().done(function(b){PlayerData.inst.achs=b;PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_ach_player").read().done(function(b){PlayerData.inst.achs_progress=b;PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});PlayerData.inst.items=JSON.parse(itemsVar);PlayerData.inst.loadCount++;
window.azureclient.getTable("tb_item_player").read().done(function(b){PlayerData.inst.items_enabled=b;for(var c=b=!1,d=-1,e=0;e<PlayerData.inst.items_enabled.length;++e)"68AFAEDC-B3E0-401E-9E1A-E272084F2E11"==PlayerData.inst.items_enabled[e].id_item&&(d=e,b=!0),PlayerData.inst.items_enabled[e].equipped&&(c=!0);!c&&b&&(PlayerData.inst.items_enabled[d].equipped=!0);b||(azureclient.invokeApi("buy_item",{body:{id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.inst.pid,equipped:c},method:"post"}).done(function(a){},
function(a){}),c=!0,0<PlayerData.inst.items_enabled.length&&(c=!1),PlayerData.inst.items_enabled.push({id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.inst.pid,equipped:c}));PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_edevent_player").read().done(function(b){PlayerData.inst.eventsplayer=b;PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});PlayerData.inst.events=JSON.parse(eventsVar);
PlayerData.inst.loadCount++};PlayerData.prototype.saveAllData=function(){this.savePlayerData();this.savePlayerItems();this.savePlayerEvents();this.savePlayerAchs()};PlayerData.prototype.savePlayerAchs=function(a){for(var b=0;b<PlayerData.inst.achs_progress.length;++b)a&&a.id!=PlayerData.inst.achs_progress[b].id||window.azureclient.getTable("tb_ach_player").update(PlayerData.inst.achs_progress[b]).done(function(a){},function(a){})};
...
PlayerData.prototype.azureLogin=function(){console.log("LOGIN VK USER ID = "+vkparams.viewerid.toString());azureclient.invokeApi("login",{body:{platformid:vkparams.viewerid,ref:vkparams.refferer},method:"post"}).done(function(a){console.log(JSON.stringify(a.result));vkparams.registered=a.result.registered;vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.result.userId.split(":")[1];PlayerData.inst.playerItem=a.result.playerItem;vkparams.first_name&&
(PlayerData.inst.playerItem.name=vkparams.first_name);vkparams.last_name&&(PlayerData.inst.playerItem.last_name=vkparams.last_name);PlayerData.inst.playerItem.crystals||(PlayerData.inst.playerItem.crystals=0);console.log("Player item read from login"+JSON.stringify(PlayerData.inst.playerItem));azureclient.currentUser={userId:a.result.userId,mobileServiceAuthenticationToken:a.result.token};vkparams.id=PlayerData.inst.playerItem.id;PlayerData.inst.getVKfriends()},function(a){PlayerData.inst.azureLogin()})};
PlayerData.dbInit=function(){console.log("dbInit start. Connecting to azure");window.azureclient=new WindowsAzure.MobileServiceClient("https://thanksdad.azure-mobile.net/","DRoaNHnoaCjxrhkbpOzHxGEHOFgGLS75");window.vkparams={};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&(vkparams.viewerid=vkparams.viewerid.toString());vkparams.viewerid&&VK||(vkparams.viewerid="2882845",MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),
vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");new PlayerData};
