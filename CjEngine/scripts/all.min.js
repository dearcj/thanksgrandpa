...
uploadPhoto=function(a){var b=new PIXI.RenderTexture(SCR_WIDTH,SCR_HEIGHT);b.render(SM.inst.superStage);b.getBase64();VK.api("photos.getWallUploadServer",{uid:a},function(a){console.log("GET WALL UPLOAD SERV")},function(a){console.log("ERROR GET WALL UPLOAD SERV")})};
