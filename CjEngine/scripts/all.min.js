...
PlayerData.inst.createAchProgress();console.log("achs loaded");PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()});PlayerData.inst.callDedAPI("READ","tb_item_player",null,null,function(b){console.log("items loaded");PlayerData.inst.items_enabled=PlayerData.inst.intJSON(b);PlayerData.inst.baseWeapIt=PlayerData.inst.getItemById("68AFAEDC-B3E0-401E-9E1A-E272084F2E11");PlayerData.inst.baseWeapItPl={id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.inst.pid,equipped:!1};
PlayerData.inst.items_enabled.push(PlayerData.inst.baseWeapItPl);PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()})};PlayerData.prototype.saveAllData=function(){this.savePlayerData();this.savePlayerItems();this.savePlayerEvents();this.savePlayerAchs()};
PlayerData.prototype.savePlayerAchs=function(a){for(var b=0;b<PlayerData.inst.achs_progress.length;++b)a&&a.id!=PlayerData.inst.achs_progress[b].id||PlayerData.inst.callDedAPI("UPDATE","tb_ach_player",PlayerData.inst.achs_progress[b].id,PlayerData.inst.achs_progress[b])};
...
[];vkparams.friendsIngameIDsStr=[];if(a.response&&a.response.length){a=a.response;var b=a.length;3<=b&&PlayerData.inst.progressAch("Gold medal 26",1,!1);5<=b&&PlayerData.inst.progressAch("Gold medal 27",1,!1);10<=b&&PlayerData.inst.progressAch("Gold medal 28",1,!1);15<=b&&PlayerData.inst.progressAch("Gold medal 29",1,!1);20<=b&&PlayerData.inst.progressAch("Gold medal 30",1,!1);for(b=0;b<a.length;++b){var c=a[b].toString();vkparams.friendsIngameIDsStr.push("'"+c+"'");vkparams.friendsIngameIDs.push(c)}vkparams.friendsFilter=
vkparams.friendsIngameIDsStr.join(", ");0<vkparams.friendsIngameIDs.length?PlayerData.inst.callDedAPI("GET_SCORES",null,null,{filter:vkparams.friendsFilter,take:60,skip:0},function(a){vkparams.friendsIngame=a;PlayerData.inst.getVKuserData()}):PlayerData.inst.getVKuserData()}else PlayerData.inst.getVKuserData()})};
