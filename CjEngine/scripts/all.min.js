...
vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&VK||(MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);if("CARLSON"==vkparams.viewerid||"2882845"==vkparams.viewerid||"282617259"==vkparams.viewerid||"197515742"==vkparams.viewerid){vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");
this.loginPage="https://www.dedgame.ru/backendmysql/login.php";this.apiSource="https://www.dedgame.ru/backendmysql/dedapi.php";if("?p=LOCAL"==window.location.search)this.playerJSON='{"registered":false,"tokenJWT":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ2a2lkIjoiMjgyNjE3MjU5IiwidXNlcmlkIjoiNzhGNkY3Q0UtMjhFMy00QUVBLUIxNDMtMkJCQjJDQkVBNTREIn0.P-nWGsKp866LbgRrzuVhBut8p4ZaAZ8XZfhIchgsph4","playerItem":{"id":"78F6F7CE-28E3-4AEA-B143-2BBB2CBEA54D","ref":"282617259","vkapi":"282617259","xp":"256.94042397661","createDate":"2015-03-25 12:31:46","updateDate":"2015-04-17 00:50:13","userId":"Custom:F800A350-EE15-4F1C-9CCF-050B775A4CD9","money":"9639","crystals":"1000","maxdistance":"918","lvl":"3","energy":"10","name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0439","last_name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0447","rank":"2467","combodate":"2015-03-25 15:56:09","keys":null,"platformid":"282617259"}}',
...
PlayerData.prototype.progressAch=function(a,b,c){for(var d=0;d<this.achs.length&&this.achs[d].name.toLowerCase()!=a.toLowerCase();++d);a=!1;for(var e=0;e<this.achs_progress.length;++e)if(this.achs_progress[e].id_ach==this.achs[d].id){0>this.achChanged.indexOf(this.achs_progress[e].id_ach)&&this.achChanged.push(this.achs_progress[e].id_ach);c?(1<=b&&(a=!0),this.achs_progress[e].progress=b):(1>this.achs_progress[e].progress&&1<=this.achs_progress[e].progress+b&&(a=!0,charStage.unreadAch=!0),this.achs_progress[e].progress+=
b);break}a&&(this.savePlayerAchs(this.achs_progress[e]),this.showAch(this.achs[d]));return a};
