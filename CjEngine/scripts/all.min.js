...
PlayerData.prototype.getVKfriends=function(){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";console.log("Gettin vk friends");vkparams.friendsids=[];vkparams.friendsIngameIDs=[];vkparams.novk?"?lhst=1922"==window.location.search&&this.loadData(this.loadEnd):VK.api("friends.getAppUsers",{},function(a){vkparams.friendsIngameIDs=[];a.response&&a.response.length?azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsids,take:15},method:"post"}).done(function(a){vkparams.friendsIngame=
a.result;vkparams.friendsIngameIDs=[];if(a.result){for(var c=0;c<a.result.length;++c)vkparams.friendsIngameIDs.push(a.result[c].platformid.toString());PlayerData.inst.getVKuserData()}},function(a){PlayerData.inst.getVKuserData()}):PlayerData.inst.getVKuserData()})};
