...
uploadPhoto=function(a){var b=new PIXI.RenderTexture(SCR_WIDTH,SCR_HEIGHT);b.render(SM.inst.superStage);var c=b.getBase64();VK.api("photos.getWallUploadServer",{uid:a},function(a){console.log("GET WALL UPLOAD SERV")},function(a){$.ajax({type:"POST",url:a.response.upload_url,data:{photo:c},success:function(a){console.log("")}})})};
