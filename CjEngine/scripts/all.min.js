...
vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");var a=getCookie("LOGIN_DATA"),a=a.replace("%2B"," "),a=decodeURIComponent(a);window.decompress(a);a=JSON.parse(a);vkparams.token=a.tokenJWT;vkparams.registered=a.registered;vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.playerItem.id;PlayerData.inst.playerItem=PlayerData.inst.intJSON(a.playerItem);
PlayerData.inst.playerItem.crystals||(PlayerData.inst.playerItem.crystals=0);vkparams.id=PlayerData.inst.playerItem.id;PlayerData.inst.getVKfriends()}};PlayerData.prototype.addNotification=function(a,b){};
