...
PlayerData.prototype.updateScore=function(a){azureclient.invokeApi("update_score",{body:{id_player:PlayerData.inst.playerItem.id,score:PlayerData.inst.playerItem.maxdistance},method:"post"}).done(function(b){a&&a(b)})};
...
window.azureclient.getTable("tb_item_player").read().done(function(b){PlayerData.inst.items_enabled=b;for(var c=b=!1,d=-1,e=0;e<PlayerData.inst.items_enabled.length;++e)"68AFAEDC-B3E0-401E-9E1A-E272084F2E11"==PlayerData.inst.items_enabled[e].id_item&&(d=e,b=!0),PlayerData.inst.items_enabled[e].equipped&&(c=!0);!c&&b&&(PlayerData.inst.items_enabled[d].equipped=!0);b||(c=!0,0<PlayerData.inst.items_enabled.length&&(c=!1),PlayerData.inst.items_enabled.push({id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",
id_player:PlayerData.inst.pid,equipped:c}));PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_edevent_player").read().done(function(b){PlayerData.inst.eventsplayer=b;PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});PlayerData.inst.events=JSON.parse(eventsVar);PlayerData.inst.loadCount++};PlayerData.prototype.saveAllData=function(){this.savePlayerData();this.savePlayerItems();this.savePlayerEvents();this.savePlayerAchs()};
