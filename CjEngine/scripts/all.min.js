...
[];vkparams.friendsIngameIDsStr=[];if(a.response&&a.response.length){a=a.response;for(var b=0;b<a.length;++b){var c=a[b].toString();vkparams.friendsIngameIDsStr.push('"'+c+'"');vkparams.friendsIngameIDs.push(c)}vkparams.friendsFilter=vkparams.friendsIngameIDsStr.join(", ");0<vkparams.friendsIngameIDs.length?PlayerData.inst.callDedAPI("GET_SCORES",null,null,{filter:null,take:15,skip:0},function(a){vkparams.friendsIngame=a;PlayerData.inst.getVKuserData()}):PlayerData.inst.getVKuserData()}else PlayerData.inst.getVKuserData()})};
