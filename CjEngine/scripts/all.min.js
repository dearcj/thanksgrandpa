...
null,null,{id:c.id,equipped:!0},function(a){console.log("SCORE UPDATED "+a);a&&a.crystals&&a.money?("Tablets$4"==c.name&&this.progressAch("Gold medal 22",1,!1),"Health$4"==c.name&&this.progressAch("Gold medal 20",1,!1),"MarioStar$4"==c.name&&this.progressAch("Gold medal 24",1,!1),"Double$4"==c.name&&this.progressAch("Gold medal 23",1,!1),"Magnet$4"==c.name&&this.progressAch("Gold medal 21",1,!1),PlayerData.inst.playerItem.crystals=parseFloat(a.crystals),PlayerData.inst.playerItem.money=parseFloat(a.money),
PlayerData.inst.items_enabled.push({id_item:c.id,id_player:PlayerData.inst.playerItem.id}),shopStage.updateStatsPanel(),PlayerData.inst.equipItem(c,"1"),shopStage.pl.updateAppearence(!0,!1,null,null,null),shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos),shopStage.updateStatsPanel(),shopStage.transScreen.parent.removeChild(shopStage.transScreen),shopStage.transScreen=null):shopStage.transScreen&&(rp(shopStage.transScreen),shopStage.transScreen=null)})):charStage.openPremiumWindow()};
...
PlayerData.prototype.progressAch=function(a,b,c){for(var d=0;d<this.achs.length&&this.achs[d].name.toLowerCase()!=a.toLowerCase();++d);if(d!=this.achs.length){a=!1;for(var e=0;e<this.achs_progress.length;++e)if(this.achs_progress[e].id_ach==this.achs[d].id){0>this.achChanged.indexOf(this.achs_progress[e].id_ach)&&this.achChanged.push(this.achs_progress[e].id_ach);c?(1<=b&&(a=!0),this.achs_progress[e].progress=b):(1>this.achs_progress[e].progress&&1<=this.achs_progress[e].progress+b&&(a=!0,charStage.unreadAch=
!0),this.achs_progress[e].progress+=b);break}a&&(this.savePlayerAchs(this.achs_progress[e]),this.showAch(this.achs[d]));return a}};
...
PlayerData.prototype.saveRunProgress=function(a){if(SM.inst.currentStage==gameStage&&!gameStage.progressSaved)for(a=Math.round(PlayerData.inst.playerItem.maxdistance),LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(a=Math.round(LauncherBG.inst.distance),PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=parseInt(a.rank)})),gameStage.progressSaved=!0,PlayerData.inst.playerItem.money+=Math.round(PlayerData.inst.score),PlayerData.inst.playerItem.maxdistance=a,PlayerData.inst.savePlayerData(),
gameStage.ari&&(gameStage.ari.kill(),gameStage.ari=null),PlayerData.inst.saveScore(),a=0;a<PlayerData.inst.achChanged.length;++a)PlayerData.inst.savePlayerAchs(PlayerData.inst.achChanged[a]),console.log("ACH SAVED")};
