...
PlayerData.prototype.getVKfriends=function(){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";console.log("Gettin vk friends");vkparams.friendsids=[];vkparams.friendsIngameIDs=[];vkparams.novk?this.loadData(this.loadEnd):VK.api("friends.getAppUsers",{},function(a){if(a.response&&a.response.length){a=a.response;for(var b=0;b<a.length;++b)vkparams.friendsids.push(a[b].toString());console.log("VK friends+")}azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsids,
take:1E3},method:"post"}).done(function(a){vkparams.friendsIngame=a.result;vkparams.friendsIngameIDs=[];if(a.result){for(var b=0;b<a.result.length;++b)vkparams.friendsIngameIDs.push(a.result[b].platformid.toString());PlayerData.inst.getVKuserData()}},function(a){PlayerData.inst.getVKuserData()})})};
