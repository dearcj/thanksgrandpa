...
CObj.getById("bpubl").click=function(){OpenInNewTab("https://vk.com/thanksgradpa")};charStage.updateMusicButton(CObj.getById("bmusic"));CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("helpded").click=function(){var b=function(){a.updateAppearence(!0,!1,"breath");CObj.enableButtons(!0);LevelManager.destroyLevel("helpded");charStage.openHelp=
!1};charStage.openHelp?b():(charStage.pl.gfx.skeleton.setAttachment("hat",null),charStage.pl.gfx.skeleton.setAttachment("head","head5"),CObj.enableButtons(!1),CObj.getById("helpded").gfx.interactive=!0,charStage.openHelp=!0,LevelManager.loadLevel("helpded",function(){CObj.getById("gohelp").click=function(){OpenInNewTab("http://bit.ly/1BnM4B8")};CObj.getById("closehelp").click=b},SM.inst.ol))};CObj.getById("btnfight").click=function(){if(1<=PlayerData.inst.playerItem.energy)--PlayerData.inst.playerItem.energy,
PlayerData.inst.savePlayerData(),SM.inst.openStage(gameStage);else{var a=CObj.getById("tfenergy"),c=CObj.getById("energyback");new TweenMax(a,.1,{y:a.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});new TweenMax(c,.1,{y:c.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});charStage.openEnergyWindow()}};var a=new CPlayer(SCR_WIDTH/2,430);charStage.pl=a;a.gfx.scale.x=.34;a.gfx.scale.y=.34;a.updateAppearence(!0,!1,"breath");SM.inst.ol.addChild(a.gfx);a.gfx.interactive=!0;CObj.getById("bsofa").click=function(){CObj.enableButtons(!1);
...
b.push(h);b[d].platformid=a[d].platformid;""!=c&&(c+=",");c+=a[d].platformid;if(3>charStage.skip+d){var l;0==charStage.skip+d&&(l="1st place");1==charStage.skip+d&&(l="2nd place");2==charStage.skip+d&&(l="3rd place");var m=crsp(l);m.x=4;m.y=10;m.scale.x=.8;m.scale.y=.8;e.addChild(m)}h.y=10;h.x=35;e.x=20;e.y=15+28*d;g.x=55;k.x=370;e.addChild(h);e.addChild(g);e.addChild(f);e.addChild(k);charStage.container.addChild(e)}VK&&""!=c&&VK.api("users.get",{user_ids:c,fields:"photo"},function(a){if(a.response)for(var c=
...
PlayerData.getVKfriends=function(a){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";console.log("Gettin vk friends");vkparams.friendsids=[];vkparams.friendsIngameIDs=[];vkparams.novk?new PlayerData(a):VK.api("friends.getAppUsers",{},function(b){b.response&&b.response.length&&(console.log("friends.get data"+JSON.stringify(b.response)),vkparams.friends=b.response,vkparams.friendsids=b.response,console.log("VK friends+"));azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsids,
take:1E3},method:"post"}).done(function(b){vkparams.friendsIngame=b.result;vkparams.friendsIngameIDs=[];if(b.result){for(var d=0;d<b.result.length;++d)vkparams.friendsIngameIDs.push(b.result[d].platformid);PlayerData.getVKuserData(a)}},function(b){PlayerData.getVKuserData(a)})})};
...
PlayerData.dbInit=function(){console.log("dbInit start. Connecting to azure");window.azureclient=new WindowsAzure.MobileServiceClient("https://thanksdad.azure-mobile.net/","DRoaNHnoaCjxrhkbpOzHxGEHOFgGLS75");window.vkparams={};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&VK||(vkparams.viewerid=2882845,MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);vkparams.gamerid=vkparams.userid||
vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");PlayerData.azureLogin()};var tWeapon="weap",tPerk="perk",tBoost="boost",tApp="app.",tHat="hat";function checkDb(){updDb(dbobj)}
