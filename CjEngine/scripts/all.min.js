...
MM=function(){this.patterns=[];this.carClips=["car","car1","car2"];this.bosses=[{cls:Boss1,dist:1E3},{cls:Boss2,dist:2E3}];this.monY=360;this.sNormal=1;this.sBoss=2;this.lastSpawnPlane=this.lastStep=0;this.currentBoss=null;this.state=this.sNormal;this.stepDelay=330};MM.inst=new MM;
