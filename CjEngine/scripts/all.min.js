...
2&&window.mouseX<b.x+b.gfx.width/2&&window.mouseY>b.y-b.gfx.height/2&&window.mouseY<b.y+b.gfx.height/2||charStage.closeEventsWnd()});charStage.bar.gfx.parent.removeChild(charStage.bar.gfx);SM.inst.fontLayer.addChild(charStage.bar.gfx);charStage.bar.gfx.visible=!0;charStage.unreadActions=!1;charStage.updateNotifications()};PlayerData.inst.comboCheck();$.ajax({type:"POST",url:"levelup.php",data:{uid:"2882845",lev:1},dataType:"text"}).success(function(a){console.log(JSON.stringify(a))});charStage.bar=
new CScrollbar(180,309,"",380,524,"podlozhka actions.png","scroll line actions.png","scroll.png",50);charStage.bar.gfx.scale.x=.7;charStage.bar.gfx.scale.y=.7;charStage.bar.gfx.visible=!1;charStage.updateEvents();shopStage.updateStatsPanel();MOBILE||(charStage.frp=charStage.createFriendsPanel())};
