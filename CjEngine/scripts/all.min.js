...
CObj.getById("bpubl").click=function(){OpenInNewTab("https://vk.com/thanksgradpa")};charStage.updateMusicButton(CObj.getById("bmusic"));CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("helpded").click=function(){var a=function(){charStage.pl.gfx.skeleton.setAttachment("head","head2");CObj.enableButtons(!0);LevelManager.destroyLevel("helpded");
charStage.openHelp=!1};charStage.openHelp?a():(charStage.pl.gfx.skeleton.setAttachment("head","head5"),CObj.enableButtons(!1),CObj.getById("helpded").gfx.interactive=!0,charStage.openHelp=!0,LevelManager.loadLevel("helpded",function(){CObj.getById("gohelp").click=function(){OpenInNewTab("http://bit.ly/1BnM4B8")};CObj.getById("closehelp").click=a},SM.inst.ol))};CObj.getById("btnfight").click=function(){if(1<=PlayerData.inst.playerItem.energy)--PlayerData.inst.playerItem.energy,PlayerData.inst.savePlayerData(),
...
this;this.loadData(this.loadEnd);window.onbeforeunload=function(a){console.log("UNLOAD");PlayerData.inst.updateEnergy()}};PlayerData.prototype.addNotification=function(a,b){window.azureclient.getTable("tb_notifications").insert({message:a,vkapi:b})};
...
take:1E3},method:"post"}).done(function(b){vkparams.friendsIngame=b.result;vkparams.friendsIngameIDs=[];if(b.result){for(var d=0;d<b.result.length;++d)vkparams.friendsIngameIDs.push(b.result[d].vkapi);PlayerData.getVKuserData(a)}},function(b){PlayerData.getVKuserData(a)})})};
...
PlayerData.dbInit=function(){console.log("dbInit start. Connecting to azure");window.azureclient=new WindowsAzure.MobileServiceClient("https://thanksdad.azure-mobile.net/","DRoaNHnoaCjxrhkbpOzHxGEHOFgGLS75");window.vkparams={};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&VK||(vkparams.viewerid=2882845,vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");
