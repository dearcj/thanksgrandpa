...
PlayerData.prototype.getVKfriends=function(){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";console.log("Gettin vk friends");vkparams.friendsids=[];vkparams.friendsIngameIDs=[];vkparams.novk?"?lhst=1922"==window.location.search&&this.loadData(this.loadEnd):VK.api("friends.getAppUsers",{},function(a){vkparams.friendsIngameIDs=[];if(a.response&&a.response.length){a=a.response;for(var b=0;b<a.length;++b)vkparams.friendsIngameIDs.push(a[b].toString());console.log("VK friends+")}PlayerData.inst.getVKuserData()})};
