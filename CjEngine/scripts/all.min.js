...
!vkparams.friendsIngame||e>=vkparams.friendsIngame.length?g.click=function(){VK.callMethod("showInviteBox")}:(username=vkparams.friendsIngame[e].name,g.click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:username+", \u0432\u043e\u0437\u0432\u0440\u0430\u0449\u0430\u0439\u0441\u044f \u0432 \u0438\u0433\u0440\u0443, \u0434\u0440\u0443\u0436\u0438\u0449\u0435\nhttps://vk.com/app4654201",attachments:["photo282617259_360326325","https://vk.com/app4654201"]},function(a){})},""!=b&&(b+=
","),b+=vkparams.friendsIngame[e].vkapi.toString(),g.vkapi=vkparams.friendsIngame[e].vkapi,c.push(g))}VK&&""!=b&&VK.api("users.get",{user_ids:b,fields:"photo"},function(a){if(a.response)for(var b=0;b<a.response.length;++b){var d=a.response[b].photo;if(!a.response||0==a.response.length)break;var e=c[b];e.loader=new PIXI.ImageLoader(d);(function(a,b){a.loader.onLoaded=function(){var c=new PIXI.Sprite(PIXI.TextureCache[b]);c.anchor.x=.5;c.anchor.y=.5;a.addChild(c);charStage.icons.push(c)}})(e,d);e.loader.load()}});
a.x=215;a.y=SCR_HEIGHT-50;SM.inst.guiLayer.addChild(a);return a};
...
diff:9,prob:1},{mons:".c.chH..h..H..000000",diff:10,prob:1}];this.carClips=["car","car1","car2"];this.bosses=[{cls:Boss1,dist:1E3},{cls:Boss2,dist:2E3}];this.monY=360;this.sNormal=1;this.sBoss=2;this.lastSpawnPlane=this.lastStep=0;this.currentBoss=null;this.state=this.sNormal;this.stepDelay=330};MM.inst=new MM;
...
extend(CTabletsBooster,CBooster,!0);function CTabletsBooster(a,b,c,d){CBooster.apply(this,[a,b,c,d]);this.duration=4+d}CTabletsBooster.prototype.onActivate=function(){CBooster.prototype.onActivate.call(this);if(gameStage.player){this.lastUse=window.time;gameStage.player.invulnerable++;var a=gameStage.player;a.blink=!0;this.prevVel=LauncherBG.inst.maxVelocity;a.superMode=!0;new TweenMax(LauncherBG.inst,1.5,{maxVelocity:LauncherBG.inst.maxVelocity+15,ease:Linear.easeOut})}};
