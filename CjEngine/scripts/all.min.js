...
PlayerData.prototype.updateEnergy=function(){if(this.playerItem){var a=(new Date).getTime()-this.playerItem.updateDate.getTime();this.playerItem.updateDate=new Date;a=a/1E3/60;0<a&&(this.playerItem.energy+=a*this.epm,console.log(this.playerItem.energy),this.playerItem.energy>this.maxEnergy&&(this.playerItem.energy=this.maxEnergy),0>this.playerItem.energy&&(this.playerItem.energy=0),this.savePlayerData());SM.inst.currentStage!=charStage&&SM.inst.currentStage!=shopStage||shopStage.updateStatsPanel();
setTimeout(function(){PlayerData.inst.updateEnergy()},PlayerData.inst.delayEnergyMS)}};PlayerData.prototype.createAchProgress=function(a){for(a=0;a<this.achs.length;++a){for(var b=!1,c=0;c<this.achs_progress.length;++c)if(this.achs[a].id==this.achs_progress[c].id_ach){b=!0;break}b||this.achs_progress.push({id_ach:this.achs[a].id,id_player:this.playerItem.id,progress:0})}};incMetric=function(a){azureclient.invokeApi("increasemetric",{body:{name:a},method:"post"})};
