...
shopStage.updateStatsPanel(),shopStage.transScreen.parent.removeChild(shopStage.transScreen),shopStage.transScreen=null):shopStage.transScreen.parent&&(rp(shopStage.transScreen.parent),shopStage.transScreen=null)})):charStage.openPremiumWindow()};
...
getURLParameter("viewer_id");vkparams.viewerid&&VK||(MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);if("CARLSON"==vkparams.viewerid||"2882845"==vkparams.viewerid||"282617259"==vkparams.viewerid||"197515742"==vkparams.viewerid){vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");this.loginPage=
"https://www.dedgame.ru/backendmysql/login.php";this.apiSource="https://www.dedgame.ru/backendmysql/dedapi.php";if("?p=LOCAL"==window.location.search)this.playerJSON='{"registered":false,"tokenJWT":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ2a2lkIjoiMjgyNjE3MjU5IiwidXNlcmlkIjoiNzhGNkY3Q0UtMjhFMy00QUVBLUIxNDMtMkJCQjJDQkVBNTREIn0.P-nWGsKp866LbgRrzuVhBut8p4ZaAZ8XZfhIchgsph4","playerItem":{"id":"78F6F7CE-28E3-4AEA-B143-2BBB2CBEA54D","ref":"282617259","vkapi":"282617259","xp":"256.94042397661","createDate":"2015-03-25 12:31:46","updateDate":"2015-04-17 00:50:13","userId":"Custom:F800A350-EE15-4F1C-9CCF-050B775A4CD9","money":"9639","crystals":"1000","maxdistance":"918","lvl":"3","energy":"10","name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0439","last_name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0447","rank":"2467","combodate":"2015-03-25 15:56:09","keys":null,"platformid":"282617259"}}',
...
PlayerData.prototype.azureReadData=function(){PlayerData.inst.callDedAPI("AZURE_READ_DATA",null,null,{score:PlayerData.inst.score,dist:LauncherBG.inst.distance},function(a){console.log(a)})};PlayerData.prototype.saveScore=function(){PlayerData.inst.callDedAPI("SAVE_SCORE",null,null,{score:PlayerData.inst.score,dist:LauncherBG.inst.distance},function(a){console.log(a)})};
...
PlayerData.prototype.loadData=function(a){checkDb();this.loadCount=0;console.log("PlayerData.loadData");PlayerData.inst.events=JSON.parse(eventsVar);PlayerData.inst.loadCount++;PlayerData.inst.achs=JSON.parse(achsVar);PlayerData.inst.loadCount++;PlayerData.inst.items=JSON.parse(itemsVar);PlayerData.inst.loadCount++;PlayerData.inst.callDedAPI("READ","tb_edevent_player",null,null,function(b){PlayerData.inst.eventsplayer=PlayerData.inst.intJSON(b);PlayerData.inst.loadCount++;console.log("events loaded");
6==PlayerData.inst.loadCount&&a&&a()});PlayerData.inst.callDedAPI("READ","tb_ach_player",null,null,function(b){PlayerData.inst.achs_progress=PlayerData.inst.intJSON(b);console.log("achs loaded");PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()});PlayerData.inst.callDedAPI("READ","tb_item_player",null,null,function(b){console.log("items loaded");PlayerData.inst.items_enabled=PlayerData.inst.intJSON(b);PlayerData.inst.baseWeapIt=PlayerData.inst.getItemById("68AFAEDC-B3E0-401E-9E1A-E272084F2E11");
PlayerData.inst.baseWeapItPl={id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.inst.pid,equipped:!1};PlayerData.inst.items_enabled.push(PlayerData.inst.baseWeapItPl);PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()})};PlayerData.prototype.saveAllData=function(){this.savePlayerData();this.savePlayerItems();this.savePlayerEvents();this.savePlayerAchs()};
