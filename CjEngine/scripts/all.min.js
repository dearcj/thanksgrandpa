...
2,SCR_HEIGHT/2+1.3*SCR_HEIGHT],p2:[SCR_WIDTH/2,SCR_HEIGHT/2],delay:0,tweenTime:.3,ease:Sine.easeIn},{tex:"4top_frame2.png",rot1:.5,vx:0,vy:.05,s1:[3,3],s2:[1,1],p1:[1100,-440],p2:[595,160],delay:.2,tweenTime:.45,ease:Back.easeOut},{tex:"4top_frame1.png",vx:0,vy:.07,s1:[3,3],s2:[1,1],p1:[730,-420],p2:[235,180],delay:2,tweenTime:.45,ease:Back.easeOut},{tex:"4frame_bottom.png",s1:[2,2],s2:[.99,.99],vx:0,vy:-.05,p1:[SCR_WIDTH/2,SCR_HEIGHT/2+SCR_HEIGHT],p2:[SCR_WIDTH/2,SCR_HEIGHT/2+138],delay:3.3,tweenTime:.5,
...
ComixStage.prototype.goNext=function(){comixStage.dcNext&&comixStage.dcNext.kill();TweenMax.killAll(!0,!0,!0);var a=this.comixData.shift();a||SM.inst.openStage(charStage);comixStage.dcNext=TweenMax.delayedCall(a.duration,function(){comixStage.goNext()});for(var b=0;b<a.objects.length;++b){var c=a.objects[b],d=crsp(c.tex);comixStage.comixContainer.addChild(d);d.visible=!1;c.rot1||(c.rot1=0);c.rot2||(c.rot2=0);c.p1||(c.p1=[0,0]);c.p2||(c.p2=c.p1);c.s1||(c.s1=[1,1]);c.s2||(c.s2=c.s1);d.scale.x=1*c.s1[0];
d.scale.y=1*c.s1[1];d.rotation=c.rot1;d.x=c.p1[0];d.y=c.p1[1];d.vx=0;d.vy=0;d.va=0;c.ease||(c.ease=Sine.easeOut);new TweenMax(d.scale,c.tweenTime,{x:1*c.s2[0],y:1*c.s2[1],delay:c.delay});(function(a,b){new TweenMax(a,b.tweenTime,{ease:b.ease,rotation:b.rot2,x:b.p2[0],y:b.p2[1],delay:b.delay,onComplete:function(){a.vx=b.vx;a.vy=b.vy;a.va=b.va}})})(d,c);c.delay||(c.delay=0);setVisible=function(a){c.alphaHide&&new TweenMax(a,.1,{delay:c.alphaHide+c.delay,alpha:0});TweenMax.delayedCall(c.delay,function(){a.visible=
!0})};setVisible(d)}};ComixStage.prototype.onHide=function(a){PIXI.TextureCache["2frame.png"].destroy(!0);rp(comixStage.comixContainer);comixStage.comixContainer=null;CObj.destroyAll()};
