...
c.push(LevelManager.objs[f].sAtlasName);LevelManager.onVeryComplete=b;a=[];for(f=0;f<c.length;++f)b="imgtps2/"+c[f],PIXI.BaseTextureCache[b+".png"]||a.push(b+".json");if(0<a.length)c=new PIXI.AssetLoader(a),c.load(),c.onComplete=LevelManager.onComplete;else LevelManager.onComplete();return LevelManager.objs};LevelManager.inst=new LevelManager;LevelManager.levels={};
...
gameStage.reloadBar.init("recharge icon.png","recharge icon bar.png","recharge icon.png");gameStage.reloadBar.pos=.5;gameStage.reloadBar.gfx.visible=!1;SM.inst.guiLayer.addChild(gameStage.reloadBar.gfx);gameStage.player=new CPlayer(140,440);gameStage.player.gfx.pivot.y=-190;gameStage.player.gfx.scale.x=.22;gameStage.player.gfx.scale.y=.22;gameStage.player.playable=!0;LauncherBG.inst.pllayer.addChild(gameStage.player.gfx);5==PlayerData.inst.getUpgrade(null,"Health").upgr&&(gameStage.player.maxHp+=
...
ShopStage.prototype.createItemBtn=function(a){function b(b){PlayerData.inst.equipItem(a,"0");shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos)}function c(a){shopStage.buyItem(a,!0)}function d(b){PlayerData.inst.equipItem(a,"1");shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos)}function e(a){shopStage.buyItem(a,!1)}var f=new PIXI.DisplayObjectContainer,
...
new TweenMax(m.scale,.6,{y:.55,ease:Elastic.easeOut});new TweenMax(m.scale,.4,{x:.55,ease:Elastic.easeOut});c=a.desc.split("|");b=c[0];1<c.length&&(b=c[1]);c=CObj.getById("tfdescd");c.setTextSafe(b);c.item=a};m.mouseout=function(b){b=CObj.getById("tfdescd");b.item==a&&b.setTextSafe("");a.type!=tWeapon&&a.type!=tApp+tHat||shopStage.pl.updateAppearence(!0,!1,null,null,null);m.tint=16777215;m.currentFrame&&m.gotoAndStop(1);new TweenMax(m.scale,.3,{x:.5,y:.5,ease:Elastic.easeOut})};if(g)for(var p=0;5>
p;++p){var q=p<h?crsp("improve point on"):crsp("improve point off");q.x=25*(p-2);q.scale.x=.8;q.scale.y=.8;q.y=3;f.addChild(q)}p=this.checkOwned(a);q=this.checkEq(a);tftext="";g&&(l?tftext="":p||(tftext=0>a.pricecrys&&0>a.price?"":0<a.pricecrys?a.pricecrys.toString():a.price.toString()));var r,l="",n="buy button",t;!p||g?g&&5==h?n="equipped button":a.reqlvl>PlayerData.inst.playerItem.lvl?(r=c,n="unlock button",l="\u041c\u0418\u041d "+a.reqlvl.toString()+" \u0423\u0420.",t="price star.png",tftext=
a.pricecrys.toString()):(r=e,t="price coin.png",n="buy button",tftext=a.price.toString()):1==q?"bcloth"==shopStage.currentTab?(n="unwear button",r=b):n="equipped button":(r=d,n="wear button");h=new CButton(0,129,n);"equipped button"==n&&(h.gfx.mouseout=null,h.gfx.mouseover=null);h.fontSize=33;h.addToSameLayer=!0;h.gfx.anchor.x=.5;h.gfx.anchor.y=.5;h.gfx.scale.x=.8;h.gfx.scale.y=.8;h.init();h.gfx.parent.removeChild(h.gfx);h.item=g?PlayerData.inst.getItemById(k.idNext):a;h.gfx.btn=h;h.click=r;f.addChild(h.gfx);
h.text&&(h.text=h.text);f.btn=h;tftext&&t&&(g=crsp(t),g.x=0,g.y=80,g.scale.x=.75,g.scale.y=.75,f.addChild(g));g=new CTextField;g.tint="0x333333";g.fontSize=15;g.align="center";g.init();f.infoTF=g;g.x=0;g.y=158;g.gfx.parent.removeChild(g.gfx);g.text=l;f.addChild(g.gfx);g=new CTextField;g.tint="0x333333";g.fontSize=15;g.align="center";g.text=tftext;g.init();f.tfprice=g;g.x=10;g.y=70;g.gfx.parent.removeChild(g.gfx);f.addChild(g.gfx);g.text=g.text;f.destroy=function(){f.tfprice.destroy();f.btn&&(f.btn.destroy(),
...
function(a){var b=CObj.getById("energybg");b.gfx.getBounds();window.mouseX=a.global.x/SCR_SCALE;window.mouseY=a.global.y/SCR_SCALE;window.mouseX>b.x-b.gfx.width/2&&window.mouseX<b.x+b.gfx.width/2&&window.mouseY>b.y-b.gfx.height/2&&window.mouseY<b.y+b.gfx.height/2||close()})},SM.inst.fontLayer,LevelManager.levelLoadOffsetX)};
...
CharStage.prototype.onShowContinue=function(){charStage.doProcess=!0;charStage.updateNotifications();charStage.skip=0;charStage.tab="total";charStage.showRecords=10;PlayerData.inst.eventsplayer.sort(function(a,c){return PlayerData.inst.getEventById(a.id_edevent).reqlvl-PlayerData.inst.getEventById(c.id_edevent).reqlvl});MOBILE||(CObj.getById("frprev").click=function(){charStage.skipFriends-=5;0>charStage.skipFriends&&(charStage.skipFriends=0);charStage.frp.parent.removeChild(charStage.frp);charStage.frp=
charStage.createFriendsPanel()},CObj.getById("frnext").click=function(){charStage.skipFriends+=5;charStage.frp.parent.removeChild(charStage.frp);charStage.frp=charStage.createFriendsPanel()});MOBILE?(CObj.getById("bshop").deltaHoverY=46,CObj.getById("bsofa").deltaHoverY=30):CObj.getById("btnachs").deltaHoverY=15;CObj.getById("bbuy1").click=charStage.openPremiumWindow;CObj.getById("bbuy2").click=charStage.openPremiumWindow;CObj.getById("tname").text=vkparams.first_name.toUpperCase()+" "+vkparams.last_name.toUpperCase();
CObj.getById("bpubl").click=function(){OpenInNewTab("https://vk.com/thanksgrandpa")};charStage.updateMusicButton(CObj.getById("bmusic"));CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("helpded").click=function(){var a=function(){charStage.pl.updateAppearence(!0,!1,null,null,null,"head2");CObj.enableButtons(!0);LevelManager.destroyLevel("helpded");
charStage.openHelp=!1};charStage.openHelp?a():(charStage.pl.gfx.skeleton.setAttachment("hat",null),charStage.pl.gfx.skeleton.setAttachment("head","head5"),CObj.enableButtons(!1),CObj.getById("helpded").gfx.interactive=!0,charStage.openHelp=!0,LevelManager.loadLevel("helpded",function(){CObj.getById("gohelp").click=function(){OpenInNewTab("http://bit.ly/1BnM4B8")};CObj.getById("closehelp").click=a},SM.inst.ol))};CObj.getById("btnfight").click=function(){if(1<=PlayerData.inst.playerItem.energy)--PlayerData.inst.playerItem.energy,
SM.inst.openStage(gameStage);else{var a=CObj.getById("tfenergy"),c=CObj.getById("energyback");new TweenMax(a,.1,{y:a.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});new TweenMax(c,.1,{y:c.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});charStage.openEnergyWindow()}};var a=new CPlayer(SCR_WIDTH/2,430);charStage.pl=a;a.gfx.scale.x=.34;a.gfx.scale.y=.34;a.updateAppearence(!0,!1,"breath",null,null,"head2");SM.inst.ol.addChild(a.gfx);a.gfx.interactive=!0;CObj.getById("bsofa").click=function(){CObj.enableButtons(!1);
charStage.disableWnd=SM.inst.addDisableWindow(null,SM.inst.fontLayer);charStage.disableWnd.interactive=!0;for(var a=0;a<CObj.objects.length;++a)CObj.checkType(CObj.objects[a],CEActionGUI)&&CObj.objects[a].btnReward&&(CObj.objects[a].btnReward.gfx.interactive=!0);charStage.closeEventsWnd=function(){rp(charStage.disableWnd);noc(charStage.disableWnd);CObj.enableButtons(!0);charStage.bar.gfx.visible=!1};onc(charStage.disableWnd,function(a){var b=charStage.bar;window.mouseX=a.global.x/SCR_SCALE;window.mouseY=
a.global.y/SCR_SCALE;window.mouseX>b.x-b.gfx.width/2&&window.mouseX<b.x+b.gfx.width/2&&window.mouseY>b.y-b.gfx.height/2&&window.mouseY<b.y+b.gfx.height/2||charStage.closeEventsWnd()});charStage.bar.gfx.parent.removeChild(charStage.bar.gfx);SM.inst.fontLayer.addChild(charStage.bar.gfx);charStage.bar.gfx.visible=!0;charStage.unreadActions=!1;charStage.updateNotifications()};PlayerData.inst.comboCheck();charStage.bar=new CScrollbar(180,309,"",380,524,"podlozhka actions.png","scroll line actions.png",
"scroll.png",50);charStage.bar.gfx.scale.x=.7;charStage.bar.gfx.scale.y=.7;charStage.bar.gfx.visible=!1;charStage.updateEvents();shopStage.updateStatsPanel();MOBILE||(charStage.frp=charStage.createFriendsPanel())};
...
b.push(h);b[d].platformid=a[d].platformid;""!=c&&(c+=",");c+=a[d].platformid;if(3>charStage.skip+d){var l;0==charStage.skip+d&&(l="1st place");1==charStage.skip+d&&(l="2nd place");2==charStage.skip+d&&(l="3rd place");var m=crsp(l);m.x=4;m.y=10;m.scale.x=.8;m.scale.y=.8;e.addChild(m)}h.y=10;h.x=35;e.x=20;e.y=15+28*d;g.x=55;k.x=370;f.x=-30;e.addChild(h);e.addChild(g);e.addChild(f);e.addChild(k);charStage.container.addChild(e)}VK&&""!=c&&VK.api("users.get",{user_ids:c,fields:"photo"},function(a){if(a.response)for(var c=
...
CHPBar.prototype.init=function(){this.upperOfsY||(this.upperOfsY=0);this.space=parseInt(this.space);this.gfx?(this.gfx.anchor.x=0,this.gfx.anchor.y=0):this.gfx=new PIXI.DisplayObjectContainer;this.space||(this.space=0);if(this.upperImage){var a=PIXI.Texture.fromFrame(this.upperImage+".png");this.upperImageClip=this.tile?new PIXI.TilingSprite(a,a.width,a.height):new PIXI.Sprite(a);this.upperImageClip.anchor.x=0;this.upperImageClip.anchor.y=0;this.upperImageClip.height-=this.space;this.gfx.addChild(this.upperImageClip)}this.initScale=
...
CPlayer.prototype.createDedGraphics=function(){var a=new PIXI.Spine("imgtps2/skeleton.json");a.skeleton.setSkinByName("perded");a.state.setAnimationByName(0,"idle",!0);this.gunBone=a.skeleton.findSlot("gun");this.boardSlot=a.skeleton.findSlot("board");this.rshSlot=a.skeleton.findSlot("r_shoulder");this.lshSlot=a.skeleton.findSlot("l_shoulder");a.scale.x=.3;a.scale.y=.3;CPlayer.rhRot||(CPlayer.rhRot=this.rshSlot.data.boneData.rotation);CPlayer.lhRot||(CPlayer.lhRot=this.lshSlot.data.boneData.rotation);
...
LauncherBG.prototype.spawnClip=function(a,b,c,d,e){d=CObj.DeserializeCObj(b);CObj.AssignTexturesToObjects([d],SM.inst.bg);var f=d.gfx;f&&f.parent&&f.parent.removeChild(f);d.gfx=null;d.destroy();var g=30;0==a.velocity&&(g=0);f?(a.clip.addChild(f),a.rightBound+=b.baseDim.x*b.scaleX,f.position.x=c?g+b.baseDim.x*b.scaleX/2:SCR_WIDTH+g+b.baseDim.x*b.scaleX/2+e-.8*this.maxVelocity-3):a.rightBound+=b.baseDim.x*b.scaleX;"skybg"==d.id&&(f.width=SCR_WIDTH,f.position.x=SCR_WIDTH/2)};
...
function BonusMonGnome(a,b,c,d){CMonster.apply(this,[a,b,null,d]);this.gfx=new PIXI.Spine("imgtps2/bird.json");this.gfx.state.setAnimationByName(0,"animation",!0);this.gfx.scale.x=.48;this.gfx.scale.y=.48;this.updateGraphics();LauncherBG.inst.ol.addChild(this.gfx);this.xp=20;this.lastDrop=0;this.allowTrackSpeed=!1;var e=this;new TweenMax(this,18,{vx:-40,ease:Circ.easeIn,onComplete:function(){e.destroy()}})}BonusMonGnome.prototype.collide=function(a){};
...
this.bar.width=8;this.bar.height=this.ph;this.bar.anchor.x=.5;this.bar.anchor.y=.5;this.bar.x=this.pw/2-4;this.bar.interactive=!0;this.bar.scrollbar=this;this.bar.mouseup=this.bar.mouseupoutside=this.toucher.mouseup;this.bar.mousedown=function(a){console.log("MOUSE DOWN");var b=this.scrollbar;setTimeout(function(){b.updatePosFromEvent(a.global.y)},20)};this.container=new PIXI.DisplayObjectContainer;this.container.x=-this.pw/2;this.container.y=-this.ph/2;this.sbMask=new PIXI.Graphics;this.sbMask.beginFill();
this.sbMask.drawRect(-this.pw/2,-this.ph/2,this.pw,this.ph);this.sbMask.endFill();this.container.mask=this.sbMask;this.gfx.addChild(this.sbMask);this.gfx.addChild(this.container);this.gfx.addChild(this.bar);this.gfx.addChild(this.toucher);this.pos=0;this.posScale=1;this.x=a;this.y=b}extend(CircleBar,CObj,!0);function CircleBar(a,b,c,d){CObj.apply(this,[a,b,c,d])}
...
b.addChild(a);SM.inst.superStage.addChild(b);b.x=SCR_WIDTH/2;new TweenMax(b,.4,{y:c.height/2});new TweenMax(b,.3,{delay:1.8,alpha:0,onComplete:function(){b.parent.removeChild(b)}})};
...
getDedImage=function(a){shopStage.transScreen&&(shopStage.transScreen.visible=!1);if(a)var b=300,c=365,d=-55,e=-120;else b=SCR_WIDTH/2,c=SCR_HEIGHT,e=d=0;var f=CObj.getById("photo"),g=CObj.getById("ava");f.textField.alpha=0;g.textField.alpha=0;a&&(CObj.getById("photo").gfx.visible=!1,CObj.getById("ava").gfx.visible=!1,CObj.getById("bgshopded").gfx.visible=!1);b=new PIXI.RenderTexture(b,c);renderer.render(stage,!0);c=new PIXI.Matrix;c.translate(d,e);b.render(SM.inst.superStage,c);d=b.getBase64();b.destroy(!0);
a&&(CObj.getById("bgshopded").gfx.visible=!0,CObj.getById("bback").gfx.visible=!0,CObj.getById("ava").gfx.visible=!0);shopStage.transScreen&&(shopStage.transScreen.visible=!0);return d};
...
window.loader=new PIXI.AssetLoader(preloaderAsset);window.loader.onComplete=preloaderLoaded;window.loader.load();new PlayerData;$(document).bind("contextmenu",function(){return!1});window.apiid=4654201;VK&&VK.init({apiId:window.apiid},function(){},function(){});function order(a){var b={type:"item",item:a};window.currentOrder=a;VK.callMethod("showOrderBox",b)}
...
function preloaderLoaded(){window.stage=new PIXI.Stage(16777215);window.px=SCR_WIDTH;window.py=SCR_HEIGHT;window.loadingScreen=new PIXI.Graphics;window.preloaderBg=new PIXI.DisplayObjectContainer;var a=1.1;window.MOBILE&&(a=1.3);var b=crsp("1st plan");b.x=SCR_WIDTH/2;window.MOBILE&&(b.anchor.y=.44);b.y=SCR_HEIGHT/2;b.scale.x=a;b.scale.y=a;var c=crsp("background");c.x=SCR_WIDTH/2;c.y=SCR_HEIGHT/2;c.scale.x=a;c.scale.y=a;preloaderBg.addChild(c);preloaderBg.addChild(b);a=crsp("loading bar");a.x=SCR_WIDTH/
2;a.y=SCR_HEIGHT/2+160;preloaderBg.addChild(a);SM.inst.addLayersToStage();SM.inst.superStage.addChild(preloaderBg);a=crsp("loading bar line");a.x=SCR_WIDTH/2;a.y=SCR_HEIGHT/2+160;window.pbWidth=a.width;a.mask=new PIXI.Graphics;a.mask.x=-pbWidth/2;window.progressMask=a.mask;a.addChild(a.mask);preloaderBg.addChild(a);SM.inst.addLayersToStage();SM.inst.superStage.addChild(loadingScreen);LevelManager.levFolder=MOBILE?"levels_mobile/":"levels/";window.loadingState="loading";window.assetsToLoader=[LevelManager.levFolder+
...
"rotatescreen.json",LevelManager.levFolder+"levchar.json",LevelManager.levFolder+"levscore.json",LevelManager.levFolder+"upperPanel.json",LevelManager.levFolder+"loading.json","imgtps2/comix.json","imgtps2/bg.json","imgtps2/achs.json","imgtps2/guiatlas.json","imgtps2/pussyatlas.json","imgtps2/dedgamedesc.xml","imgtps2/dedgamecaps.xml","imgtps2/dedgameXP.xml","imgtps2/skeleton.json","imgtps2/boss1.json","imgtps2/bird.json"];window.prevW=window.innerWidth;window.prevH=window.innerHeight;window.loader=
new PIXI.AssetLoader(assetsToLoader);document.body.appendChild(renderer.view);PIXI.scaleModes.DEFAULT=0;window.charStage=new CharStage;window.comixStage=new ComixStage;window.gameStage=new GameStage;window.achStage=new AchStage;window.shopStage=new ShopStage;requestAnimFrame(animate);window.pool=new ZPool;FRAME_DELAY=1E3/FRAME_RATE;window.addEventListener("resize",onWindowResize,!1);window.addEventListener("resizeend",onWindowResize,!1);rescale();onWindowResize();window.lastLoop=0;assetsButSoundsLoaded();
loader.onComplete=function(){window.loaded=!0;console.log("gfx loaded");window.gfxLoaded=!0;onAssetsLoaded()};loader.load();loader.onProgress=onAssetsProgress}function onAssetsProgress(a){console.log(window.assetsLoaded.toString()+" asset loaded");window.assetsLoaded++;a.json&&void 0!=a.json.objects&&(LevelManager.levels[a.url]=a.json)}
...
function onAssetsLoaded(){if(window.dbinit&&1==ZSound.loaded&&window.gfxLoaded){rp(preloaderBg);loadingState="game";rp(loadingScreen);preloaderBg=loadingScreen=null;PIXI.TextureCache["1st plan.png"].destroy(!0);window.progressMask=null;MOBILE||(window.addEventListener("orientationchange",orientchange,!1),orientchange());setTimeout("window.scrollTo(0, 1)",10);var a=document.getElementById("vk_ads_55316");a&&a.parentNode.removeChild(a);PlayerData.inst.updateEnergy();0==PlayerData.inst.playerItem.maxdistance?
...
function animate(){requestAnimFrame(animate);var a=window.time;window.time=(new Date).getTime();a=window.time-a;100<a&&(a=100);if("prepreload"!=loadingState)if("loading"==loadingState){a=assetsLoaded/window.assetsToLoader.length;1<a&&(a=1);window.preloaderTime||(window.preloaderTime=0);window.preloaderTime+=30;var b=5*Math.cos(window.preloaderTime/2E3),c=5*Math.sin(window.preloaderTime/1600);window.preloaderBg.children[0].x=SCR_WIDTH/2+b;window.preloaderBg.children[0].y=SCR_HEIGHT/2-c/3;window.preloaderBg.children[1].x=
