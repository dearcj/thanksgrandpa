...
window.loader=new PIXI.AssetLoader(preloaderAsset);window.loader.onComplete=preloaderLoaded;window.loader.load();PlayerData.dbInit();$(document).bind("contextmenu",function(){return!1});window.apiid=4654201;VK&&VK.init({apiId:window.apiid},function(){},function(){});function order(a){var b={type:"item",item:a};window.currentOrder=a;VK.callMethod("showOrderBox",b)}
