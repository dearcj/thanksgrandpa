...
PlayerData.getVKfriends=function(a){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";vkparams.novk?new PlayerData(a):(console.log("Gettin vk friends"),VK.api("friends.getAppUsers",{},function(a){console.log("friends.get data"+JSON.stringify(a))}),VK.api("friends.get",{user_id:vkparams.viewerid,order:"name",count:500,fields:"uid"},function(b){if(b.response&&b.response.length){vkparams.friends=b.response;vkparams.friendsids=[];console.log("VK friends+");for(b=0;b<vkparams.friends.length;++b)vkparams.friendsids.push(vkparams.friends[b].uid);
