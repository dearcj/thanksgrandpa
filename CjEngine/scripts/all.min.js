...
getDedImage=function(a){shopStage.transScreen&&(shopStage.transScreen.visible=!1);if(a)var b=300,c=365,d=-55,e=-120;else b=SCR_WIDTH/2,c=SCR_HEIGHT,e=d=0;b=new PIXI.RenderTexture(b,c);a&&(CObj.getById("bback").textField.alpha=0,CObj.getById("ava").textField.alpha=0,CObj.getById("bback").gfx.visible=!1,CObj.getById("ava").gfx.visible=!1,CObj.getById("bgshopded").gfx.visible=!1);renderer.render(stage,!0);c=new PIXI.Matrix;c.translate(d,e);b.render(SM.inst.superStage,c);d=b.getBase64();b.destroy(!0);
