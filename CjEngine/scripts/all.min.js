...
{};vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&VK||(MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");"?p=LOCAL"==window.location.search?(this.playerJSON='{"registered":false,"tokenJWT":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ2a2lkIjoiMjgyNjE3MjU5IiwidXNlcmlkIjoiNzhGNkY3Q0UtMjhFMy00QUVBLUIxNDMtMkJCQjJDQkVBNTREIn0.P-nWGsKp866LbgRrzuVhBut8p4ZaAZ8XZfhIchgsph4","playerItem":{"id":"78F6F7CE-28E3-4AEA-B143-2BBB2CBEA54D","ref":"282617259","vkapi":"282617259","xp":"256.94042397661","createDate":"2015-03-25 12:31:46","updateDate":"2015-04-17 00:50:13","userId":"Custom:F800A350-EE15-4F1C-9CCF-050B775A4CD9","money":"9639","crystals":"1000","maxdistance":"918","lvl":"3","energy":"10","name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0439","last_name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0447","rank":"2467","combodate":"2015-03-25 15:56:09","keys":null,"platformid":"282617259"}}',
this.loginPage="https://www.dedgame.ru/backendmysql/login.php",this.apiSource="https://www.dedgame.ru/backendmysql/dedapi.php",a=JSON.parse(this.playerJSON)):"?p=MYSQL"==window.location.search&&(this.loginPage="https://www.dedgame.ru/backendmysql/login.php",this.apiSource="https://www.dedgame.ru/backendmysql/dedapi.php");if(!a){this.loginPage="https://www.dedgame.ru/backend/login.php";this.apiSource="https://www.dedgame.ru/backend/dedapi.php";var a=getCookie("LOGIN_DATA"),a=decodeURIComponent(a),
a=a.replace(/\+/g," "),a=a.replace(/@/g,"+"),a=JSON.parse(a)}vkparams.token=a.tokenJWT;vkparams.registered=a.registered;vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.playerItem.id;PlayerData.inst.playerItem=PlayerData.inst.intJSON(a.playerItem);vkparams.viewerid=PlayerData.inst.playerItem.platformid;PlayerData.inst.playerItem.money=Math.round(PlayerData.inst.playerItem.money);PlayerData.inst.playerItem.crystals||(PlayerData.inst.playerItem.crystals=
