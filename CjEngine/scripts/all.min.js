...
null,null,{id:c.id,equipped:!0},function(a){console.log("SCORE UPDATED "+a);a&&a.crystals&&a.money?(PlayerData.inst.playerItem.crystals=parseFloat(a.crystals),PlayerData.inst.playerItem.money=parseFloat(a.money),PlayerData.inst.items_enabled.push({id_item:c.id,id_player:PlayerData.inst.playerItem.id}),shopStage.updateStatsPanel(),PlayerData.inst.equipItem(c,"1"),shopStage.pl.updateAppearence(!0,!1,null,null,null),shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos),
shopStage.updateStatsPanel(),shopStage.transScreen.parent.removeChild(shopStage.transScreen),shopStage.transScreen=null):shopStage.transScreen&&(rp(shopStage.transScreen),shopStage.transScreen=null)})):charStage.openPremiumWindow()};
...
xp:22E3},{crystals:3,money:3E3,xp:23E3},{crystals:3,money:3E3,xp:24E3},{crystals:3,money:3E3,xp:25E3},{crystals:3,money:3E3,xp:26E3},{crystals:3,money:3E3,xp:27E3},{crystals:3,money:3E3,xp:28E3},{crystals:3,money:3E3,xp:29E3},{crystals:3,money:3E3,xp:31E3},{crystals:3,money:3E3,xp:32E3},{crystals:3,money:3E3,xp:33E3},{crystals:3,money:3E3,xp:34E3},{crystals:3,money:3E3,xp:35E3}];this.items={};this.achs={};this.score=0;PlayerData.inst=this;window.vkparams={};vkparams.sid=getURLParameter("sid");vkparams.viewerid=
getURLParameter("viewer_id");vkparams.viewerid&&VK||(MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");this.loginPage="https://www.dedgame.ru/backendmysql/login.php";this.apiSource="https://www.dedgame.ru/backendmysql/dedapi.php";if("?p=LOCAL"==
window.location.search)this.playerJSON='{"registered":false,"tokenJWT":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ2a2lkIjoiMjgyNjE3MjU5IiwidXNlcmlkIjoiNzhGNkY3Q0UtMjhFMy00QUVBLUIxNDMtMkJCQjJDQkVBNTREIn0.P-nWGsKp866LbgRrzuVhBut8p4ZaAZ8XZfhIchgsph4","playerItem":{"id":"78F6F7CE-28E3-4AEA-B143-2BBB2CBEA54D","ref":"282617259","vkapi":"282617259","xp":"256.94042397661","createDate":"2015-03-25 12:31:46","updateDate":"2015-04-17 00:50:13","userId":"Custom:F800A350-EE15-4F1C-9CCF-050B775A4CD9","money":"9639","crystals":"1000","maxdistance":"918","lvl":"3","energy":"10","name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0439","last_name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0447","rank":"2467","combodate":"2015-03-25 15:56:09","keys":null,"platformid":"282617259"}}',
...
PlayerData.prototype.comboCheck=function(){if(this.playerItem.combodate){var a=datetime().getTime()-(new Date(sqlToJsDate(this.playerItem.updateDate))).getTime(),a=a/1E3/60;1740<a?this.playerItem.combodate=sqlDate(new Date):(a=datetime().getTime()-(new Date(sqlToJsDate(this.playerItem.combodate))).getTime(),a/=1E3,a/=60,4320<a&&this.progressAch("Gold medal 8",1,!1),14400<a&&this.progressAch("Gold medal 9",1,!1))}else this.playerItem.combodate=this.playerItem.updateDate};
...
PlayerData.prototype.azureReadData=function(){PlayerData.inst.callDedAPI("AZURE_READ_DATA",null,null,{score:PlayerData.inst.score,dist:Math.round(LauncherBG.inst.distance)},function(a){})};PlayerData.prototype.saveScore=function(){PlayerData.inst.callDedAPI("SAVE_SCORE",null,null,{score:PlayerData.inst.score,dist:Math.round(LauncherBG.inst.distance)},function(a){console.log(a)})};
...
incMetric("ACH GAINED "+this.achs[d].name));return a};
...
PlayerData.prototype.createAchProgress=function(a){for(a=0;a<this.achs.length;++a){for(var b=!1,c=0;c<this.achs_progress.length;++c)if(this.achs[a].id==this.achs_progress[c].id_ach){b=!0;break}b||this.achs_progress.push({id_ach:this.achs[a].id,id_player:this.playerItem.id,progress:0})}};incMetric=function(a){};PlayerData.prototype.getEventById=function(a){for(var b=0;b<this.events.length;++b)if(this.events[b].id==a)return this.events[b];return null};
PlayerData.prototype.updateScore=function(a){PlayerData.inst.callDedAPI("UPDATE_SCORE",null,null,null,a)};PlayerData.prototype.intJSON=function(a){var b="reward_ready progress xp_gain money_gain crystal_gain reqlvl exectime delay_min xp money crystals maxdistance lvl energy rank keys".split(" ");if("[object Array]"===Object.prototype.toString.call(a))for(b=0;b<a.length;++b)this.intJSON(a[b]);else for(var c in a)"string"==typeof a[c]&&-1<b.indexOf(c)&&(a[c]=parseFloat(a[c]));return a};
...
PlayerData.prototype.saveRunProgress=function(a){SM.inst.currentStage!=gameStage||gameStage.progressSaved||(a=Math.round(PlayerData.inst.playerItem.maxdistance),LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(a=Math.round(LauncherBG.inst.distance),PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=parseInt(a.rank)})),gameStage.progressSaved=!0,PlayerData.inst.playerItem.money+=Math.round(PlayerData.inst.score),PlayerData.inst.playerItem.maxdistance=a,PlayerData.inst.savePlayerData(),
gameStage.ari&&(gameStage.ari.kill(),gameStage.ari=null),PlayerData.inst.saveScore())};
...
{desc:"\u041f\u043e\u0441\u043c\u043e\u0442\u0440\u0435\u0442\u044c \u043d\u043e\u0432\u043e\u0441\u0442\u0438",name:"event3",delay_min:360,xp_gain:50,money_gain:0,crystal_gain:0,gfx:"action 3.png",reqlvl:2,exectime:30},{desc:"\u0417\u0430\u0433\u043b\u044f\u043d\u0443\u0442\u044c \u0432 \u0438\u043d\u0442\u0435\u0440\u043d\u0435\u0442",name:"event4",delay_min:1440,xp_gain:600,money_gain:0,crystal_gain:0,gfx:"action 4.png",reqlvl:7,exectime:140},{desc:"\u041f\u043e\u0441\u0442\u0438\u0440\u0430\u0442\u044c \u043c\u0443\u043d\u0434\u0438\u0440",
name:"event5",delay_min:2880,xp_gain:0,money_gain:0,crystal_gain:8,gfx:"action 5.png",reqlvl:9,exectime:120},{desc:"\u0414\u043e\u0435\u0441\u0442\u044c \u0443\u0436\u0438\u043d",name:"event6",delay_min:1440,xp_gain:100,money_gain:0,crystal_gain:0,gfx:"action 6.png",reqlvl:1,exectime:10},{desc:"\u041f\u043e\u0437\u0432\u043e\u043d\u0438\u0442\u044c \u0432\u043d\u0443\u043a\u0443",name:"event7",delay_min:1440,xp_gain:900,money_gain:0,crystal_gain:0,gfx:"action 7.png",reqlvl:8,exectime:80},{desc:"\u041f\u043e\u043c\u043e\u0447\u044c \u0431\u0430\u0431\u043a\u0435 \u043f\u043e \u0445\u043e\u0437\u044f\u0439\u0441\u0442\u0432\u0443",
name:"event8",delay_min:240,xp_gain:0,money_gain:0,crystal_gain:3,gfx:"action 8.png",reqlvl:6,exectime:50},{desc:"\u041f\u043e\u0434\u0440\u0435\u043c\u0430\u0442\u044c",name:"event9",delay_min:360,xp_gain:200,money_gain:0,crystal_gain:0,gfx:"action 9.png",reqlvl:5,exectime:120},{desc:"\u041f\u043e\u0441\u043c\u043e\u0442\u0440\u0435\u0442\u044c \u0444\u043e\u0442\u043e\u0433\u0440\u0430\u0444\u0438\u0438",name:"event10",delay_min:60,xp_gain:50,money_gain:0,crystal_gain:0,gfx:"action 10.png",reqlvl:1,
exectime:10},{desc:"\u041f\u043e\u0447\u0438\u0442\u0430\u0442\u044c \u043a\u043d\u0438\u0433\u0443",name:"event11",delay_min:240,xp_gain:0,money_gain:0,crystal_gain:1,gfx:"action 11.png",reqlvl:5,exectime:60},{desc:"\u041f\u043e\u0447\u0438\u0441\u0442\u0438\u0442\u044c \u043e\u0440\u0434\u0435\u043d\u0430",name:"event12",delay_min:1440,xp_gain:0,money_gain:0,crystal_gain:2,gfx:"action 12.png",reqlvl:1,exectime:1},{desc:"\u0421\u0445\u043e\u0434\u0438\u0442\u044c \u0432 \u043f\u043e\u043b\u0438\u043a\u043b\u0438\u043d\u0438\u043a\u0443",
name:"event13",delay_min:2880,xp_gain:0,money_gain:1E3,crystal_gain:3,gfx:"action 13.png",reqlvl:3,exectime:200},{name:"event14",desc:"\u041f\u043e\u043a\u043e\u0440\u043c\u0438\u0442\u044c \u043a\u043e\u0442\u0430",delay_min:360,xp_gain:0,money_gain:1E3,crystal_gain:0,gfx:"action 14.png",reqlvl:6,exectime:30}]},{tbname:"tb_achs",items:[{name:"Gold medal 1",desc:"\u041f\u0435\u0440\u0432\u044b\u0439 \u0431\u043e\u0439",gfx:"orden.png"},{name:"Gold medal 2",desc:"\u0414\u043e\u043b\u0433\u0438\u0439 \u043f\u0443\u0442\u044c 100\u043c",
