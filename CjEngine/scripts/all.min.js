...
PlayerData.prototype.saveRunProgress=function(a){SM.inst.currentStage!=gameStage||gameStage.progressSaved||(a=Math.round(PlayerData.inst.playerItem.maxdistance),LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(a=Math.round(LauncherBG.inst.distance)),gameStage.progressSaved=!0,PlayerData.inst.playerItem.money+=Math.round(PlayerData.inst.score),PlayerData.inst.playerItem.maxdistance=a,PlayerData.inst.saveScore(),PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=parseInt(a.rank)}))};
