...
var ZSound={available:!1,loaded:!1,Init:function(a){MOBILE||(createjs.FlashAudioPlugin.swfPath="res/snd/",createjs.Sound.registerPlugins([createjs.WebAudioPlugin,createjs.HTMLAudioPlugin,createjs.FlashAudioPlugin]),createjs.Sound.alternateExtensions=["mp3"]);ZSound.available=createjs.Sound.initializeDefaultPlugins();ZSound.available?(ZSound.loaded=0,ZSound.total=a.length,createjs.Sound.on("fileload",function(b){ZSound.loaded++;console.log(b.src);console.log("ZSound loaded "+ZSound.loaded.toString()+
" / "+a.length.toString());ZSound.loaded==a.length&&ZSound.soundLoadedFunction&&(ZSound.loaded=!0,ZSound.soundLoadedFunction())}),createjs.Sound.registerSounds(a,"res/snd/")):(console.log("ZSound loaded without plugins [NO SOUND]"),ZSound.loaded=!0)},PlayMusic:function(a){ZSound.loaded?ZSound.PlayMusicInner(a):soundLoadedFunction=function(){ZSound.PlayMusicInner(a);ZSound.loaded=!0}},UnMute:function(){ZSound.available||(ZSound.available=!0,createjs.Sound.setMute(!1))},Mute:function(){ZSound.available=
