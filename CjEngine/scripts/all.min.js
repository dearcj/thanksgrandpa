...
uploadPhoto=function(a){var b=new PIXI.RenderTexture(SCR_WIDTH/2,SCR_HEIGHT);renderer.render(stage,!0);b.render(SM.inst.superStage);var c=b.getBase64();b.destroy(!0);window.location=c;c=c.replace(/^data:image\/(png|jpg);base64,/,"");VK.api("photos.getWallUploadServer",{uid:a},function(a){a=a.response.upload_url;getParameterByName("hash",a);getParameterByName("rhash",a);$.ajax({type:"POST",url:"upload.php",data:{uploadUrl:a,photo:c},dataType:"text"}).success(function(a){a=JSON.parse(a);VK.api("photos.saveWallPhoto",
{uid:vkparams.viewerid,server:a.server,photo:a.photo,hash:a.hash},function(a){a.response&&VK.api("wall.post",{owner_id:vkparams.viewerid,message:"\u0425\u0423\u0419 \u0417\u0410\u041b\u0423\u041f\u0410",attachments:a.response[0].id},function(a){console.log("SSS")},function(a){console.log("SSS")})});console.log("")}).error(function(a){console.log("")})})};
