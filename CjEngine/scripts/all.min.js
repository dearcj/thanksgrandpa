...
CObj.getById("bpubl").click=function(){OpenInNewTab("https://vk.com/thanksgradpa")};charStage.updateMusicButton(CObj.getById("bmusic"));CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("helpded").click=function(){var a=function(){charStage.pl.updateAppearence(!0,!1,null,null,null,"head2");CObj.enableButtons(!0);LevelManager.destroyLevel("helpded");
