...
vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");var a=getCookie("LOGIN_DATA"),a=a.replace("%2"," "),a=decodeURIComponent(a);window.decompress(a);a=JSON.parse(a);vkparams.token=a.tokenJWT;vkparams.registered=a.registered;vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.playerItem.id;PlayerData.inst.playerItem=PlayerData.inst.intJSON(a.playerItem);
