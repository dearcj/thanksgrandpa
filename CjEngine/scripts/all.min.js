var CG_GROUND=1,CG_MONSTER=2,CG_PLAYER=4,CG_BULLET=8;function findByProp(a,b,c){for(var d=a.length,e=0;e<d;++e)if(a[e][b]==c)return a[e];return null}function getRand(a){return a[Math.floor(Math.random()*a.length)]}function clone(a){return JSON.parse(JSON.stringify(a))}function superRand(a){for(var b=0,c=0;c<a;++c)b+=Math.random();return b/a}
function dateDiff(a,b){var c=(new Date).getTime()-a.getTime(),c=(6E4*b-c)/1E3,d=Math.floor(c/3600),c=c%3600,e=Math.floor(c/60),c=c%60,f=Math.floor(c%60);return{d:c,m:e,h:d,s:f,timeString:(10>d?"0"+d:d)+" : "+(10>e?"0"+e:e)+" : "+(10>f?"0"+f:f)}}function crsp(a){var b=4<=a.length&&"."!=a.charAt(a.length-4)?".png":"";a=new PIXI.Sprite(PIXI.Texture.fromFrame(a+b));a.anchor.x=.5;a.anchor.y=.5;return a}function rp(a){a&&a.parent&&a.parent.removeChild(a)}
...
function rgbToHsl(a,b,c){a/=255;b/=255;c/=255;var d=Math.max(a,b,c),e=Math.min(a,b,c),f,g=(d+e)/2;if(d==e)f=e=0;else{var h=d-e,e=.5<g?h/(2-d-e):h/(d+e);switch(d){case a:f=(b-c)/h+(b<c?6:0);break;case b:f=(c-a)/h+2;break;case c:f=(a-b)/h+4}f/=6}return[f,e,g]}
var ZSound={available:!1,loaded:!1,Init:function(a){ZSound.available=createjs.Sound.initializeDefaultPlugins();ZSound.available&&(createjs.Sound.alternateExtensions=["mp3"],ZSound.loaded=0,ZSound.total=a.length,createjs.Sound.addEventListener("fileload",function(){ZSound.loaded++;ZSound.loaded==a.length&&(ZSound.soundLoadedFunction&&ZSound.soundLoadedFunction(),ZSound.loaded=!0)}),createjs.Sound.registerManifest(a,"res/snd/"))},PlayMusic:function(a){ZSound.loaded?ZSound.PlayMusicInner(a):soundLoadedFunction=
function(){ZSound.PlayMusicInner(a);ZSound.loaded=!0}},UnMute:function(){ZSound.available||(ZSound.available=!0,createjs.Sound.setMute(!1))},Mute:function(){ZSound.available=!1;createjs.Sound.setMute(!0)},PlayMusicInner:function(a){if(ZSound.musicInstanceName!=a||!ZSound.musicInstance){ZSound.musicInstance&&createjs.Sound.stop(ZSound.musicInstance);try{ZSound.musicInstanceName=a,ZSound.musicInstance=createjs.Sound.play(a,{interrupt:createjs.Sound.INTERRUPT_NONE,loop:999999})}catch(b){}}},Play:function(a){if(ZSound.available)try{createjs.Sound.play(a,
createjs.Sound.INTERRUPT_NONE,0,0,!1,1)}catch(b){}}};LevelManager=function(){};LevelManager.onComplete=function(){LevelManager.layer||(LevelManager.layer=SM.inst.ol);CObj.AssignTexturesToObjects(LevelManager.objs,LevelManager.layer);for(var a=0;a<LevelManager.objs.length;++a)LevelManager.objs[a].init();if(LevelManager.onVeryComplete)LevelManager.onVeryComplete()};LevelManager.removeLastLevel=function(){for(;0<LevelManager.objs.length;)LevelManager.objs[0].destroy(),LevelManager.objs.splice(0,1)};
...
null;this.transStart=0;this.transTime=600;this.doTrans=!1;var a=function(a){a.stopPropagation();a.stopImmediatePropagation();if(CObj.objects)for(var c=0;c<CObj.objects.length;++c)if(CObj.checkType(CObj.objects[c],CScrollbar),CObj.objects[c].mover)CObj.objects[c].onWheel(a)};document.addEventListener("mousewheel",a,!1);document.addEventListener("DOMMouseScroll",a,!1)}SM.inst=new SM;
...
return c};SM.prototype.addLayersToStage=function(){this.superStage.addChild(this.bg);this.superStage.addChild(this.ol);this.superStage.addChild(this.fg);this.superStage.addChild(this.guiLayer);this.superStage.addChild(this.superGuiLayer);this.superStage.addChild(this.fontLayer);stage.addChild(this.superStage);this.bg.mousemove=function(a){window.mouseX=a.global.x/SCR_SCALE;window.mouseY=a.global.y/SCR_SCALE}};
...
function MainMenu(){CustomStage.apply(this)}extend(MainMenu,CustomStage);MainMenu.prototype.onShow=function(){CustomStage.prototype.onShow.call(this);LevelManager.loadLevel("mainmenu",this.onShowContinue)};
MainMenu.prototype.onShowContinue=function(){window.loadedMenu=!0;ZSound.PlayMusic("trackmenu");CObj.getById("credits").click=function(){SM.inst.openStage(credStage)};mainMenu.muteBtn=CObj.getById("mutebtn");mainMenu.muteBtn.click=function(){ZSound.available?ZSound.Mute():ZSound.UnMute();dataStorage.soundEnabled=ZSound.available;updateDS();gameStage.updateSoundBtn(mainMenu.muteBtn)};CObj.getById("playgame").click=function(a){SM.inst.openStage(levSel)};gameStage.updateSoundBtn(mainMenu.muteBtn)};
MainMenu.prototype.soundCheckLoaded=function(){CObj.getById("layer").gfx.interactive=!0;CObj.getById("byes").click=function(){dataStorage.soundEnabled=ZSound.available;updateDS();ZSound.UnMute();SM.inst.openStage(levSel)};CObj.getById("bno").click=function(){dataStorage.soundEnabled=ZSound.available;updateDS();ZSound.Mute();SM.inst.openStage(levSel)}};MainMenu.prototype.onHide=function(a){CustomStage.prototype.onHide.call(this,null);CObj.destroyAll();CObj.processAll()};
...
LevSel.prototype.onHide=function(a){CustomStage.prototype.onHide.call(this,null);CObj.destroyAll();CObj.processAll()};LevSel.prototype.process=function(){CObj.processAll()};function GameStage(){this.invFR=1/FRAME_RATE}extend(GameStage,CustomStage);
...
gameStage.player.maxHp*this.texW*a,this.gfx.getChildAt(0).width=gameStage.player.maxHp*this.texW)}};GameStage.prototype.createCircle=function(a,b,c,d){a=new PIXI.Graphics;var e=2*Math.PI/100,f=0,g,h;a.moveTo(0,0);for(var k=0;100>k;++k)g=b+Math.cos(f)*d,h=c+Math.sin(f)*d,f+=e,a.lineTo(g,h),a.moveTo(g,h);return a};GameStage.prototype.process=function(){window.focus();CObj.processAll();var a=Math.floor(LauncherBG.inst.distance);gameStage.distText&&(gameStage.distText.text=a.toString());MM.inst.process()};
GameStage.prototype.onHide=function(a){gameStage.menuBtn=null;gameStage.player=null;gameStage.barXP=null;gameStage.floor=null;gameStage.winDelayedCall&&(gameStage.winDelayedCall.kill(!1),gameStage.winDelayedCall=null);gameStage.losing=!1;gameStage.scoreObj=null;gameStage.preWinText=null;gameStage.curweapon=null;gameStage.ammobar=null;gameStage.ammoico=null;TweenMax.killAll(!0,!0,!0);CustomStage.prototype.onHide.call(this,null);CObj.destroyAll();gameStage.preWinText=null;gameStage.dragObject=null;
stage.touchmove=null;stage.mousemove=null;stage.mousedown=null;stage.touchstart=null;stage.mouseup=null;stage.touchend=null;gameStage.pauseSprite&&(gameStage.pauseSprite.parent.removeChild(gameStage.pauseSprite),gameStage.pauseTexture.destroy(!0),gameStage.pauseTexture=null,gameStage.pauseSprite=null);gameStage.distText=null;LauncherBG.inst.destroy();LauncherBG.inst=null};GameStage.prototype.loseGame=function(){};GameStage.prototype.remGfx=function(a){a&&a.parent&&a.parent.removeChild(a)};
GameStage.prototype.updateXP=function(){gameStage.barXP.prop=PlayerData.inst.playerItem.xp/PlayerData.inst.xpLevel[PlayerData.inst.playerItem.lvl].xp};
GameStage.prototype.updateItems=function(){var a=0,b=[{key:"A",gfx:"1boost_button.png"},{key:"S",gfx:"2boost_button.png"},{key:"D",gfx:"3boost_button.png"}];gameStage.curweapon=w_rifle;for(var c=0;c<PlayerData.inst.items_enabled.length;++c){var d=PlayerData.inst.getItemById(PlayerData.inst.items_enabled[c].id_item);if(d.type==tBoost){var e;"Double"==d.name&&(e=CDoubleBooster);"Health"==d.name&&(e=CHeartBooster);"Magnet"==d.name&&(e=CMagnetBooster);"MarioStar"==d.name&&(e=CSupermanBooster);"Tablets"==
d.name&&(e=CTabletsBooster);var f=new e(30+50*a,SCR_HEIGHT-40,null);f.gfx=crsp(d.gfx);f.gfx.scale.x=.3;f.gfx.scale.y=.3;f.updateGraphics();f.ieid=PlayerData.inst.items_enabled[c].id;var g;if(null==f.activate)f.gfx.tint=7833634;else{if("A"==f.key)var h=b[0];"S"==f.key&&(h=b[1]);"D"==f.key&&(h=b[2]);h&&(g=crsp(h.gfx),g.scale.x=3,g.scale.y=3,g.y=82,g.x=-50,f.gfx.addChild(g))}SM.inst.guiLayer.addChild(f.gfx);a++}d.type==tWeapon&&PlayerData.inst.items_enabled[c].equipped&&("Rifle"==d.name&&(gameStage.curweapon=
w_rifle),"PPS"==d.name&&(gameStage.curweapon=w_pps),"AK-74"==d.name&&(gameStage.curweapon=w_ak74),"Minigun"==d.name&&(gameStage.curweapon=w_minigun),"Grenade launcher"==d.name&&(gameStage.curweapon=w_grenadel),"Plazma Cannon"==d.name&&(gameStage.curweapon=w_laser))}gameStage.player.weapon=gameStage.curweapon};
GameStage.prototype.shAfterLife=function(){if(!SM.inst.currentStage.killing){var a=new CircleBar(SCR_WIDTH/2,SCR_HEIGHT/2);a.init("bodrost cover.png","bodrost bar.png","bodrost bar bg.png");SM.inst.guiLayer.addChild(a.gfx);removeafterlife=function(){f.parent.removeChild(f);c.parent.removeChild(c);h.parent.removeChild(h);a.gfx.visible=!1};openScoreWnd=function(){SM.inst.currentStage.killing||(removeafterlife(),LevelManager.loadLevel("levelgameover",gameStage.openEndWindowLoaded,SM.inst.guiLayer))};
var b=new TweenMax(a,3,{pos:1,onComplete:openScoreWnd}),c=new PIXI.Sprite(PIXI.Texture.fromFrame("bodrost text.png"));c.anchor.x=.5;c.anchor.y=.5;c.x=SCR_WIDTH/2;c.y=SCR_HEIGHT/2-108;SM.inst.guiLayer.addChild(c);a.gfx.interactive=!0;a.gfx.click=function(){var c=function(){ZSound.Play("vzbodritsa");TweenMax.killTweensOf(a);removeafterlife();gameStage.removeFade();gameStage.unpause();gameStage.state="game";PlayerData.inst.playerItem.crystals-=g;gameStage.player.reveal();PlayerData.inst.savePlayerData();
new TweenMax(LauncherBG.inst,2,{maxVelocity:LauncherBG.inst.preVelocity})};if(PlayerData.inst.playerItem.crystals>g)c();else{order("item5");VK.orderComplete=function(){PlayerData.inst.playerItem.crystals>g&&c()};var d=function(){b.resume()};VK.orderFail=d;VK.orderCancel=d}};var d=a.gfx.scale.x,e=a.gfx.scale.y;a.gfx.mouseover=function(b){TweenMax.killTweensOf(a.gfx.scale);a.gfx.tint=CButton.tintColor;new TweenMax(a.gfx.scale,.6,{y:e+.05,ease:Elastic.easeOut});new TweenMax(a.gfx.scale,.4,{x:d+.05,ease:Elastic.easeOut})};
a.gfx.mouseout=function(b){a.gfx.tint=16777215;new TweenMax(a.gfx.scale,.3,{x:d,y:e,ease:Elastic.easeOut})};var f=new PIXI.Sprite(PIXI.Texture.fromFrame("bodrost star.png"));f.anchor.x=.5;f.anchor.y=.5;f.x=SCR_WIDTH/2;f.y=SCR_HEIGHT/2+120;SM.inst.guiLayer.addChild(f);var g=Math.round(2+LauncherBG.inst.distance/250),h=CTextField.createTextField({text:g.toString(),fontSize:22,align:"center"});h.tint=3355443;h.updateText();h.x=8+SCR_WIDTH/2;h.y=SCR_HEIGHT/2+107;SM.inst.guiLayer.addChild(h)}};
...
PlayerData.inst.score;PlayerData.inst.playerItem.maxdistance=b;PlayerData.inst.savePlayerData();CObj.getById("bshare").click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b"+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432. ",attachments:["photo2882845_347400805","https://vk.com/app4654201"]},function(a){})};for(c=0;5>c;++c)a(c);azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:5,skip:scoreStage.skip},
method:"post"}).done(function(a){a=a.result;for(var c=0;c<Math.min(5,a.length);++c)CObj.getById("tf"+(c+1).toString()+"2").text=a[c].name+" "+a[c].last_name,CObj.getById("tf"+(c+1).toString()+"3").text=a[c].maxdistance.toString(),b>a[c].maxdistance&&(CObj.getById("b"+(c+1).toString()).gfx.visible=!0,CObj.getById("b"+(c+1).toString()).text="\u042f \u0442\u0435\u0431\u044f \u0443\u0434\u0435\u043b\u0430\u043b",function(a,c){CObj.getById("b"+(a+1).toString()).click=function(){VK.api("wall.post",{owner_id:c.vkapi,
message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b"+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432. "+c.name+" "+c.last_name+", \u044f \u0442\u0435\u0431\u044f \u0443\u0434\u0435\u043b\u0430\u043b!",attachments:["photo2882845_347400805","https://vk.com/app4654201"]},function(a){})}}(c,a[c]));for(a=c;5>a;++a)CObj.getById("b"+(a+1).toString()).gfx.visible=!0,CObj.getById("b"+(a+1).toString()).text="\u041f\u0440\u0438\u0433\u043b\u0430\u0441\u0438\u0442\u044c \u0432 \u0438\u0433\u0440\u0443",
CObj.getById("b"+(a+1).toString()).click=function(){VK.callMethod("showInviteBox")}},function(a){})};GameStage.prototype.sessionEnd=function(){"game"==gameStage.state&&(gameStage.state="endsession",gameStage.pause(),gameStage.fadeScreen(),gameStage.shAfterLife())};GameStage.prototype.updateWindowLevWin=function(){gameStage.doPhys=!1};GameStage.prototype.updateScore=function(){gameStage.scoreObj&&(gameStage.scoreObj.text=PlayerData.inst.score.toString())};
function getChar(a){return null==a.which?32>a.keyCode?null:String.fromCharCode(a.keyCode):0!=a.which&&0!=a.charCode?32>a.which?null:String.fromCharCode(a.which):null}GameStage.prototype.doKeyDown=function(a){if("game"==gameStage.state){a=a||window.event;var b=String.fromCharCode(a.which);if(CBooster.list)for(var c=0;c<CBooster.list.length;++c)if(CBooster.list[c].key==b&&CBooster.list[c].activate)CBooster.list[c].onActivate();if((87==a.which||17==a.which)&&gameStage.player)gameStage.player.onJump()}};
GameStage.prototype.doKeyUp=function(a){"game"==gameStage.state&&(a=a||window.event,getChar(a),87!=a.which&&17!=a.which||!gameStage.player||(gameStage.player.jumpboost=!1))};
GameStage.prototype.onShow=function(){CustomStage.prototype.onShow.call(this);gameStage.killing=!1;gameStage.slowMoCoef=1;this.state="game";this.doProcess=!1;LauncherBG.inst=new LauncherBG(0,0);LauncherBG.inst.addLevel("plantPart2");for(var a=0;500>a;++a)LauncherBG.inst.process(!0);LauncherBG.inst.distance=0;MM.inst.init();LevelManager.loadLevel("hud",gameStage.onShowContinue,SM.inst.guiLayer)};
...
gameStage.reloadBar.init("recharge icon.png","recharge icon bar.png","recharge icon.png");gameStage.reloadBar.pos=.5;gameStage.reloadBar.gfx.visible=!1;SM.inst.guiLayer.addChild(gameStage.reloadBar.gfx);gameStage.player=new CPlayer(140,SCR_HEIGHT-160);gameStage.player.gfx.pivot.y=-190;gameStage.player.gfx.scale.x=.22;gameStage.player.gfx.scale.y=.22;gameStage.player.playable=!0;LauncherBG.inst.pllayer.addChild(gameStage.player.gfx);gameStage.updateItems();gameStage.barXP=CObj.getById("barxp");gameStage.player.updateAppearence(!0,
!0,"idle");TweenMax.delayedCall(1.3,function(){gameStage.player&&gameStage.player.gfx.skeleton.setAttachment("head","head1")});gameStage.player.weapon.state=gameStage.player.weapon.sFire;gameStage.player.weapon.recoilValue=0;gameStage.player.weapon.ammo=gameStage.player.weapon.magCapacity;gameStage.player.weapon.updateAmmo();gameStage.player.process();gameStage.scoreObj=CObj.getById("score");gameStage.updateScore();gameStage.worldSpeed=1;gameStage.createPools();gameStage.distText=CObj.getById("dist");
gameStage.visibleAllText=function(a){for(var c=0;c<SM.inst.fontLayer.children.length;++c)SM.inst.fontLayer.children[c].visible=a};gameStage.menuBtn=CObj.getById("menu");gameStage.menuBtn.click=function(){gameStage.doProcess&&gameStage.doPhys&&(gameStage.state="paused",gameStage.pause(),gameStage.fadeScreen(),gameStage.visibleAllText(!1),TweenMax.killTweensOf(gameStage.menuBtn,!0),LevelManager.loadLevel("levelmenu",gameStage.makePause,SM.inst.fontLayer))};gameStage.updateXP()};
GameStage.prototype.makePause=function(){removePause=function(){gameStage.state="game";gameStage.doProcess=!0;LevelManager.removeLastLevel();LevelManager.objs=null;gameStage.visibleAllText(!0);gameStage.doPhys=!0;gameStage.unpause();gameStage.removeFade()};CObj.getById("brestart").click=function(){removePause();SM.inst.openStage(gameStage)};CObj.getById("bresume").click=function(){removePause()};CObj.getById("blevs").click=function(){removePause();SM.inst.openStage(charStage)}};
GameStage.prototype.createPools=function(){0==pool.Size("textParticle")&&pool.Fill("textParticle",0,function(){var a=new CTextField(0,0);a.fontFamily=0;a.fontSize=25;a.align="center";a.gfx=CTextField.createTextField(a);a.gfx.scale.x*=window.addScale;a.gfx.scale.y*=window.addScale;return a});0==pool.Size("smoke")&&pool.Fill("smoke",20,function(){return crsp("smoke")});0==pool.Size("coinCollect")&&pool.Fill("coinCollect",10,function(){var a=CObj.createMovieClip("coinfx.png");a.scale.x=.7;a.scale.y=
.7;a.anchor.x=.5;a.anchor.y=.5;return a});0==pool.Size("expl")&&pool.Fill("expl",4,function(){var a=CObj.createMovieClip("Boom");a.anchor.x=.5;a.anchor.y=.5;a.scale.x=1;a.scale.y=1;return a});0==pool.Size("blood")&&pool.Fill("blood",11,function(){var a=CObj.createMovieClip("blood");a.anchor.x=.5;a.anchor.y=.5;a.scale.x=1;a.scale.y=1;return a});0==pool.Size("bloodblow")&&pool.Fill("bloodblow",6,function(){var a=CObj.createMovieClip("bloodblow");a.anchor.x=.5;a.anchor.y=.5;a.scale.x*=1;a.scale.y*=1;
return a})};GameStage.prototype.removeFade=function(){TweenMax.killTweensOf(gameStage.pauseSprite);gameStage.pauseSprite.parent.removeChild(gameStage.pauseSprite);gameStage.pauseSprite=null;PIXI.Texture.removeTextureFromCache(gameStage.pauseTexture);gameStage.pauseTexture.destroy();gameStage.pauseTexture=null};
GameStage.prototype.fadeScreen=function(){gameStage.pauseTexture=new PIXI.RenderTexture(SCR_WIDTH,SCR_HEIGHT);gameStage.pauseSprite=new PIXI.Graphics;gameStage.pauseSprite.beginFill(5636061,.4);gameStage.pauseSprite.drawRect(0,0,SCR_WIDTH,SCR_HEIGHT);gameStage.pauseSprite.endFill();gameStage.pauseSprite.alpha=0;gameStage.pauseSprite.blendMode=PIXI.blendModes.DIFFERENCE;new TweenMax(gameStage.pauseSprite,1.1,{alpha:1,ease:Elastic.easeOut});SM.inst.guiLayer.addChild(gameStage.pauseSprite)};
GameStage.prototype.unpause=function(){gameStage.doProcess=!0;gameStage.player&&(gameStage.player.gfx.autoUpdate=!0);window.focus();TweenMax.resumeAll()};GameStage.prototype.pause=function(){gameStage.doProcess&&(gameStage.doProcess=!1,gameStage.player&&(gameStage.player.gfx.autoUpdate=!1),TweenMax.pauseAll())};GameStage.prototype.updateSoundBtn=function(a){ZSound.available?a.gfx.gotoAndStop(0):a.gfx.gotoAndStop(1)};function Credits(){CustomStage.apply(this)}extend(Credits,CustomStage);
...
AchStage.prototype.onShow=function(){this.doProcess=!1;CustomStage.prototype.onShow.call(this);LevelManager.loadLevel("levach",this.onShowContinue)};AchStage.prototype.createDesc=function(){var a=crsp("yashick");a.interactive=!1;a.anchor.x=-.2;a.anchor.y=-.2;var b=CTextField.createTextField({align:"left",fontSize:"24"});a.addChild(b);b.x=20;b.y=10;b=CTextField.createTextField({align:"left",fontSize:"24"});b.x=20;a.addChild(b);a.alpha=0;return a};
...
CharStage.prototype.onShow=function(){this.doProcess=!1;charStage.skipFriends=0;CustomStage.prototype.onShow.call(this);charStage.icons=[];LevelManager.loadLevel("levchar",function(){LevelManager.loadLevel("upperPanel",charStage.onShowContinue,SM.inst.ol)},SM.inst.ol)};
...
CharStage.prototype.createFriendsPanel=function(){for(var a=new PIXI.DisplayObjectContainer,b="",c=[],d=charStage.skipFriends,e=0+d;e<5+d;++e){var f=new CButton(63+100*(e-d),5,"add friend"),g=f.gfx;g.parent.removeChild(g);g.anchor.x=.5;g.anchor.y=.5;f.hover=!0;vkparams.friendsIngame&&e<vkparams.friendsIngame.length&&(f.text=vkparams.friendsIngame[e].name+vkparams.friendsIngame[e].last_name);f.init();a.addChild(g);!vkparams.friendsIngame||e>=vkparams.friendsIngame.length?g.click=function(){VK.callMethod("showInviteBox")}:
(username=vkparams.friendsIngame[e].name,g.click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:username+", \u0432\u043e\u0437\u0432\u0440\u0430\u0449\u0430\u0439\u0441\u044f \u0432 \u0438\u0433\u0440\u0443 \u0434\u0440\u0443\u0436\u0438\u0449\u0435",attachments:["photo2882845_347400805","https://vk.com/app4654201"]},function(a){})},""!=b&&(b+=","),b+=vkparams.friendsIngame[e].vkapi.toString(),g.vkapi=vkparams.friendsIngame[e].vkapi,c.push(g))}VK&&""!=b&&VK.api("users.get",{user_ids:b,
fields:"photo"},function(a){if(a.response)for(var b=0;b<a.response.length;++b){var d=a.response[b].photo;if(!a.response||0==a.response.length)break;var e=c[b];e.loader=new PIXI.ImageLoader(d);(function(a,b){a.loader.onLoaded=function(){var c=new PIXI.Sprite(PIXI.TextureCache[b]);c.anchor.x=.5;c.anchor.y=.5;a.addChild(c);charStage.icons.push(c)}})(e,d);e.loader.load()}});a.x=215;a.y=SCR_HEIGHT-50;SM.inst.guiLayer.addChild(a);return a};
CharStage.prototype.openPremiumWindow=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);LevelManager.loadLevel("levelpremium",function(){close=function(){LevelManager.removeLastLevel();CObj.enableButtons(!0);a.parent.removeChild(a)};charStage.skipFriends=0;orderFunc=function(a){ZSound.Play("buy");order(a);shopStage.updateStatsPanel()};CObj.getById("buy1").click=function(){orderFunc("item1")};CObj.getById("buy2").click=function(){orderFunc("item2")};CObj.getById("buy3").click=
function(){orderFunc("item3")};CObj.getById("buy4").click=function(){orderFunc("item4")};CObj.getById("buy5").click=function(){orderFunc("item5")};CObj.getById("buy6").click=function(){orderFunc("item6")};CObj.getById("btnclose").click=close;CObj.getById("btnfree").click=close},SM.inst.fontLayer)};
CharStage.prototype.openEnergyWindow=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);a.interactive=!0;LevelManager.loadLevel("energywindow",function(){CObj.getById("breplenish").click=function(){order("item7");VK.orderComplete=function(){shopStage.updateStatsPanel();close()}};close=function(){rp(a);CObj.enableButtons(!0);LevelManager.removeLastLevel();a.click=null};a.click=function(){var a=CObj.getById("energybg");a.gfx.getBounds();window.mouseX>a.x-a.gfx.width/
2&&window.mouseX<a.x+a.gfx.width/2&&window.mouseY>a.y-a.gfx.height/2&&window.mouseY<a.y+a.gfx.height/2||close()}},SM.inst.fontLayer)};
CharStage.prototype.onShowContinue=function(){charStage.doProcess=!0;charStage.skip=0;charStage.tab="total";charStage.showRecords=10;PlayerData.inst.eventsplayer.sort(function(a,c){return PlayerData.inst.getEventById(a.id_edevent).reqlvl-PlayerData.inst.getEventById(c.id_edevent).reqlvl});CObj.getById("frprev").click=function(){charStage.skipFriends-=5;0>charStage.skipFriends&&(charStage.skipFriends=0);charStage.frp.parent.removeChild(charStage.frp);charStage.frp=charStage.createFriendsPanel()};CObj.getById("frnext").click=
function(){charStage.skipFriends+=5;charStage.frp.parent.removeChild(charStage.frp);charStage.frp=charStage.createFriendsPanel()};CObj.getById("bbuy1").click=charStage.openPremiumWindow;CObj.getById("bbuy2").click=charStage.openPremiumWindow;vkparams.first_name&&(CObj.getById("tname").text=vkparams.first_name.toUpperCase()+" "+vkparams.last_name.toUpperCase());CObj.getById("bset").click=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);a.interactive=!0;var c=
LevelManager.loadLevel("settings",function(){CObj.getById("bcallback").click=function(){window.location.href="mailto:thanksgrandpa@gmail.com";window.open("mailto:thanksgrandpa@gmail.com","mail")};CObj.getById("bmusic").click=function(){ZSound.available?ZSound.Mute():ZSound.UnMute()};a.click=function(){var d=CObj.getById("setbg");d.gfx.getBounds();if(!(window.mouseX>d.x-d.gfx.width/2&&window.mouseX<d.x+d.gfx.width/2&&window.mouseY>d.y-d.gfx.height/2&&window.mouseY<d.y+d.gfx.height/2)){rp(a);CObj.enableButtons(!0);
for(d=0;d<c.length;++d)c[d].destroy();a.click=null}}},SM.inst.fontLayer)};CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("btnfight").click=function(){if(1<=PlayerData.inst.playerItem.energy)--PlayerData.inst.playerItem.energy,SM.inst.openStage(gameStage);else{var a=CObj.getById("tfenergy"),c=CObj.getById("energyback");new TweenMax(a,
.1,{y:a.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});new TweenMax(c,.1,{y:c.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});charStage.openEnergyWindow()}};var a=new CPlayer(400,430);charStage.pl=a;a.gfx.scale.x=.34;a.gfx.scale.y=.34;a.updateAppearence(!0,!1,"breath");SM.inst.ol.addChild(a.gfx);a.gfx.interactive=!0;CObj.getById("bsofa").click=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);a.interactive=!0;for(var c=0;c<CObj.objects.length;++c)CObj.checkType(CObj.objects[c],
CEActionGUI)&&CObj.objects[c].btnReward&&(CObj.objects[c].btnReward.gfx.interactive=!0);charStage.closeEventsWnd=function(){a.parent.removeChild(a);CObj.enableButtons(!0);charStage.bar.gfx.visible=!1};a.click=function(){charStage.bar.gfx.getBounds().contains(window.mouseX,window.mouseY)||charStage.closeEventsWnd()};charStage.bar.gfx.parent.removeChild(charStage.bar.gfx);SM.inst.fontLayer.addChild(charStage.bar.gfx);charStage.bar.gfx.visible=!0};PlayerData.inst.comboCheck();charStage.bar=new CScrollbar(180,
309,"",380,524,"podlozhka actions.png","scroll line actions.png","scroll.png",50);charStage.bar.gfx.scale.x=.7;charStage.bar.gfx.scale.y=.7;charStage.bar.gfx.visible=!1;charStage.updateEvents();shopStage.updateStatsPanel();charStage.frp=charStage.createFriendsPanel()};
CharStage.prototype.updateEvents=function(){charStage.bar.clear();for(var a=0;a<PlayerData.inst.eventsplayer.length;++a){var b=new CEActionGUI(50,70+150*a),c=PlayerData.inst.getEventById(PlayerData.inst.eventsplayer[a].id_edevent);b.init(PlayerData.inst.eventsplayer[a],c,c.gfx,"progress fore.png","progress bg.png");b.updateGraphics();if(charStage.eventsArray){if(c=findByProp(charStage.eventsArray,"id",PlayerData.inst.eventsplayer[a].id))b.acting=c.acting,b.startTime=c.startTime,b.execTime=c.execTime,
b.pos=c.pos,b.acting&&(b.progressbg.visible=!0,b.progressfore.visible=!0);console.log(c)}charStage.bar.container.addChild(b.gfx)}charStage.bar.updateHeight();charStage.bar.pos=0};
CharStage.prototype.process=function(){if(Math.round(PlayerData.inst.playerItem.energy)<Math.round(PlayerData.inst.maxEnergy)){var a=dateDiff(PlayerData.inst.playerItem.updateDate,PlayerData.inst.delayEnergyMS/6E4);CObj.getById("tfdelay").text=a.timeString}else CObj.getById("tfdelay").text="";CObj.processAll();for(var b=a=0;b<CObj.objects.length;++b)if(CObj.checkType(CObj.objects[b],CEActionGUI)&&CObj.objects[b].acting){var c=(window.time-CObj.objects[b].startTime)/CObj.objects[b].execTime;1<=c?(CObj.objects[b].pos=
1,CObj.objects[b].endAction()):CObj.objects[b].pos=c;a++}};CharStage.prototype.updateFriends=function(){PlayerData.inst.savePlayerData();azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:charStage.showRecords,skip:charStage.skip},method:"post"}).done(function(a){charStage.updateSB(a.result)},function(a){})};
CharStage.prototype.updateTotal=function(){azureclient.invokeApi("get_scores",{body:{filter:null,take:charStage.showRecords,skip:charStage.skip},method:"post"}).done(function(a){charStage.updateSB(a.result)},function(a){})};
CharStage.prototype.openScore=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);LevelManager.loadLevel("levscore",function(){charStage.container=new PIXI.DisplayObjectContainer;charStage.container.x=170;charStage.container.y=170;SM.inst.fontLayer.addChild(charStage.container);CObj.getById("tplscore").text=PlayerData.inst.playerItem.maxdistance.toString()+"\u043c.";CObj.getById("tplace").text=PlayerData.inst.playerItem.rank.toString()+".";CObj.getById("bfriends").click=
function(){charStage.skip=0;"friends"==charStage.tab?(CObj.getById("bfriends").text="\u0412\u0441\u0435 \u043e\u0447\u043a\u0438",charStage.tab="total",charStage.updateTotal()):(CObj.getById("bfriends").text="\u041e\u0447\u043a\u0438 \u0434\u0440\u0443\u0437\u0435\u0439",charStage.tab="friends",charStage.updateFriends())};CObj.getById("bfriends").click();CObj.getById("bforwardlist").click=function(){charStage.skip+=charStage.showRecords;"total"==charStage.tab&&charStage.updateTotal();"friends"==charStage.tab&&
charStage.updateFriends()};CObj.getById("bback").click=function(){CObj.enableButtons(!0);for(LevelManager.removeLastLevel();0<charStage.container.children.length;)rp(charStage.container.getChildAt(0));rp(charStage.container);rp(a);charStage.container=null};CObj.getById("bbacklist").click=function(){charStage.skip-=charStage.showRecords;0>charStage.skip&&(charStage.skip=0);"total"==charStage.tab&&charStage.updateTotal();"friends"==charStage.tab&&charStage.updateFriends()}},SM.inst.fontLayer)};
CharStage.prototype.updateSB=function(a){for(;0<charStage.container.children.length;)rp(charStage.container.getChildAt(0));for(var b=[],c="",d=0;d<a.length;++d){var e=new PIXI.DisplayObjectContainer,f=CTextField.createTextField({tint:3355443,fontSize:15,text:(charStage.skip+d+1).toString()+"."}),g=CTextField.createTextField({tint:3355443,fontSize:15,text:a[d].name+" "+a[d].last_name}),h=CTextField.createTextField({tint:3355443,fontSize:15,text:Math.round(a[d].maxdistance).toString()+"\u043c."}),k=
crsp("buy small button");b.push(k);b[d].vkapi=a[d].vkapi;""!=c&&(c+=",");c+=a[d].vkapi;if(3>charStage.skip+d){var l;0==charStage.skip+d&&(l="1st place");1==charStage.skip+d&&(l="2nd place");2==charStage.skip+d&&(l="3rd place");var m=crsp(l);m.x=4;m.y=10;m.scale.x=.8;m.scale.y=.8;e.addChild(m)}k.y=10;k.x=35;e.x=20;e.y=15+28*d;g.x=55;h.x=370;e.addChild(k);e.addChild(g);e.addChild(f);e.addChild(h);charStage.container.addChild(e)}VK&&""!=c&&VK.api("users.get",{user_ids:c,fields:"photo"},function(a){if(a.response)for(var c=
...
ShopStage.prototype.onShow=function(){PlayerData.inst.playerItem.money=1E4;PlayerData.inst.playerItem.crystals=1E3;azureclient.getTable("tb_players").update(PlayerData.inst.playerItem);LevelManager.loadLevel("levshop",function(){LevelManager.loadLevel("upperPanel",shopStage.onShowContinue,SM.inst.ol)})};
ShopStage.prototype.checkEq=function(a){for(var b=0;b<PlayerData.inst.items_enabled.length;++b)if(PlayerData.inst.items_enabled[b].id_item==a.id&&1==PlayerData.inst.items_enabled[b].equipped)return!0;return!1};ShopStage.prototype.checkOwned=function(a){for(var b=0;b<PlayerData.inst.items_enabled.length;++b)if(a.id==PlayerData.inst.items_enabled[b].id_item)return!0;return!1};
ShopStage.prototype.unequipAll=function(){for(var a=0;a<PlayerData.inst.items_enabled.length;++a)PlayerData.inst.getItemById(PlayerData.inst.items_enabled[a].id_item).type==shopStage.currentFilter&&(PlayerData.inst.items_enabled[a].equipped=!1)};
...
c.pricecrys:PlayerData.inst.playerItem.money-=c.price,shopStage.updateStatsPanel(),ZSound.Play("buy"),azureclient.invokeApi("buy_item",{body:{id_item:c.id,id_player:PlayerData.inst.playerItem.id},method:"post"}).done(function(a){PlayerData.inst.loadData(function(){PlayerData.inst.equipItem(c);shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos);shopStage.updateStatsPanel();shopStage.transScreen.parent.removeChild(shopStage.transScreen);
shopStage.transScreen=null})},function(a){shopStage.transScreen.parent.removeChild(shopStage.transScreen);shopStage.transScreen=null})):charStage.openPremiumWindow()};
ShopStage.prototype.createItemBtn=function(a){function b(a){shopStage.buyItem(a,!0)}function c(b){PlayerData.inst.equipItem(a);shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos)}function d(a){shopStage.buyItem(a,!1)}var e=new PIXI.DisplayObjectContainer,f=crsp(a.gfx);f.x=0;f.scale.x=.5;f.scale.y=.5;f.y=f.height/2;e.addChild(f);f.interactive=!0;f.mouseover=function(b){if(a.type==tWeapon||a.type==tApp+tHat){var c=b=
null;a.type==tWeapon&&(c=a.gfx);a.type==tApp+tHat&&(b=a.gfx);shopStage.pl.updateAppearence(!0,!1,null,c,b)}TweenMax.killTweensOf(f.scale);f.tint=CButton.tintColor;new TweenMax(f.scale,.6,{y:.55,ease:Elastic.easeOut});new TweenMax(f.scale,.4,{x:.55,ease:Elastic.easeOut});c=a.desc.split("|");b="\u041e\u043f\u0438\u0441\u0430\u043d\u0438\u0435 \u0431\u0443\u0434\u0435\u0442 \u0437\u0434\u0435\u0441\u044c..... \u043f\u043e\u0437\u0436\u0435";1<c.length&&(b=c[2]);c=CObj.getById("tfdescd");c.setTextSafe(b);
console.log("MOUSE IN");c.item=a};f.mouseout=function(b){b=CObj.getById("tfdescd");b.item==a&&b.setTextSafe("");a.type!=tWeapon&&a.type!=tApp+tHat||shopStage.pl.updateAppearence(!0,!1,null,null,null);f.tint=16777215;f.currentFrame&&f.gotoAndStop(1);new TweenMax(f.scale,.3,{x:.5,y:.5,ease:Elastic.easeOut});console.log("MOUSE OUT")};var g=this.checkOwned(a),h=this.checkEq(a);tftext="";g||(tftext=0>a.pricecrys&&0>a.price?"":0<a.pricecrys?a.pricecrys.toString():a.price.toString());var k,l="",m=0,n="buy button";
g?(m=-45,1==h?n="equipped button":(k=c,n="wear button"),"bstuff"==shopStage.currentTab&&(n="equipped button")):a.reqlvl>PlayerData.inst.playerItem.lvl?(k=b,n="unlock button",l="\u041c\u0418\u041d "+a.reqlvl.toString()+" \u0423\u0420."):(k=d,n="buy button",m=-15);g=new CButton(0,182+m,n);"equipped button"==n&&(g.gfx.mouseout=null,g.gfx.mouseover=null);g.fontSize=33;g.addToSameLayer=!0;g.gfx.anchor.x=.5;g.gfx.anchor.y=.5;g.gfx.scale.x=.8;g.gfx.scale.y=.8;g.init();g.gfx.parent.removeChild(g.gfx);g.item=
a;g.gfx.btn=g;g.click=k;e.addChild(g.gfx);g.text&&(g.text=g.text);e.btn=g;if(tftext){if(0<a.price)var p="price coin.png";0<a.pricecrys&&(p="price star.png");p&&(k=crsp(p),k.x=0,k.y=110,e.addChild(k))}k=new CTextField;k.tint="0x333333";k.fontSize=15;k.align="center";k.init();e.infoTF=k;k.x=0;k.y=135;k.gfx.parent.removeChild(k.gfx);k.text=l;e.addChild(k.gfx);l=new CTextField;l.tint="0x333333";l.fontSize=17;l.align="left";l.text=tftext;l.init();e.tfprice=l;l.x=2;l.y=100;l.gfx.parent.removeChild(l.gfx);
e.addChild(l.gfx);l.text=l.text;e.destroy=function(){e.tfprice.destroy();e.btn&&(e.btn.destroy(),e.btn=null);e.tfprice=null;e.parent.removeChild(e)};return e};
...
shopStage.createItemBtn(PlayerData.inst.items[d]);g.x=a/2+f%e*a;g.y=40+220*Math.floor(f/e);this.bar.container.addChild(g);f++}c||(c=0);this.bar.pos=c};
...
ShopStage.prototype.onShowContinue=function(){CustomStage.prototype.onShow.call(this);shopStage.bar=new CScrollbar(610,335,"",380,524);shopStage.bar.gfx.parent.removeChild(shopStage.bar.gfx);SM.inst.ol.addChildAt(shopStage.bar.gfx,1);shopStage.updateStatsPanel();CObj.getById("bbuy1").click=charStage.openPremiumWindow;CObj.getById("bbuy2").click=charStage.openPremiumWindow;CObj.getById("bback").click=function(){SM.inst.openStage(charStage)};CObj.getById("bstuff").click=function(){shopStage.updateBar("bstuff",
tBoost)};CObj.getById("bweap").click=function(){shopStage.updateBar("bweap",tWeapon)};CObj.getById("bcloth").click=function(){shopStage.updateBar("bcloth",tApp)};shopStage.updateBar("bstuff",tBoost);var a=new CPlayer(180,430);shopStage.pl=a;shopStage.pl.updateAppearence(!0,!1,"breath",null,null);a.gfx.scale.x=.4;a.gfx.scale.y=.4;SM.inst.ol.addChild(a.gfx)};function levelClick(a){gameStage.currentLevel=a.target.levelNum;SM.inst.openStage(gameStage)}
ShopStage.prototype.onHide=function(a){shopStage.pl=null;CustomStage.prototype.onHide.call(this,null);CObj.destroyAll();CObj.processAll()};ShopStage.prototype.process=function(){if(Math.round(PlayerData.inst.playerItem.energy)<Math.round(PlayerData.inst.maxEnergy)){var a=dateDiff(PlayerData.inst.playerItem.updateDate,PlayerData.inst.delayEnergyMS/6E4);CObj.getById("tfdelay").text=a.timeString}else CObj.getById("tfdelay").text="";CObj.processAll()};function ScoreStage(){CustomStage.apply(this)}
...
k=crsp("buy small button");b.push(k);b[d].vkapi=a[d].vkapi;""!=c&&(c+=",");c+=a[d].vkapi;if(3>scoreStage.skip+d){var l;0==scoreStage.skip+d&&(l="1st place");1==scoreStage.skip+d&&(l="2nd place");2==scoreStage.skip+d&&(l="3rd place");var m=crsp(l);m.x=4;m.y=10;m.scale.x=.8;m.scale.y=.8;e.addChild(m)}k.y=10;k.x=35;e.x=20;e.y=15+28*d;g.x=55;h.x=370;e.addChild(k);e.addChild(g);e.addChild(f);e.addChild(h);scoreStage.container.addChild(e)}VK&&""!=c&&VK.api("users.get",{user_ids:c,fields:"photo"},function(a){for(var c=
...
"friends"==scoreStage.tab&&scoreStage.updateFriends()}};ScoreStage.prototype.process=function(){CObj.processAll()};ZPool=function(){this.objects={};ZPool.Inst=this;return this};ZPool.prototype.Fill=function(a,b,c){void 0==this.objects[a]&&(this.objects[a]=[]);for(var d=0;d<b;d++){var e=c();e.poolName=a;this.objects[a].push(e)}};
ZPool.prototype.Pop=function(a){if(void 0==this.objects[a])console.warn("Error: not found '"+a+"' in pool.");else if(0==this.objects[a].length)console.warn("Error: pool empty. Element '"+a+"'");else return this.objects[a].pop()};ZPool.prototype.Size=function(a){return void 0==this.objects[a]?0:this.objects[a].length};ZPool.prototype.Push=function(a){void 0==a.poolName?console.warn("Error: Can't push unnamed element in pool."):this.objects[a.poolName].push(a)};
...
CObj.prototype.onContactEnd=function(a){};CObj.prototype.collide=function(a){};CObj.prototype.process=function(){0!=this.av&&(this.rotation+=this.av*gameStage.slowMoCoef);0!=this.vx&&(this.x+=this.vx*gameStage.slowMoCoef);0!=this.vy&&(this.y+=this.vy*gameStage.slowMoCoef);CObj.debugView&&this.debugGfx&&(this.debugGfx.position.x=this.x,this.debugGfx.position.y=this.y);this.gravityEnabled&&(this.vy+=this.gravPower);this.allowTrackSpeed&&(this.vx=-LauncherBG.inst.maxVelocity);this.updateGraphics()};
CObj.prototype._destroy=function(){this.doRemove&&(CObj.debugView&&this.debugGfx&&(this.debugGfx.parent.removeChild(this.debugGfx),this.debugGfx=null),this.gfx&&this.gfx.parent&&this.gfx.parent.removeChild(this.gfx),this.gfx=null)};CObj.prototype.destroy=function(){this.poolName||(this.doRemove=!0)};CObj.getById=function(a){for(var b=0;b<CObj.objects.length;++b)if(CObj.objects[b].id==a)return CObj.objects[b]};CObj.checkType=function(a,b){return a.constructor==b};
CObj.destroyAll=function(){for(var a=CObj.objects.length,b=0;b<a;++b)CObj.objects[b].mechanicalDestroy=!0,CObj.objects[b].destroy();CObj.processAll()};
...
d.hitTestCircles.length,g=0;g<f;++g){var h=e.x-(d.x+d.hitTestCircles[g].x),k=e.y-(d.y+d.hitTestCircles[g].y),l=e.radius+d.hitTestCircles[g].r;if(h*h+k*k<l*l){0!=(d.colMask&e.colGroup)&&d.collide(e);0!=(e.colMask&d.colGroup)&&e.collide(d);break}}else h=d.x-e.x,k=d.y-e.y,h*h+k*k<(e.radius+d.radius)*(e.radius+d.radius)&&(0!=(d.colMask&e.colGroup)&&d.collide(e),0!=(e.colMask&d.colGroup)&&e.collide(d))}for(b=0;b<a;b++)CObj.objects[b].process(),CObj.objects[b].doRemove&&(CObj.objects[b]._destroy(),CObj.objects.splice(b,
...
CButton.prototype.updateGraphics=function(){if(!this.doRemove&&(CObj.prototype.updateGraphics.call(this),this.gfx&&this.textField&&!this.addToSameLayer)){var a=0;this.hover&&(a=this.y>SCR_HEIGHT-100?-50:50);this.textField.y=this.gfx.y-.7*this.textField.height+a;this.textField.x=this.gfx.x-this.textField.width/2}};
...
new TweenMax(a.scale,.4,{x:1.1,ease:Elastic.easeOut}));e.hover&&(e.textField.alpha=1)};this.gfx.mouseout=function(f){e.over=!1;e.hover&&(e.textField.alpha=0);b.tint=16777215;b.currentFrame&&b.gotoAndStop(1);new TweenMax(b.scale,.3,{x:c,y:d,ease:Elastic.easeOut});a.visible&&""!=a.text&&new TweenMax(a.scale,.3,{x:1,y:1,ease:Elastic.easeOut})};this.addToSameLayer?this.gfx.addChild(this.textField):SM.inst.fontLayer.addChild(this.textField)};extend(ZCJoint,CObj,!0);
...
Object.defineProperty(CTextField.prototype,"text",{get:function(){return this._text},set:function(a){this._text=a;""==this._text&&(this._text=" ");this.gfx&&(this.gfx.text=this._text,this.gfx.updateText(),a=this.gfx.getLocalBounds(),this.offsetX="center"==this.align?-a.width/2*window.addScale:"right"==this.align?-a.width*window.addScale:0,this.updateGraphics(!0))}});CTextField.hashCode=function(a){for(var b=0,c=0;c<a.length;c++)b=a.charCodeAt(c)+((b<<5)-b);return b};
...
b.align="center";"0xffffff"!=a.tint&&void 0!=a.tint&&(b.tint=parseInt(a.tint));b.breaks=0;b.fs=a.fontSize;b.updateText();return b};CTextField.prototype.setTextSafe=function(a){this.safeText=a;console.log("TEXT "+a)};CTextField.prototype.process=function(){void 0!=this.safeText&&(this.text=this.safeText,this.safeText=null)};
...
function CPlayer(a,b,c,d){CLiveObj.apply(this,[a,b,null,d]);this.initialJumpSpeed=-19.5;this.gravPower=.94;this.gfx=this.createDedGraphics();this.fireAngle=0;this.weapon=gameStage.curweapon;this.bar=CObj.getById("hpbar");this.ammobar=gameStage.ammobar;this.colGroup=CG_PLAYER;this.colMask=CG_MONSTER;this.hp=this.maxHp=5;this.baseY=this.y+=10;this.baseX=this.x;this.offsetY=-20;this.offsetX=-25;this.radius=this.gfx.width/2-35;this.sMoving=1;this.sDying=2;this.state=this.sMoving;this.playable=!1;this.lastUseExpl=
0;this.superMode=!1;this.jumpNumber=0;SM.inst.currentStage==gameStage&&(this.movementTween=new TweenMax(this,2,{ease:Sine.easeInOut,x:this.x-50,yoyo:!0,repeat:-1}),this.landing())}CPlayer.prototype.collide=function(a){!this.prekilled&&!this.doRemove&&this.superMode&&CObj.checkType(a,CMonster)&&500<window.time-this.lastUseExpl&&(this.lastUseExpl=window.time,CGrenade.makeBoom((this.x+a.x)/2,(this.y+a.y)/2,80,300))};
...
this.rshSlot.data.boneData.rotation=CPlayer.rhRot;this.lshSlot.data.boneData.rotation=CPlayer.lhRot;a.skeleton.setAttachment("body","body");for(var b=0;b<PlayerData.inst.items_enabled.length;++b)"105A3B3C-160C-4355-AB38-9F107DB5A831"==PlayerData.inst.items_enabled[b].id_item&&a.skeleton.setAttachment("body","body1");a.stateData.setMixByName("idle","jump",.2);a.stateData.setMixByName("jump","idle",.1);a.stateData.setMixByName("jump","defeated",.3);a.stateData.setMixByName("idle","defeated",.72);this.bulletStart=
40;return a};CPlayer.prototype.reveal=function(){this.hp=2;this.invulnerable=!1;this.state=this.sMoving;this.revealTime=(new Date).getTime();this.gfx.state.setAnimationByName(0,"idle",!0)};
CPlayer.prototype.onJump=function(){!this.jumpboost&&this.state==this.sMoving&&(!this.jumping||this.jumping&&this.jumpNumber)&&(this.jumpNumber++,2<this.jumpNumber||(this.jumpboost=this.jumping=!0,2!=this.jumpNumber?(this.prevX||(this.prevX=this.x),this.vy=this.initialJumpSpeed,this.gfx.state.setAnimationByName(0,"jump",!1)):this.vy+=this.initialJumpSpeed/5,this.gravityEnabled=!0,this.vy=this.initialJumpSpeed,ZSound.Play("jump2"),this.movementTween.pause()))};
CPlayer.prototype.kill=function(){if(this.state==this.sMoving){this.state=this.sDying;this.invulnerable=!0;var a=LauncherBG.inst;a.preVelocity=a.maxVelocity;ZSound.Play("losing");this.gfx.state.update(.5);this.gfx.state.setAnimationByName(0,"defeated",!1);new TweenMax(a,2,{maxVelocity:.5});TweenMax.delayedCall(2.57,gameStage.sessionEnd)}};
...
function CBullet(a,b,c,d){CObj.apply(this,[a,b,null,d]);this.gfx=new PIXI.DisplayObjectContainer;this.visualVel=7;this.bhead=new PIXI.Sprite(PIXI.Texture.fromFrame("head.png"));this.bhead.anchor.x=.5;this.bhead.anchor.y=.5;this.bhead.blendMode=PIXI.blendModes.ADD;this.bhead.width=this.visualWidth;this.bmiddle=new PIXI.Sprite(PIXI.Texture.fromFrame("center.png"));this.bmiddle.width=this.visualWidth;this.bmiddle.anchor.x=.5;this.bmiddle.anchor.y=.5;this.bmiddle.blendMode=PIXI.blendModes.ADD;this.bsheylf=
new PIXI.Sprite(PIXI.Texture.fromFrame("shleyf.png"));this.bsheylf.width=this.visualWidth;this.bsheylf.anchor.x=.5;this.bsheylf.anchor.y=.5;this.bsheylf.blendMode=PIXI.blendModes.ADD;this.gfx.addChild(this.bhead);this.gfx.addChild(this.bmiddle);this.gfx.addChild(this.bsheylf);SM.inst.ol.addChild(this.gfx);this.dmg=10;this.radius=30;CBullet.list||(CBullet.list=[]);CBullet.list.push(this)}
...
CBullet.prototype.collide=function(a){if(a&&this.prevVictim!=a){a.dealDamage(this.dmg);var b=pool.Pop("blood");if(b){var c=new CObj(this.x,this.y,null);b.loop=!1;b.gotoAndStop(0);b.gotoAndPlay(0);c.gfx=b;c.updateGraphics();SM.inst.fg.addChild(b);b.animationSpeed=.55;this.updateGraphics();c.gfx.onComplete=function(){c.gfx&&(c.gfx&&pool.Push(c.gfx),c.destroy())}}this.life--;this.dmg*=.66;0>=this.life&&this.destroy();this.prevVictim=a}};
CBullet.prototype.destroy=function(){this.prevVictim=null;var a=CBullet.list.indexOf(this);0<=a&&CBullet.list.splice(a,1);CObj.prototype.destroy.call(this)};CBullet.prototype.process=function(){this.visualVel+=29.5;this.visualWidth+=this.dw;this.updateBulletSpeed(this.visualVel);CObj.prototype.process.call(this)};extend(FloorObj,CObj,!0);function FloorObj(a,b,c,d){CObj.apply(this,[a,b,c,d]);this.gfx&&(this.gfx.parent.removeChild(this.gfx),SM.inst.ol.addChildAt(this.gfx,0))}
FloorObj.prototype.process=function(){for(var a=this.y-this.gfx.height/2,b=0;b<CObj.objects.length;++b){var c=CObj.objects[b];CObj.checkType(c,CMonster)&&0<c.vy&&c.y+c.radius/2>a&&c.destroy();CObj.checkType(c,JumpMon)&&c.y+c.radius/2>a-50&&0<c.vy&&(c.vy=.8*-c.vy,c.av=.1*Math.random());CObj.checkType(c,CCoin)&&c.y+c.radius/2>a-58&&0<c.vy&&(c.vy=.5*-c.vy)}};extend(LauncherBG,CObj,!0);
function LauncherBG(a,b,c,d){CObj.apply(this,[a,b,c,d]);this.levCycles=[];this.gfx=new PIXI.DisplayObjectContainer;SM.inst.bg.addChild(this.gfx);this.nullSpeed=7.4;this.distance=0;this.incDist=50;this.speedUpCoef=.08;this.layersSpeed=[0,.1,.14,.65,.65,1,1];this.ol=new PIXI.DisplayObjectContainer;this.pllayer=new PIXI.DisplayObjectContainer;this.planeLayer=new PIXI.DisplayObjectContainer;this.defaultLayer=null;this.pixToDist=.02}
...
d.length;++c){for(var e=1E5,f=-1E5,g=0;g<d[c].objects.length;++g){var h=d[c].objects[g].x-d[c].objects[g].scaleX*d[c].objects[g].baseDim.x/2,k=d[c].objects[g].x+d[c].objects[g].scaleX*d[c].objects[g].baseDim.x/2;h<e&&(e=h);k>f&&(f=k)}d[c].maxx=f;d[c].minx=e;d[c].width=f-e;if(0==d[c].velocity)for(e=0;e<d[c].objects.length;++e)this.spawnClip(d[c],d[c].objects[e],!0)}this.defaultLayer=d[d.length-1].clip;this.levCycles.push({layers:d,dist:b});this.maxVelocity=this.nullSpeed};extend(CGrenade,CBullet,!0);
...
CGrenade.prototype.addSmoke=function(a){if(!this.doRemove){var b=this;TweenMax.delayedCall(.02,function(){b.addSmoke()});if(a=pool.Pop("smoke")){var c=new CObj(this.x,this.y,null);c.gfx=a;c.updateGraphics();a.alpha=1;LauncherBG.inst.ol.addChild(c.gfx);new TweenMax(c.gfx,.2,{alpha:0,onComplete:function(){c.gfx&&(pool.Push(c.gfx),c.destroy())}})}}};
CGrenade.makeBoom=function(a,b,c,d){ZSound.Play("grenade");var e=pool.Pop("expl");if(e){var f=new CObj(a,b,null);e.loop=!1;e.gotoAndPlay(0);f.allowTrackSpeed=!0;f.gfx=e;f.updateGraphics();SM.inst.fg.addChild(e);f.rotation=Math.random()-.5;e.animationSpeed=.85;f.updateGraphics();f.gfx.onComplete=function(){f.gfx&&f.gfx&&(pool.Push(f.gfx),f.destroy())}}for(var e=d*d,g=CMonster.list.length,h=0;h<g;++h){var k=CMonster.list[h];if(!k.doRemove){var l=k.x-a,m=k.y-b,l=l*l+m*m;l<e&&(l=Math.sqrt(l),l=(d-(l+
.01))/d*c,k.dealDamage(l),console.log(l));k.doRemove&&(h--,g--)}}this.owner!=gameStage.player&&(l=gameStage.player.x-a,m=gameStage.player.y-b,l*l+m*m<.25*d*d&&gameStage.player.dealDamage(1))};CGrenade.prototype.collide=function(a){this.owner!=gameStage.player&&a&&CObj.checkType(a,CMonster)||a==this.owner||(CGrenade.makeBoom(this.x,this.y,this.dmg,350),this.destroy())};CGrenade.prototype.destroy=function(){CBullet.prototype.destroy.call(this)};
...
CPlane.generateProperty("alpha",{defaultValue:1,get:function(){return this._alpha},set:function(a){this._alpha=a;this.shleif1.alpha=a;this.shleif2.alpha=1-a}});extend(CMonster,CLiveObj,!0);
function CMonster(a,b,c,d){CLiveObj.apply(this,[a,b,c,null]);this.radius=50;this.xp=1;this.colGroup=CG_MONSTER;this.colMask=CG_PLAYER;this.jumpTimeCoef=this.highCoef=1;CMonster.list||(CMonster.list=[]);CMonster.list.push(this);this.maxHp=50;this.spawnCoins=!0;this.coinAmount=4;this.hp=this.maxHp;if(1==d||null==d)this.bar=new CHPBar(a,b,"health bar empty"),this.bar.upperImage="health bar full",this.bar.init(),this.bar.prop=1,this.barOffsetX=this.barOffsetY=0;this.process();this.dmg=1}
CMonster.prototype.collide=function(a){this.prekilled||this.doRemove||this.hitDone||(a.dealDamage(this.dmg),a.invulnerable||(this.hitDone=!0))};CMonster.prototype.process=function(){this.bar&&(this.bar.x=this.x-.5*this.bar.gfx.width-10+this.barOffsetX,this.bar.y=this.y-1.5*this.radius+this.barOffsetY);470<this.y&&this.rollLeave&&(this.av-=.01,-.2>this.av&&(this.av=-.2),this.gravityEnabled=!1,new TweenMax(this,.7,{vx:-20}),this.vy=0);CLiveObj.prototype.process.call(this)};
CMonster.prototype.kill=function(){if(this&&!this.prekilled){if(this.spawnCoins){var a=5;gameStage.player.doubleBooster&&(a=10);for(var b=0;b<a;++b).3<Math.random()||CCoin.spawnCoin(this.x,this.y,this.coinAmount)}this.prekilled=!0;this.bar&&new TweenMax(this.bar.gfx,.2,{width:3*this.bar.gfx.width,height:0});PlayerData.inst.progressAch("Gold medal 10",.01,!1);PlayerData.inst.progressAch("Gold medal 11",.005,!1);PlayerData.inst.gainExp(this.xp);a=this.gfx.parent;a.removeChild(this.gfx);var b=pool.Pop("bloodblow"),
c=this;b?(this.gfx=b,this.gfx.anchor.x=.5,this.gfx.anchor.y=.5,this.gfx.scale.x=1.8,this.gfx.scale.y=1.8,this.gfx.animationSpeed=.6,this.updateGraphics(),a.addChild(this.gfx),this.gfx.loop=!1,this.gfx.gotoAndPlay(0),this.gfx.onComplete=function(){c.gfx&&(c.gfx&&pool.Push(c.gfx),c.destroy())}):CLiveObj.prototype.kill.call(c);this.updateGraphics()}};
CMonster.prototype.destroy=function(){if(!this.doRemove){this.bar&&this.bar.destroy();this.bar=null;var a=CMonster.list.indexOf(this);CMonster.list.splice(a,1);CObj.prototype.destroy.call(this)}};CMonster.prototype.longJump=function(a,b,c,d,e,f){a=1;this.gravityEnabled=!0;this.jumpTimeCoef=1;f||(f=0);f=1+f;this.gravPower=(b+.025*a)*f;this.vy=40*-this.gravPower*f;this.allowTrackSpeed=!1;this.gravityEnabled=!0;this.vx=d-a;new TweenMax(this,e,{vx:c-a,yoyo:!0,repeat:1})};extend(JumpMon,CMonster,!0);
function JumpMon(a,b,c,d){CMonster.apply(this,[a,b,c,d]);this.rollLeave=!1}JumpMon.prototype.process=function(){CMonster.prototype.process.call(this)};extend(CDrone,CMonster,!0);function CDrone(a,b,c,d){CMonster.apply(this,[a,b,c,d]);var e=this;new TweenMax.delayedCall(1,function(){e.spawnGrenade()})}
CDrone.prototype.spawnGrenade=function(){if(!this.doRemove){var a=new CGrenade(this.x,this.y+60);a.owner=this;a.life=10;a.dmg=40;a.rotation=Math.PI/2;a.av=.2;a.vx=-3;a.gfx.tint=16711680;a.gravityEnabled=!0;a.colGroup=CG_GROUND;a.colMask=CG_PLAYER;var b=this;new TweenMax.delayedCall(1,function(){b.spawnGrenade()})}};CDrone.prototype.process=function(){CMonster.prototype.process.call(this)};extend(CObstacle,CMonster,!0);function CObstacle(a,b,c,d){CMonster.apply(this,[a,b,c,d])}
CObstacle.prototype.dealDamage=function(a){CMonster.prototype.dealDamage.call(this,a)};CObstacle.prototype.collide=function(a){this.collided||a!=gameStage.player||(CMonster.prototype.collide.call(this,a),this.collided=!0,gameStage.player.onDmgAnim(this))};extend(CBarrel,CObstacle,!0);function CBarrel(a,b,c,d){CObstacle.apply(this,[a,b,c,!0])}CBarrel.prototype.kill=function(){this.doRemove||(this.destroy(),CGrenade.makeBoom(this.x,this.y,this.dmgExpl,350))};extend(Boss1,CMonster,!0);
function Boss1(a,b,c,d){this.hitTestCircles=[{x:10,y:0,r:60},{x:10,y:-130,r:60},{x:0,y:-260,r:60}];CMonster.apply(this,[a,b,null,null]);this.gfx=new PIXI.Spine(c);this.gfx.state.setAnimationByName(0,"idle",!0);this.gfx.scale.x=.48;this.gfx.scale.y=.48;this.updateGraphics();this.maxHp=800;this.xp=300;this.hp=this.maxHp;this.bar.gfx.width*=2;this.barOffsetY=-360;LauncherBG.inst.ol.addChild(this.gfx);var e=this;this.fireDelay=1.75;TweenMax.delayedCall(this.fireDelay,function(){e.fire()});this.b1=this.gfx.skeleton.findSlot("b_bullet1");
this.b2=this.gfx.skeleton.findSlot("b_bullet2");this.gfx.skeleton.setAttachment("b_legs","b_legs");this.gfx.skeleton.setAttachment("b_body","b_body");this.gfx.skeleton.setAttachment("b_head","b_head");this.gfx.skeleton.setAttachment("b_top_body","b_top_body");this.gfx.stateData.setMixByName("idle","shot",.2);this.gfx.stateData.setMixByName("shot","idle",.1)}
Boss1.prototype.fire=function(){this.gfx.state.setAnimationByName(0,"shot",!1);var a=this;TweenMax.delayedCall(.5,function(){a.fireBullet(1);a.fireBullet(1);a.fireBullet(1)});TweenMax.delayedCall(1.3,function(){a.fireBullet(2);a.fireBullet(2);a.fireBullet(2)});TweenMax.delayedCall(1.7,function(){a.goIdle()})};
Boss1.prototype.goIdle=function(){var a=this;if(this.gfx){this.gfx.state.setAnimationByName(0,"idle",!0);var b="disp"+(1+Math.floor(5*Math.random())).toString();this.gfx.skeleton.setAttachment("disp1",b);TweenMax.delayedCall(1,function(){a.fire()})}};
...
Boss1.prototype.destroy=function(){CMonster.prototype.destroy.call(this);MM.inst.currentBoss=null};extend(Boss2,Boss1,!0);function Boss2(a,b,c,d){Boss1.apply(this,[a,b,c,null]);this.gfx.skeleton.setAttachment("b_legs","b_legs1");this.gfx.skeleton.setAttachment("b_body","b_body1");this.gfx.skeleton.setAttachment("b_head","b_head1");this.gfx.skeleton.setAttachment("b_top_body","b_top_body1")}
MM=function(){this.patterns=[{mons:".g..s.gs.l.l.",diff:1,prob:1},{mons:".s..s..s..c",diff:1,prob:1},{mons:".s00z00s..z",diff:1,prob:1},{mons:".b..b..c..b.b.",diff:1,prob:1},{mons:".ss..ss.s..l...ss..l.l..s",diff:1,prob:1},{mons:".z...c.s.s.sc..",diff:2,prob:1},{mons:".l..zz.ss.c.",diff:1,prob:1},{mons:".c.gc..",diff:1,prob:1},{mons:".c..c..o000s.s",diff:1,prob:1},{mons:".z...c.z..",diff:2,prob:1},{mons:"j",diff:2,prob:.1},{mons:".lbb..c.",diff:2,prob:1},{mons:".c..x.x.x.",diff:2,prob:1},{mons:".f...z...f..c.",
diff:2,prob:1},{mons:".l.lz..c..z..c...c..s..l..s.l",diff:2,prob:1},{mons:".lsslss0000l00l.l..",diff:3,prob:1},{mons:".o..lo..l..",diff:3,prob:1},{mons:".c.g..gl",diff:3,prob:1},{mons:"..f..f.z.o..f..",diff:3,prob:1},{mons:"jd..df...f.",diff:4,prob:.1},{mons:"..dz..d..z.z",diff:4,prob:.1},{mons:".F..l.l.F..l.",diff:4,prob:1},{mons:".b.bf..",diff:4,prob:.1},{mons:"..s.sss..s..l",diff:4,prob:1},{mons:"l.l.l...ssl.lbl.l.",diff:4,prob:1},{mons:"f..c.flf.c00",diff:5,prob:1},{mons:".c..c..z..s..sc..sc..sc..",
diff:5,prob:1},{mons:".f.ffc..c..",diff:5,prob:1},{mons:".b..bbb..bbbbbbb..",diff:5,prob:.1},{mons:"gg.g...g..g..G.GG.",diff:5,prob:1},{mons:"zzz.z..G.GG.zzz.",diff:5,prob:1},{mons:"..ss..ss.s..lll.ss..l...l...s",diff:6,prob:1},{mons:".b.bf.x.",diff:6,prob:.1},{mons:".c..c.l..g.g00g",diff:6,prob:1},{mons:".c..c..l..g..g..g",diff:6,prob:1},{mons:"j",diff:6,prob:.1},{mons:"..s..s..dss",diff:6,prob:.1},{mons:".b..bbb..bbbbb000bbbbbbb..",diff:7,prob:.1},{mons:".z..zz...zzz...zzzz.",diff:7,prob:1},{mons:".czgG.gFl...",
diff:7,prob:1},{mons:".c.b.cbb..lb.gG.Gg..g.",diff:8,prob:1},{mons:"o...ss.s.s.d..o.o..",diff:8,prob:1},{mons:"Fz.Fz.zFz.",diff:8,prob:1}];this.bosses=[{cls:Boss2,dist:10},{cls:Boss2,dist:2E3}];this.monY=360;this.sNormal=1;this.sBoss=2;this.lastSpawnPlane=this.lastStep=0;this.currentBoss=null;this.state=this.sNormal;this.stepDelay=330};MM.inst=new MM;
MM.prototype.init=function(){this.simpleRandomSpawn=[this.spawnCoin,this.spawnDrone,this.spawnFatty,this.spawnFatty2,this.spawnGopnick,this.spawnGopnick2,this.spawnSimpleMonster,this.spawnSimpleMonster,this.spawnSimpleMonster];this.bossDistance=0;this.monsterQueue=MM.inst.generateMonsterQueue()};
...
MM.prototype.generateMonsterQueue=function(){for(var a=[],b=0,c=PlayerData.inst.playerItem.lvl/4.5-.5,d=0;3E3>d;++d){var e=b/500;9<e&&(e=9);for(var e=Math.sin(b/50)*(1+.05*e)+e+c,f=0,g=0;g<this.patterns.length;++g){var h=1/(Math.abs(this.patterns[g].diff-e)+1)*this.patterns[g].prob,h=Math.pow(h,1.6);0<g?(this.patterns[g].prob1=this.patterns[g-1].prob1+h,this.patterns[g].prob0=this.patterns[g-1].prob1):(this.patterns[g].prob1=h,this.patterns[g].prob0=0);f+=h}f*=Math.random();for(g=0;g<this.patterns.length&&
!(f>this.patterns[g].prob0&&f<=this.patterns[g].prob1);++g);a+=this.patterns[g].mons;console.log(e+" / "+b.toString()+" choose pattern with diff = "+this.patterns[g].diff.toString()+" with p = "+(this.patterns[g].prob1-this.patterns[g].prob0).toString());b+=this.patterns[g].mons.length}return a};
...
MM.prototype.spawnBarrel=function(a,b,c){a=new CBarrel(SCR_WIDTH+240,450+2*b,a,!0);a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.maxHp=70;a.hp=a.maxHp;a.gfx.anchor.y=.5+b/(a.gfx.height/a.gfx.scale.y);a.dmgExpl=250;a.dmg=1;a.radius=a.gfx.width/2+12;a.offsY=-c;a.allowTrackSpeed=!0};
MM.prototype.spawnCar=function(a,b,c){a=new CObstacle(SCR_WIDTH+240,450+2*b,a,!1);a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.maxHp=111180;a.hp=a.maxHp;a.gfx.anchor.y=.5+b/(a.gfx.height/a.gfx.scale.y);a.radius=(a.gfx.width-50)/2*.94;a.gfx.scale.x=.7;a.gfx.scale.y=.7;a.offsY=-c;a.allowTrackSpeed=!0;a.colGroup=0};
MM.prototype.spawnDrone=function(a){a=new CDrone(SCR_WIDTH+100,80,"dron");a.gfx.anchor.x=.5;a.vx=-1;a.allowTrackSpeed=!1;a.gravityEnabled=!1;new TweenMax(a,1,{y:a.y+80,ease:Sine.easeInOut,yoyo:!0,repeat:10});a.maxHp=190;a.hp=a.maxHp;a.barOffsetX=10;a.xp=25+.01*LauncherBG.inst.distance};MM.prototype.spawnBonusGnome=function(a){var b=new BonusMonGnome(SCR_WIDTH+100,150,"enemy1_1");b.gfx.scale.x=.8;b.gfx.scale.y=.8;b.maxHp=400;b.hp=b.maxHp;b.xp=a+.01*LauncherBG.inst.distance};
MM.prototype.spawnJumpMon=function(){var a=new JumpMon(SCR_WIDTH+120,this.monY-200,"enemy1");a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.av=.1*Math.random();a.longJump(1,.25,-1,-3,1.2);a.maxHp=170;a.hp=a.maxHp;a.xp=10+.01*LauncherBG.inst.distance};MM.prototype.spawnFatty=function(){var a=new CMonster(SCR_WIDTH+100,this.monY,"enemy1");a.rollLeave=!0;a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.longJump(1,.13,-4,-13,1.2);new TweenMax(a,1.2,{rotation:-Math.PI/15});a.maxHp=100;a.hp=a.maxHp;a.xp=10+.01*LauncherBG.inst.distance};
MM.prototype.spawnFatty2=function(a){a=new CMonster(SCR_WIDTH+100,this.monY,"enemy1_1");a.rollLeave=!0;a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.longJump(1,.2,-6,-15,1.2);new TweenMax(a,1.2,{rotation:-Math.PI/15});a.maxHp=100;a.hp=a.maxHp;a.xp=17+.01*LauncherBG.inst.distance};
MM.prototype.spawnGopnick=function(a){a=new CMonster(SCR_WIDTH+100,this.monY,"enemy3");a.rollLeave=!0;a.jumpTimeCoef=.7;a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.maxHp=70;a.hp=a.maxHp;new TweenMax(a,1.2,{rotation:-Math.PI/15});a.longJump(1,.13,-5-2*Math.random(),-16-2*Math.random(),.95);a.xp=11+.01*LauncherBG.inst.distance};
MM.prototype.spawnGopnick2=function(a){a=new CMonster(SCR_WIDTH+100,this.monY,"enemy3_3");a.rollLeave=!0;a.jumpTimeCoef=.6;a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.maxHp=120;a.hp=a.maxHp;new TweenMax(a,1.2,{rotation:-Math.PI/15});a.longJump(1,.13,-5-2*Math.random(),-16-2*Math.random(),.95);a.xp=17+.01*LauncherBG.inst.distance};MM.prototype.spawnRandomMonster=function(a){getRand(this.simpleRandomSpawn).call(this)};
MM.prototype.spawnSimpleMonster=function(a){var b="enemy2";.5<Math.random()&&(b="enemy2_2");b=new CMonster(SCR_WIDTH+100,this.monY,b);b.rollLeave=!0;b.gfx.scale.x=.8;b.gfx.scale.y=.8;new TweenMax(b,1.2,{rotation:-Math.PI/15});b.longJump(1,.14,-6,-12,1.2-.15*Math.random());b.xp=a+.01*LauncherBG.inst.distance};
MM.prototype.doStep=function(){var a=this.monsterQueue.charAt(0);this.monsterQueue=this.monsterQueue.slice(1);this.diff=LauncherBG.inst.distance/1E3;"s"==a&&this.spawnSimpleMonster(5);"f"==a&&this.spawnFatty();"F"==a&&this.spawnFatty2();"G"==a&&this.spawnGopnick2();"g"==a&&this.spawnGopnick();"c"==a&&this.spawnCar("car",40,0);"l"==a&&this.spawnObstacle("luke",40,10);"z"==a&&this.spawnObstacle("conus",20,0,-5);"j"==a&&this.spawnBonusGnome(5);"d"==a&&this.spawnDrone();"b"==a&&this.spawnBarrel("barrel",
20,0,-5);"x"==a&&this.spawnRandomMonster();"0"==a&&this.spawnCoin(440);"o"==a&&this.spawnJumpMon();0==this.monsterQueue.length&&(this.noMonsLeft=!0)};
MM.prototype.process=function(){var a=window.time,b=Math.floor(LauncherBG.inst.distance/4);0==Math.floor(LauncherBG.inst.distance)%250&&.5>Math.random()&&6E4<a-this.lastSpawnPlane&&(this.spawnPlane(),this.lastSpawnPlane=a);b!=this.prevS&&(!this.currentBoss&&0<this.bosses.length&&4*this.prevS-this.bossDistance<this.bosses[0].dist&&LauncherBG.inst.distance-this.bossDistance>=this.bosses[0].dist?(this.currentBoss=new (this.bosses.shift().cls)(SCR_WIDTH+200,500,"imgtps/boss1.json"),this.currentBoss.showUpAnimation()):
this.currentBoss&&(this.bossDistance+=4),this.currentBoss||this.doStep());this.prevS=b};extend(BonusMonGnome,CMonster,!0);
function BonusMonGnome(a,b,c,d){CMonster.apply(this,[a,b,null,d]);this.gfx=new PIXI.Spine("imgtps/bird.json");this.gfx.state.setAnimationByName(0,"animation",!0);this.gfx.scale.x=.48;this.gfx.scale.y=.48;this.updateGraphics();LauncherBG.inst.ol.addChild(this.gfx);this.xp=30;this.lastDrop=0;this.allowTrackSpeed=!1;var e=this;new TweenMax(this,18,{vx:-40,ease:Circ.easeIn,onComplete:function(){e.destroy()}})}BonusMonGnome.prototype.collide=function(a){};
BonusMonGnome.prototype.dealDamage=function(a){CMonster.prototype.dealDamage.call(this,a);200<window.time-this.lastDrop&&(this.lastDrop=window.time,gameStage.player.doubleBooster?CCoin.spawnCoin(this.x,this.y,6):CCoin.spawnCoin(this.x,this.y,3))};extend(CCoin,CObj,!0);
function CCoin(a,b,c){CObj.apply(this,[a,b,null,null]);this.gravityEnabled=!0;this.colGroup=1;this.colMask=CG_PLAYER;this.gravPower=.7;this.radius=15;this.gfx=CObj.createMovieClip("coin");this.gfx.anchor.x=.5;this.gfx.anchor.y=.5;this.gfx.scale.x=.7;this.gfx.scale.y=.7;this.gfx.animationSpeed=.25;this.gfx.play();SM.inst.ol.addChild(this.gfx);this.updateGraphics();this.amount=c;this.allowTrackSpeed=!0;CCoin.coins||(CCoin.coins=[]);CCoin.coins.push(this)}
CCoin.prototype.process=function(){CObj.prototype.process.call(this);this.gravityEnabled&&(this.vx=-7)};CCoin.spawnCoin=function(a,b,c){a=new CCoin(a,b,c);a.vx=20+10*Math.random();a.vy=-20*Math.random()};
CCoin.prototype.collide=function(a){if(!this.isCollected)if(this.isCollected=!0,PlayerData.inst.score+=this.amount,gameStage.updateScore(),this.gravityEnabled=!1,this.vy=this.vx=0,this.allowTrackSpeed=!1,a=pool.Pop("coinCollect"),ZSound.Play("coin"),a){rp(a);rp(this.gfx);a.loop=!1;a.gotoAndStop(0);a.gotoAndPlay(0);this.gfx=a;this.updateGraphics();SM.inst.fg.addChild(a);var b=this;a.animationSpeed=.5;this.updateGraphics();this.gfx.onComplete=function(){b.gfx&&(b.gfx&&pool.Push(b.gfx),b.destroy())}}else this.destroy()};
...
CScrollbar.prototype.destroy=function(){this.toucher.mousedown=null;this.toucher.mouseup=null;this.toucher.mousemove=null;this.toucher.mouseupoutside=null;this.toucher=this.toucher.scrollbar=null;this.bar.mousedown=null;this.sbMask=this.container=this.bar=this.bar.scrollbar=null;CObj.prototype.destroy.call(this)};CScrollbar.prototype.onWheel=function(a){a.stopPropagation();a.stopImmediatePropagation();this.pos+=a.deltaY/3};
function CScrollbar(a,b,c,d,e,f,g,h,k){c="shop back.png";f&&(c=f);CObj.apply(this,[a,b,null,null]);this.gfx=new PIXI.DisplayObjectContainer;this.gui=!0;this.pw=d;this.ph0=this.ph=e;k||(k=0);SM.inst.fg.addChildAt(this.gfx,0);d="scroll line element.png";g&&(d=g);g="scroll.png";h&&(g=h);var l=this;this.gfx.interactive=!0;this.gfx.mouseover=function(){l.mover=!0};this.gfx.mouseout=function(){l.mover=!1};this.bg=new PIXI.Sprite(PIXI.Texture.fromFrame(c));this.bg.width=this.pw+k;this.bg.height=this.ph+
k;this.bg.anchor.x=.5;this.bg.anchor.y=.5;this.gfx.addChild(this.bg);this.updateGraphics();this.toucher=new PIXI.Sprite(PIXI.Texture.fromFrame(g));this.toucher.width=8;this.toucher.anchor.x=.5;this.toucher.anchor.y=.5;this.toucher.x=this.pw/2-4;this.toucher.interactive=!0;this.toucher.scrollbar=this;this.toucher.mousedown=function(a){this.pressed=!0};this.toucher.mouseup=function(a){this.pressed=!1};this.toucher.mouseupoutside=this.toucher.mouseup;this.toucher.mousemove=function(a){this.pressed&&
...
CEActionGUI.prototype.init=function(a,b,c,d,e){CircleBar.prototype.init.call(this,c,d,e);this.eventpl=a;this.event=b;c=0;d="";0<this.event.xp_gain&&(c=this.event.xp_gain,d="price xp.png");0<this.event.money_gain&&(c=this.event.money_gain,d="price coin.png");0<this.event.crystal_gain&&(c=this.event.crystal_gain,d="price star.png");d=new PIXI.Sprite(PIXI.Texture.fromFrame(d));d.anchor.x=.5;d.anchor.y=.5;d.x=120;d.y=-2;this.gfx.addChild(d);this.timeleft=CTextField.createTextField({tint:"0x333333",text:"",
fontSize:17,align:"center"});this.timeleft.x=50;this.timeleft.y=27;this.gfx.addChild(this.timeleft);c=CTextField.createTextField({tint:"0x333333",text:c.toString(),fontSize:16,align:"center"});c.x=120;c.y=-11;this.gfx.addChild(c);var f=this,g=this.ico;g.interactive=!0;var h=g.scale.x,k=g.scale.y;g.mouseover=function(){new TweenMax(g.scale,.6,{y:k+.05,ease:Elastic.easeOut});new TweenMax(g.scale,.4,{x:h+.05,ease:Elastic.easeOut})};g.mouseout=function(){new TweenMax(g.scale,.6,{y:k,ease:Elastic.easeOut});
new TweenMax(g.scale,.4,{x:h,ease:Elastic.easeOut})};g.click=function(){f.ready&&!a.reward_ready&&f.startAction()};this.progressbg.interactive=!0;this.progressbg.click=this.onclick;this.progressbg.tap=this.onclick;null==this.eventpl.lastused&&(this.pos=1);c=CTextField.createTextField({fontFamily:"dedgamedesc",tint:"0x1111111",text:b.desc,fontSize:20,align:"center"});c.x=50;c.y=-55;this.gfx.addChild(c);this.eventpl.reward_ready&&this.addRewardButton();this.progressbg.visible=!1;this.progressfore.visible=
!1};CWeapon=function(a,b,c,d,e,f){this.lastShot=0;this.backupStats=d;this.resetParams();this.clipGfx=e;this.sReload=1;this.sFire=2;this.visualWidth=d.visualWidth;this.dw=d.dw;this.speed=d.speed;this.state=this.sFire;this.id=a;this.name=b;this.desc=c;this.unlocked=!1;this.upgrades=f;this.sound=d.sound;this.recoilValue=0;this.acc=this.backupStats.acc;CWeapon.list||(CWeapon.objects=[]);CWeapon.objects.push(this)};CWeapon.prototype.mouseUp=function(){};
...
CWeapon.prototype.shot=function(){if(!this.canShot()||this.state==this.sReload)return!1;this.sound&&ZSound.Play(this.sound);if(0>this.ammo)return this.reload(),!1;this.lastShot=(new Date).getTime();this.acc+=this.backupStats.accRecoil;this.recoilValue+=this.recoil;this.ammo--;window.totalShots||(window.totalShots=0);window.totalShots++;0==this.ammo&&this.reload();this.updateAmmo();return!0};
CWeapon.prototype.canShot=function(){var a=(new Date).getTime();return this.state==this.sReload?!1:a-this.lastShot>=this.delay?!0:!1};CWeapon.prototype.updateAmmo=function(){gameStage.player.ammobar.text=this.ammo.toString()};
...
CWeapon.prototype.retrieveData=function(){};CWeapon.prototype.applyUpgrades=function(a){for(var b=0;b<a.length;++b){var c=a[b];this[c.param]+=c.value}};extend(CPistol,CWeapon,!0);function CPistol(a,b,c,d,e,f){CWeapon.apply(this,[a,b,c,d,e,f])}CPistol.prototype.mouseUp=function(){this.lastShot-=.3*this.delay};
CPistol.prototype.shot=function(){var a=CWeapon.prototype.shot.call(this);if(a){var b=gameStage.player.fireAngle+(superRand(6)-.5)*this.acc,c=Math.cos(b),d=Math.sin(b),e=gameStage.player.firePointX,f=gameStage.player.firePointY-14,g=crsp("fxblink.png");g.x=e+50*c;g.y=f+50*d;g.rotation=b;g.blendMode=PIXI.blendModes.ADD;SM.inst.fg.addChild(g);TweenMax.delayedCall(.03,function(){g.parent.removeChild(g)});gameStage.player.vx=-.5;e=new CBullet(e,f,"bomb1");e.life=this.life;e.dmg=this.damage;e.rotation=
Math.PI/2+b;e.visualWidth=this.visualWidth;e.dw=this.dw;e.vx=c*this.speed;e.vy=d*this.speed;e.colGroup=CG_BULLET;e.colMask=CG_MONSTER;return a}};extend(CQueueGun,CWeapon,!0);function CQueueGun(a,b,c,d,e,f){CWeapon.apply(this,[a,b,c,d,e,f]);this.queueLife=0;this._sound=this.sound;this.sound=null;this.canFireQueue=!0}CQueueGun.prototype.reload=function(){this.canFireQueue=!1;CWeapon.prototype.reload.call(this);this.queueLife=this.queue};
CQueueGun.prototype.process=function(){CWeapon.prototype.process.call(this);var a=(new Date).getTime();this.canFireQueue&&0<this.queueLife&&this.state!=this.sReload&&a-this.lastShot>=this.queueDelay&&(a=this.delay,this.delay=this.queueDelay,this.shot(!0),this.delay=a)};CQueueGun.prototype.resetParams=function(){CWeapon.prototype.resetParams.call(this);this.queue=this.backupStats.queue;this.queueDelay=this.backupStats.queueDelay};
CQueueGun.prototype.shot=function(a){var b=CWeapon.prototype.shot.call(this);if(b){this._sound&&this.queue==this.queueLife&&ZSound.Play(this._sound);0<this.queueLife&&this.queueLife--;if(!a){this.canFireQueue=!0;if(0<this.queueLife)return;0!=this.queueLife||a||(this.queueLife=this.queue)}a=-this.recoilValue/200+gameStage.player.fireAngle+Math.random()*this.backupStats.acc;var c=Math.cos(a),d=Math.sin(a),e=gameStage.player.firePointX,f=gameStage.player.firePointY-14,g=crsp("fxblink.png");g.x=e+50*
c;g.y=f+50*d;g.rotation=a;g.blendMode=PIXI.blendModes.ADD;SM.inst.fg.addChild(g);TweenMax.delayedCall(.03,function(){g.parent.removeChild(g)});e=new CBullet(e,f,"bomb1");e.life=this.life;e.dmg=this.damage;e.rotation=Math.PI/2+a;e.visualWidth=this.visualWidth;e.dw=this.dw;e.vx=c*this.speed;e.vy=d*this.speed;e.colGroup=CG_BULLET;e.colMask=CG_MONSTER;return b}};extend(CLaser,CWeapon,!0);
...
"\u043f\u0438\u0441\u0442\u043e\u043b\u0435\u0442","\u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435",{visualWidth:20,dw:-.7,speed:38.5,sound:"mini",life:1,acc:.022,accIncrease:.02,accRecoil:.1,recoil:3,magcap:20,delay:120,damage:28,unlockprice:10,reloadTime:900},"asd",[{name:"\u0422\u043e\u0447\u043d\u044b\u0439 \u0441\u0442\u0432\u043e\u043b",param:"recoil",valuesUpgr:[10,20,30,40],level:0},{name:"\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u043c\u0430\u0433\u0430\u0437\u0438\u043d",
...
"\u043f\u0438\u0441\u0442\u043e\u043b\u0435\u0442","\u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435",{visualWidth:20,dw:-.9,speed:60.5,sound:"ochered",queue:4,queueDelay:110,life:1,acc:.08,accIncrease:.02,accRecoil:.1,recoil:1.5,magcap:50,delay:600,damage:55,unlockprice:10,reloadTime:2200},"asd",[{name:"\u0422\u043e\u0447\u043d\u044b\u0439 \u0441\u0442\u0432\u043e\u043b",param:"recoil",valuesUpgr:[10,20,30,40],level:0},{name:"\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u043c\u0430\u0433\u0430\u0437\u0438\u043d",
param:"magCapacity",valuesUpgr:[2,4,6,8],level:0},{name:"\u0411\u044b\u0441\u0442\u0440\u0430\u044f \u0441\u0442\u0440\u0435\u043b\u044c\u0431\u0430",param:"delay",valuesUpgr:[-10,-20,-30,-40],level:0}]),w_grenadel=new CGrenadeLauncher("grenade launcher","\u043b\u0430\u0437\u0435\u0440","\u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435",{visualWidth:20,dw:-.7,speed:40.5,sound:"laser",life:1,acc:.08,accIncrease:0,accRecoil:0,recoil:3,magcap:3,delay:400,damage:110,reloadTime:2200},"asd",[{name:"\u0422\u043e\u0447\u043d\u044b\u0439 \u0441\u0442\u0432\u043e\u043b",
...
param:"delay",valuesUpgr:[-10,-20,-30,-40],level:0}]);extend(CBooster,CObj,!0);function CBooster(a,b,c){CObj.apply(this,[a,b,c,null]);CBooster.list||(CBooster.list=[]);CBooster.list.push(this);this.activate=null}CBooster.prototype.destroy=function(){CObj.prototype.destroy.call(this)};CBooster.prototype.onDeactivate=function(){rp(this.tf);this.tf=null;this.gfx.alpha=.5};
...
CBooster.prototype.onActivate=function(){this.activate=!1;PlayerData.inst.progressAch("Gold medal 5",1,!1);this.startTime=window.time;this.lastTick=0;this.tf=CTextField.createTextField({tint:"0x333333",text:"AAASA",fontSize:48,align:"center"});this.tf.x=this.tf.width/2;this.tf.y=12;this.gfx.addChild(this.tf)};
CBooster.prototype.process=function(){if(this.tf){if(1E3<window.time-this.lastTick){this.lastTick=window.time;var a=Math.round(this.duration-(window.time-this.startTime)/1E3);this.tf.text=a.toString();this.tf.updateText()}this.tf.x=-this.tf.width/2}};extend(CDoubleBooster,CBooster,!0);function CDoubleBooster(a,b,c){CBooster.apply(this,[a,b,c]);this.duration=30;this.key="D";this.activate=!0}
CDoubleBooster.prototype.onActivate=function(){if(gameStage.player){CBooster.prototype.onActivate.call(this);var a=this;gameStage.player.doubleBooster=!0;TweenMax.delayedCall(this.duration,function(){gameStage.player.doubleBooster=!1;a.onDeactivate()})}};extend(CHeartBooster,CBooster,!0);function CHeartBooster(a,b,c){CBooster.apply(this,[a,b,c]);gameStage.player.maxHp++;gameStage.player.hp++}extend(CMagnetBooster,CBooster,!0);
function CMagnetBooster(a,b,c){CBooster.apply(this,[a,b,c]);CMagnetBooster.mindist=9E4}CMagnetBooster.prototype.process=function(){if(gameStage.player&&CCoin.coins)for(var a=CCoin.coins.length,b=0;b<a;++b){var c=CCoin.coins[b].x-gameStage.player.x,d=CCoin.coins[b].y-gameStage.player.y;if(c*c+d*d<CMagnetBooster.mindist){var e=Math.sqrt(c*c+d*d),c=c/e,d=d/e;CCoin.coins[b].vx-=1.5*c;CCoin.coins[b].vy-=1.5*d}}};extend(CSupermanBooster,CBooster,!0);
function CSupermanBooster(a,b,c){CBooster.apply(this,[a,b,c]);this.duration=15;this.key="S";this.activate=!0}
CSupermanBooster.prototype.onActivate=function(){if(gameStage.player&&!gameStage.player.jumping){CBooster.prototype.onActivate.call(this);var a=this;new TweenMax(gameStage.player,.84,{y:200,ease:Linear.easeOut,onComplete:function(){gameStage.player.vy=-2;new TweenMax(gameStage.player,a.duration/24,{vy:2,yoyo:!0,repeat:24,ease:Sine.easeInOut})}});gameStage.player.jumping=!0;gameStage.player.gravityEnabled=!1;gameStage.player.jumpBoost=!1;TweenMax.delayedCall(this.duration,function(){gameStage.player.jumping=
!1;gameStage.player.gravityEnabled=!0;rp(a.fire1);rp(a.fire2);rp(a.fire3);a.fire1=null;a.fire2=null;a.fire3=null;a.onDeactivate()});this.fire1=CObj.createMovieClip("firesmall");this.fire1.x=-314;this.fire1.y=-100;this.fire1.scale.x=3;this.fire1.scale.y=3;this.fire1.loop=!0;this.fire1.gotoAndPlay(0);gameStage.player.gfx.addChildAt(this.fire1,0);this.fire2=CObj.createMovieClip("firesmall");this.fire2.x=-140;this.fire2.y=20;this.fire2.scale.x=3;this.fire2.scale.y=3;this.fire2.loop=!0;this.fire2.gotoAndPlay(0);
gameStage.player.gfx.addChildAt(this.fire2,0);this.fire3=CObj.createMovieClip("firesmall");this.fire3.x=85;this.fire3.y=20;this.fire3.scale.x=3;this.fire3.scale.y=3;this.fire3.loop=!0;this.fire3.gotoAndPlay(0);gameStage.player.gfx.addChildAt(this.fire3,0);gameStage.player.state.setAnimationByName(0,"idle",!0)}};extend(CTabletsBooster,CBooster,!0);function CTabletsBooster(a,b,c){CBooster.apply(this,[a,b,c]);this.duration=4;this.key="A";this.activate=!0}
CTabletsBooster.prototype.onActivate=function(){CBooster.prototype.onActivate.call(this);if(gameStage.player){this.lastUse=window.time;gameStage.player.invulnerable=!0;var a=gameStage.player;a.blink=!0;var b=LauncherBG.inst.maxVelocity;a.superMode=!0;var c=this;new TweenMax(LauncherBG.inst,this.duration,{maxVelocity:LauncherBG.inst.maxVelocity+25,ease:Linear.easeOut});TweenMax.delayedCall(this.duration+.3,function(){new TweenMax(LauncherBG.inst,1.3,{maxVelocity:b,ease:Linear.easeOut});TweenMax.delayedCall(.9,
function(){c.onDeactivate();a.superMode=!1;a.resetBlink();a.invulnerable=!1;a.blink=!1})})}};
PlayerData=function(a){this.maxEnergy=10;this.epm=.2;this.delayEnergyMS=1/this.epm*6E4;this.xpLevel=[{crystals:1,money:25,xp:0},{crystals:1,money:50,xp:250},{crystals:1,money:100,xp:500},{crystals:1,money:200,xp:1E3},{crystals:2,money:400,xp:2E3},{crystals:2,money:800,xp:2500},{crystals:2,money:1E3,xp:3500},{crystals:2,money:1500,xp:7E3},{crystals:3,money:2E3,xp:12E3},{crystals:3,money:2500,xp:18E3},{crystals:3,money:3E3,xp:25E3},{crystals:3,money:3E3,xp:3E4},{crystals:3,money:3E3,xp:35E3},{crystals:3,
money:3E3,xp:47E3},{crystals:3,money:3E3,xp:55E3},{crystals:3,money:3E3,xp:6E4},{crystals:3,money:3E3,xp:75E3}];this.items={};this.achs={};a&&(this.playerItem=a);this.activeBoosters=[];this.score=0;this.loadData(this.loadEnd);PlayerData.inst=this};PlayerData.prototype.addNotification=function(a,b){window.azureclient.getTable("tb_notifications").insert({message:a,vkapi:b})};
...
PlayerData.prototype.gainExp=function(a){console.log("XP "+a.toString());this.playerItem.xp+=a;if(this.playerItem.xp>=this.xpLevel[this.playerItem.lvl].xp&&this.playerItem.lvl+1<this.xpLevel.length){this.playerItem.xp-=this.xpLevel[this.playerItem.lvl].xp;this.playerItem.crystals+=this.xpLevel[this.playerItem.lvl].crystals;this.playerItem.lvl++;ZSound.Play("levelup");this.score+=this.xpLevel[this.playerItem.lvl].money;if(SM.inst.currentStage==charStage){charStage.closeEventsWnd&&charStage.closeEventsWnd();
CObj.enableButtons(!1);var b=SM.inst.addDisableWindow(null,SM.inst.fontLayer);b.interactive=!0;charStage.closeEventsWnd=function(){b.parent.removeChild(b);CObj.enableButtons(!0)}}SM.inst.currentStage==gameStage&&(gameStage.updateScore(),gameStage.pause());LevelManager.loadLevel("levelup",function(){CObj.getById("moneytf").text=PlayerData.inst.xpLevel[PlayerData.inst.playerItem.lvl].money.toString();CObj.getById("crystalstf").text=PlayerData.inst.xpLevel[PlayerData.inst.playerItem.lvl].crystals.toString();
CObj.getById("levnum").text=PlayerData.inst.playerItem.lvl.toString();CObj.getById("btnclose").click=function(){for(var a=0;a<LevelManager.objs.length;++a)LevelManager.objs[a].destroy();LevelManager.objs=null;SM.inst.currentStage==gameStage?gameStage.unpause():(charStage.closeEventsWnd(),charStage.updateStatsPanel())}},SM.inst.fontLayer)}SM.inst.currentStage==gameStage&&gameStage.updateXP()};
...
PlayerData.prototype.progressAch=function(a,b,c){for(var d=0;d<this.achs.length&&this.achs[d].name.toLowerCase()!=a.toLowerCase();++d);a=!1;for(var e=0;e<this.achs_progress.length;++e)if(this.achs_progress[e].id_ach==this.achs[d].id){c?(1<=b&&(a=!0),this.achs_progress[e].progress=b):(1>this.achs_progress[e].progress&&1<=this.achs_progress[e].progress+b&&(a=!0),this.achs_progress[e].progress+=b);break}a&&(this.savePlayerAchs(),this.showAch(this.achs[d]));return a};
PlayerData.prototype.loadEnd=function(){PlayerData.inst.createAchProgress();window.dbinit=!0;checkDb();window.dbinit&&window.loaded&&assetsButSoundsLoaded();SM.inst.openStage(charStage)};
PlayerData.prototype.updateEnergy=function(){var a=(new Date).getTime()-this.playerItem.updateDate.getTime();this.playerItem.updateDate=new Date;a=a/1E3/60;0<a&&(this.playerItem.energy+=a*this.epm);this.playerItem.energy>this.maxEnergy&&(this.playerItem.energy=this.maxEnergy);this.savePlayerData();SM.inst.currentStage!=charStage&&SM.inst.currentStage!=shopStage||shopStage.updateStatsPanel();console.log("UPD ENERGY");var b=this;setTimeout(function(){b.updateEnergy()},this.delayEnergyMS)};
...
PlayerData.prototype.loadData=function(a){this.loadCount=0;window.azureclient.getTable("tb_players").read().done(function(b){PlayerData.inst.playerItem=b[0];PlayerData.inst.playerItem.name=vkparams.first_name;PlayerData.inst.playerItem.last_name=vkparams.last_name;PlayerData.inst.updateEnergy();azureclient.invokeApi("update_score",{body:{id_player:PlayerData.inst.playerItem.id,score:PlayerData.inst.playerItem.maxdistance},method:"post"}).done();PlayerData.inst.playerItem.crystals||(PlayerData.inst.playerItem.crystals=
0);PlayerData.inst.loadCount++;7==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_achs").read().done(function(b){PlayerData.inst.achs=b;PlayerData.inst.loadCount++;7==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_ach_player").read().done(function(b){PlayerData.inst.achs_progress=b;PlayerData.inst.loadCount++;7==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_items").read().done(function(b){PlayerData.inst.items=
b;PlayerData.inst.loadCount++;7==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_item_player").read().done(function(b){PlayerData.inst.items_enabled=b;for(var c=b=!1,d=-1,e=0;e<PlayerData.inst.items_enabled.length;++e)"68AFAEDC-B3E0-401E-9E1A-E272084F2E11"==PlayerData.inst.items_enabled[e].id_item&&(d=e,b=!0),PlayerData.inst.items_enabled[e].equipped&&(c=!0);!c&&b&&(PlayerData.inst.items_enabled[d].equipped=!0);b||(azureclient.invokeApi("buy_item",{body:{id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",
id_player:PlayerData.pid,equipped:c},method:"post"}).done(function(a){},function(a){}),c=!0,0<PlayerData.inst.items_enabled.length&&(c=!1),PlayerData.inst.items_enabled.push({id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.pid,equipped:c}),PlayerData.inst.savePlayerItems());PlayerData.inst.loadCount++;7==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_edevent_player").read().done(function(b){PlayerData.inst.eventsplayer=b;PlayerData.inst.loadCount++;
...
PlayerData.prototype.savePlayerAchs=function(){for(var a=0;a<PlayerData.inst.achs_progress.length;++a)window.azureclient.getTable("tb_ach_player").update(PlayerData.inst.achs_progress[a]).done(function(a){},function(a){})};PlayerData.prototype.savePlayerEvents=function(a){for(var b=0;b<PlayerData.inst.eventsplayer.length;++b)a&&a.id!=PlayerData.inst.eventsplayer[b].id||window.azureclient.getTable("tb_edevent_player").update(PlayerData.inst.eventsplayer[b]).done(function(a){},function(a){})};
PlayerData.prototype.savePlayerItems=function(a){for(var b=0;b<PlayerData.inst.items_enabled.length;++b)a&&a.id!=PlayerData.inst.items_enabled[b].id||window.azureclient.getTable("tb_item_player").update(PlayerData.inst.items_enabled[b]).done(function(a){},function(a){})};PlayerData.prototype.savePlayerData=function(){window.azureclient.getTable("tb_players").update(PlayerData.inst.playerItem).done(function(a){PlayerData.inst.playerItem=a},function(a){})};
var tWeapon="weap",tPerk="perk",tBoost="boost",tApp="app.",tHat="hat";function checkDb(){updDb(dbobj)}
...
gfx:"orden2.png"},{name:"Gold medal 7",desc:"\u0423\u0431\u0438\u043b \u043f\u0435\u0440\u0432\u043e\u0433\u043e \u0431\u043e\u0441\u0441\u0430",gfx:"orden.png"},{name:"Gold medal 8",desc:"3 \u0434\u043d\u044f \u0431\u0435\u0437 \u043f\u0435\u0440\u0435\u0440\u044b\u0432\u0430",gfx:"orden7.png"},{name:"Gold medal 9",desc:"10 \u0434\u043d\u0435\u0439 \u0431\u0435\u0437 \u043f\u0435\u0440\u0435\u0440\u044b\u0432\u0430",gfx:"orden2.png"},{name:"Gold medal 10",desc:"\u0423\u0431\u0438\u0442\u044c 100 \u0448\u043a\u043e\u043b\u044c\u043d\u0438\u043a\u043e\u0432",
gfx:"orden6.png"},{name:"Gold medal 11",desc:"\u0423\u0431\u0438\u0442\u044c 200 \u0448\u043a\u043e\u043b\u044c\u043d\u0438\u043a\u043e\u0432",gfx:"orden12.png"}]},{tbname:"tb_items",items:[{type:tWeapon,price:-1,pricecrys:-1,name:"Rifle",desc:"\u0420\u0443\u0436\u044c\u0438\u0448\u043a\u043e",gfx:"gun0",reqlvl:-1},{type:tWeapon,price:500,pricecrys:-1,name:"PPS",desc:"\u041f\u041f\u0428",gfx:"gun1",reqlvl:2},{type:tWeapon,price:1E3,pricecrys:-1,name:"AK-74",desc:"\u041a\u0430\u043b\u0430\u0448",gfx:"gun2",
reqlvl:4},{type:tWeapon,price:2E3,pricecrys:1,name:"Minigun",desc:"\u041f\u0443\u043b\u0435\u043c\u0435\u0442",gfx:"gun3",reqlvl:7},{type:tWeapon,price:1E4,pricecrys:5,name:"Grenade launcher",desc:"\u0413\u0440\u0430\u043d\u0430\u0442\u043e\u043c\u0435\u0442",gfx:"gun4",reqlvl:10},{type:tWeapon,price:6E4,pricecrys:15,name:"Plazma Cannon",desc:"\u0427\u0442\u043e-\u0442\u043e \u043c\u043e\u0449\u043d\u043e\u0435",gfx:"gun5",reqlvl:15},{type:tBoost,price:500,pricecrys:-1,name:"Magnet",desc:"\u041c\u0430\u0433\u043d\u0438\u0442",
gfx:"booster2",reqlvl:2},{type:tBoost,price:200,pricecrys:5,name:"Tablets",desc:"\u0411\u0438\u043e\u0434\u043e\u0431\u0430\u0432\u043a\u0438",gfx:"booster1",reqlvl:1},{type:tBoost,price:800,pricecrys:-1,name:"Health",desc:"\u0411\u043e\u043b\u044c\u0448\u0435 \u0416\u042b\u0417\u041d\u0418",gfx:"booster4",reqlvl:5},{type:tBoost,price:1,pricecrys:1,name:"MarioStar",desc:"\u041d\u0435\u0443\u044f\u0437\u0432\u0438\u043c\u043e\u0441\u0442\u044c!",gfx:"booster5",reqlvl:5},{type:tBoost,price:100,pricecrys:-1,
name:"Double",desc:"\u0412 \u0434\u0432\u0430 \u0440\u0430\u0437\u0430 \u0431\u043e\u043b\u044c\u0448\u0435 \u043c\u043e\u043d\u0435\u0442!",gfx:"booster3",reqlvl:-1},{type:tApp+tHat,price:100,pricecrys:-1,name:"Appearence.Hat1",desc:"\u0428\u043b\u044f\u043f\u0430 1",gfx:"hat1",reqlvl:-1},{type:tApp+tHat,price:200,pricecrys:-1,name:"Appearence.Hat2",desc:"\u0428\u043b\u044f\u043f\u0430 2",gfx:"hat2",reqlvl:-1},{type:tApp+tHat,price:300,pricecrys:-1,name:"Appearence.Hat3",desc:"\u0428\u043b\u044f\u043f\u0430 3",
gfx:"hat3",reqlvl:-1},{type:tApp+tHat,price:400,pricecrys:-1,name:"Appearence.Hat4",desc:"\u0428\u043b\u044f\u043f\u0430 4",gfx:"hat4",reqlvl:-1},{type:tApp+tHat,price:500,pricecrys:-1,name:"Appearence.Hat5",desc:"\u0428\u043b\u044f\u043f\u0430 5",gfx:"hat5",reqlvl:-1},{type:tApp+tHat,price:600,pricecrys:-1,name:"Appearence.Hat6",desc:"\u0428\u043b\u044f\u043f\u0430 6",gfx:"hat6",reqlvl:-1}]}];
function updDb(a,b){for(var c=0;c<a.length;++c)for(var d=window.azureclient.getTable(a[c].tbname),e=0;e<a[c].items.length;++e)(function(b,d){d.where(a[c].items[e].id?{id:a[c].items[e].id}:{name:a[c].items[e].name}).read().done(function(a){0<a.length?(b.id=a[0].id,d.update(b)):d.insert(b)},function(a){console.log("Error: "+a)})})(a[c].items[e],d)}
getURLParameter=function(a){return decodeURIComponent(((new RegExp("[?|&]"+a+"=([^&;]+?)(&|#|;|$)")).exec(location.search)||[,""])[1].replace(/\+/g,"%20"))||null};
loginCallback=function(a){if(vkparams.novk)new PlayerData(a);else{var b=0;VK.api("friends.get",{user_id:vkparams.viewerid,order:"name",count:1E3,fields:"domain"},function(c){vkparams.friends=c.response;vkparams.friendsids=[];for(c=0;c<vkparams.friends.length;++c)vkparams.friendsids.push(vkparams.friends[c].uid);azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsids},method:"post"}).done(function(c){b++;vkparams.friendsIngame=c.result;vkparams.friendsIngameIDs=[];if(c.result){for(var e=
0;e<c.result.length;++e)vkparams.friendsIngameIDs.push(c.result[e].vkapi);2==b&&new PlayerData(a)}},function(a){})});VK.api("users.get",{user_ids:vkparams.viewerid.toString()},function(c){vkparams.first_name=c.response[0].first_name?c.response[0].first_name:"\u041d\u043e\u0443\u043d\u0435\u0439\u043c";vkparams.last_name=c.response[0].first_name?c.response[0].last_name:"";b++;2==b&&new PlayerData(a)})}};
dbInit=function(){window.azureclient=new WindowsAzure.MobileServiceClient("https://thanksdad.azure-mobile.net/","DRoaNHnoaCjxrhkbpOzHxGEHOFgGLS75");window.vkparams={};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid||(vkparams.viewerid=2882845,vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");
vkparams.accesstoken=getURLParameter("access_token");azureclient.invokeApi("login",{body:{vkapi:vkparams.viewerid,ref:vkparams.refferer},method:"post"}).done(function(a){PlayerData.pid=a.result.userId.split(":")[1];azureclient.currentUser={userId:a.result.userId,mobileServiceAuthenticationToken:a.result.token};vkparams.id=a.result.id;loginCallback(a.result)},function(a){})};var loadingState="prepreload";window.openSponsorWindow=null;window.focus();var assetsLoaded=0,preloaderAsset=["preloader.png"];
window.loader=new PIXI.AssetLoader(preloaderAsset);window.loader.onComplete=preloaderLoaded;window.loader.load();dbInit();window.addScale=1;window.SCR_WIDTH=800;window.SCR_HEIGHT=600;window.SCR_SCALE=1;window.FRAME_RATE=60;window.renderer=new PIXI.autoDetectRenderer(SCR_WIDTH,SCR_HEIGHT);VK.init({apiId:4654201},function(){console.log("INIT OK")},function(){console.log("INIT FAILED")},"5.27");function order(a){var b={type:"item",item:a};window.currentOrder=a;VK.callMethod("showOrderBox",b)}
VK.addCallback("onOrderSuccess",function(a){"item1"==window.currentOrder&&(PlayerData.inst.playerItem.money+=100);"item2"==window.currentOrder&&(PlayerData.inst.playerItem.money+=1200);"item3"==window.currentOrder&&(PlayerData.inst.playerItem.money+=7E3);"item4"==window.currentOrder&&(PlayerData.inst.playerItem.crystals+=3);"item5"==window.currentOrder&&(PlayerData.inst.playerItem.crystals+=15);"item6"==window.currentOrder&&(PlayerData.inst.playerItem.crystals+=80);"item7"==window.currentOrder&&(PlayerData.inst.playerItem.energy+=
1);PlayerData.inst.savePlayerData();VK.orderComplete&&VK.orderComplete()});VK.addCallback("onOrderFail",function(){VK.orderFail&&(VK.orderFail(),VK.orderFail=null)});VK.addCallback("onOrderCancel",function(){VK.orderCancel&&(VK.orderCancel(),VK.orderCancel=null)});
function preloaderLoaded(){window.stage=new PIXI.Stage(16777215);window.loadingScreen=new PIXI.Graphics;window.preloaderBg=PIXI.Sprite.fromImage("preloader.png");SM.inst.addLayersToStage();SM.inst.superStage.addChild(preloaderBg);SM.inst.superStage.addChild(loadingScreen);requestAnimFrame(animate);window.loadingState="loading";window.assetsToLoader="levels/energywindow.json levels/settings.json levels/levelpremium.json levels/levelup.json levels/levach.json levels/levshop.json levels/mainmenu.json levels/hud.json levels/plantPart1.json levels/plantPart2.json levels/levelmenu.json levels/levelselect.json levels/levelwin.json levels/levelsoundcheck.json levels/levelgameover.json levels/credits.json levels/wingame.json levels/rotatescreen.json levels/levchar.json levels/levscore.json levels/upperPanel.json imgtps/bg.json imgtps/guiatlas.json imgtps/pussyatlas.json imgtps/dedgamedesc.xml imgtps/dedgamecaps.xml imgtps/skeleton.json imgtps/boss1.json imgtps/bird.json".split(" ");
window.prevW=window.innerWidth;window.prevH=window.innerHeight;window.loader=new PIXI.AssetLoader(assetsToLoader);document.body.appendChild(renderer.view);PIXI.scaleModes.DEFAULT=0;window.scoreStage=new ScoreStage;window.gameStage=new GameStage;window.mainMenu=new MainMenu;window.credStage=new Credits;window.achStage=new AchStage;window.levSel=new LevSel;window.shopStage=new ShopStage;window.charStage=new CharStage;window.pool=new ZPool;FRAME_DELAY=1E3/FRAME_RATE;window.addEventListener("resize",
onWindowResize,!1);window.addEventListener("resizeend",onWindowResize,!1);rescale();onWindowResize();window.lastLoop=0;loader.onComplete=function(){window.loaded=!0;window.dbinit&&window.loaded&&assetsButSoundsLoaded()};loader.load();loader.onProgress=onAssetsProgress}function onAssetsProgress(a){window.assetsLoaded++;a.json&&void 0!=a.json.objects&&(LevelManager.levels[a.url]=a.json)}
function assetsButSoundsLoaded(){ZSound.soundLoadedFunction=onAssetsLoaded;ZSound.Init([{id:"CLICK",src:"CLICK2.ogg"},{id:"jump",src:"jump.ogg"},{id:"jump2",src:"jump2.ogg"},{id:"lazer",src:"Vystrel_lazer.ogg"},{id:"mini",src:"Vystrel_minigan.ogg"},{id:"ochered",src:"Vystrel_ochered.ogg"},{id:"rifle",src:"rifle.ogg"},{id:"levelup",src:"levelup.ogg"},{id:"buy",src:"buy.ogg"},{id:"losing",src:"losing.ogg"},{id:"grenade",src:"grenade.ogg"},{id:"vzbodritsa",src:"vzbodritsa.ogg"},{id:"coin",src:"Pickup_Coin66.ogg"}])}
function onAssetsLoaded(){SM.inst.superStage.removeChild(loadingScreen);loadingScreen=null;preloaderBg.texture.destroy(!0);SM.inst.superStage.removeChild(preloaderBg);preloaderBg=null;gameStage.currentLevel=1;PIXI.Texture.fromImage("preloader.png").destroy(!0);window.addEventListener("orientationchange",orientchange,!1);orientchange();window.txtFps=new PIXI.Text("FPS:",{fill:"white",font:"bold 40px Arial",strokeThickness:8,stroke:"black"});loadingState="game";window.txtFps.position.y=SCR_HEIGHT-24;
window.txtFps.scale.x=.5;window.txtFps.scale.y=.5;SM.inst.fontLayer.addChild(window.txtFps);setTimeout("window.scrollTo(0, 1)",10)}function orientchange(){switch(window.orientation){case 0:addRotationText();break;case 90:removeRotationText();break;case -90:removeRotationText()}}function removeRotationText(){document.body.removeChild(window.rotatebg);window.rotatebg=null;document.body.removeChild(window.icorotate);window.icorotate=null}
...
function animate(){requestAnimFrame(animate);window.time=(new Date).getTime();if("prepreload"!=loadingState)if("loading"==loadingState){var a=assetsLoaded/window.assetsToLoader.length;1<a&&(a=1);loadingScreen.beginFill(16742263);loadingScreen.drawRect(SCR_WIDTH/2-92+2,SCR_HEIGHT/2+195,236*a,28);loadingScreen.endFill()}else"game"==loadingState&&(SM.inst&&SM.inst.process(),a=new Date,fps=1E3/(a-lastLoop),lastLoop=a,txtFps.setText("FPS: "+parseInt(fps)));renderer.render(stage)};
