...
CScrollbar.prototype.destroy=function(){this.gfx.touchstart=null;this.gfx.touchend=null;this.gfx.parentObj=null;this.toucher.mousedown=null;this.toucher.mouseup=null;this.toucher.mousemove=null;this.toucher.mouseupoutside=null;this.toucher=this.toucher.scrollbar=null;this.bar.mousedown=null;this.sbMask=this.container=this.bar=this.bar.scrollbar=null;CObj.prototype.destroy.call(this)};CScrollbar.prototype.touchStart=function(a){console.log("debug")};
CScrollbar.prototype.onWheel=function(a,b,c,d){a.stopPropagation();a.stopImmediatePropagation();this.pos-=25*b};
function CScrollbar(a,b,c,d,e,f,g,k,h){c="shop back.png";f&&(c=f);CObj.apply(this,[a,b,null,null]);this.gfx=new PIXI.DisplayObjectContainer;this.gui=!0;this.pw=d;this.ph0=this.ph=e;h||(h=0);SM.inst.fg.addChildAt(this.gfx,0);d="scroll line element.png";g&&(d=g);g="scroll.png";k&&(g=k);var l=this;this.gfx.interactive=!0;this.gfx.mouseover=function(){l.mover=!0};this.gfx.mouseout=function(){l.mover=!1};this.gfx.touchmove=function(a){console.log("ENIS");l.prevSwipeX||(l.prevSwipeX=a.global.x);l.prevSwipeY||
(l.prevSwipeY=a.global.y);var b=a.global.y-l.prevSwipeY;console.log(b);l.pos+=b;l.prevSwipeX=a.global.x;l.prevSwipeY=a.global.y};this.gfx.touchstart=function(a){console.log("start")};this.gfx.touchend=function(a){console.log("NIS");l.prevSwipeX=null;l.prevSwipeY=null};this.bg=new PIXI.Sprite(PIXI.Texture.fromFrame(c));this.bg.width=this.pw+h;this.bg.height=this.ph+h;this.bg.anchor.x=.5;this.bg.anchor.y=.5;this.gfx.addChild(this.bg);this.gfx.parentObj=this;this.updateGraphics();this.toucher=new PIXI.Sprite(PIXI.Texture.fromFrame(g));
this.toucher.width=8;this.toucher.anchor.x=.5;this.toucher.anchor.y=.5;this.toucher.x=this.pw/2-4;this.toucher.interactive=!0;this.toucher.scrollbar=this;this.toucher.mousedown=function(a){this.pressed=!0};this.toucher.mouseup=function(a){this.pressed=!1};this.toucher.mouseupoutside=this.toucher.mouseup;this.toucher.mousemove=function(a){this.pressed&&this.scrollbar&&(this.scrollbar.pos=a.global.y/SCR_SCALE-this.scrollbar.y+this.scrollbar.ph/2)};this.bar=new PIXI.Sprite(PIXI.Texture.fromFrame(d));
this.bar.width=8;this.bar.height=this.ph;this.bar.anchor.x=.5;this.bar.anchor.y=.5;this.bar.x=this.pw/2-4;this.bar.interactive=!0;this.bar.scrollbar=this;this.bar.mousedown=function(a){this.scrollbar.pos=a.global.y/SCR_SCALE-this.scrollbar.y+this.scrollbar.ph/2;this.scrollbar.toucher.pressed=!0};this.container=new PIXI.DisplayObjectContainer;this.container.x=-this.pw/2;this.container.y=-this.ph/2;this.sbMask=new PIXI.Graphics;this.sbMask.beginFill();this.sbMask.drawRect(-this.pw/2,-this.ph/2,this.pw,
this.ph);this.sbMask.endFill();this.container.mask=this.sbMask;this.gfx.addChild(this.sbMask);this.gfx.addChild(this.container);this.gfx.addChild(this.bar);this.gfx.addChild(this.toucher);this.pos=0;this.posScale=1;this.x=a;this.y=b}extend(CircleBar,CObj,!0);function CircleBar(a,b,c,d){CObj.apply(this,[a,b,c,d])}
