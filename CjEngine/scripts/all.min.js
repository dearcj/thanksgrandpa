...
uploadPhoto=function(a){var b=new PIXI.RenderTexture(SCR_WIDTH,SCR_HEIGHT);b.render(SM.inst.superStage);var c=b.getBase64();VK.api("photos.getWallUploadServer",{uid:a},function(a){a=a.response.upload_url.replace("http://","https://");$.ajax({type:"POST",url:a,data:{photo:c,format:"json"},dataType:"json",success:function(a){console.log("")},error:function(a){console.log("")}})})};
