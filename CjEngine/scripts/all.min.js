...
duration:5.5,objects:[{tex:"2frame.png",s1:[1.2,1.2],s2:[1.1,1.1],vx:0,vy:-.2,p1:[SCR_WIDTH/2,SCR_HEIGHT/2+SCR_HEIGHT],p2:[SCR_WIDTH/2,SCR_HEIGHT/2+15],delay:0,tweenTime:.6,ease:Back.easeOut},{tex:"2frame_comment1.png",vx:0,vy:-.1,p1:[SCR_WIDTH/2,SCR_HEIGHT/2+260],p2:[SCR_WIDTH/2,SCR_HEIGHT/2+110],delay:1.4,tweenTime:.4,ease:Back.easeOut},{tex:"2frame_comment2.png",vx:0,vy:-.1,p1:[SCR_WIDTH/2+20,SCR_HEIGHT/2+305],p2:[SCR_WIDTH/2+20,SCR_HEIGHT/2+155],delay:1.88,tweenTime:.4,ease:Back.easeOut},{tex:"2frame_comment3.png",
vx:0,vy:-.1,p1:[SCR_WIDTH/2+20,SCR_HEIGHT/2+350],p2:[SCR_WIDTH/2+20,SCR_HEIGHT/2+200],delay:2.3,tweenTime:.35,ease:Back.easeOut}]},{frame:"anger",duration:5.5,objects:[{tex:"StoryBackground.png",vx:0,vy:0,s1:[150,150],p1:[SCR_WIDTH/2,SCR_HEIGHT/2+1.3*SCR_HEIGHT],p2:[SCR_WIDTH/2,SCR_HEIGHT/2],delay:0,tweenTime:.3,ease:Sine.easeIn},{tex:"3frame_top.png",rot1:2,rot2:0,vx:0,vy:.15,p1:[SCR_WIDTH/2+600,SCR_HEIGHT/2-SCR_HEIGHT/4+700],p2:[SCR_WIDTH/2,SCR_HEIGHT/2-120],delay:.45,tweenTime:.6,ease:Back.easeOut},
{tex:"3top_frame_signs.png",va:-4E-4,rot1:-2,rot2:0,vx:0,vy:-.15,p1:[SCR_WIDTH/2+600,SCR_HEIGHT/2-SCR_HEIGHT/4+700],p2:[SCR_WIDTH/2,SCR_HEIGHT/2-120],delay:.45,tweenTime:.6,ease:Back.easeOut},{tex:"3frame_bottom.png",rot1:.05,rot2:0,vx:0,vy:-.15,p1:[SCR_WIDTH/2,SCR_HEIGHT/2-SCR_HEIGHT],p2:[SCR_WIDTH/2,SCR_HEIGHT/2+138],delay:2.7,tweenTime:.33,ease:Back.easeOut}]},{frame:"way of war",duration:5.5,objects:[{tex:"StoryBackground.png",vx:0,vy:0,s1:[150,150],p1:[SCR_WIDTH/2,SCR_HEIGHT/2+1.3*SCR_HEIGHT],
p2:[SCR_WIDTH/2,SCR_HEIGHT/2],delay:0,tweenTime:.3,ease:Sine.easeIn},{tex:"4top_frame2.png",rot1:.5,vx:0,vy:.05,s1:[3,3],s2:[1,1],p1:[1100,-440],p2:[605,160],delay:.2,tweenTime:.45,ease:Back.easeOut},{tex:"4top_frame1.png",vx:0,vy:.07,s1:[3,3],s2:[1,1],p1:[730,-420],p2:[225,180],delay:2,tweenTime:.45,ease:Back.easeOut},{tex:"4frame_bottom.png",s1:[2,2],s2:[.99,.99],vx:0,vy:-.05,p1:[SCR_WIDTH/2,SCR_HEIGHT/2+SCR_HEIGHT],p2:[SCR_WIDTH/2,SCR_HEIGHT/2+138],delay:3.3,tweenTime:.5,ease:Sine.easeOut}]}];
comixStage.goNext()};
ComixStage.prototype.goNext=function(){comixStage.dcNext&&comixStage.dcNext.kill();TweenMax.killAll(!0,!0,!0);var a=this.comixData.shift();a||SM.inst.openStage(charStage);comixStage.dcNext=TweenMax.delayedCall(a.duration,function(){comixStage.goNext()});for(var b=0;b<a.objects.length;++b){var c=a.objects[b],d=crsp(c.tex);comixStage.comixContainer.addChild(d);d.visible=!1;c.rot1||(c.rot1=0);c.rot2||(c.rot2=0);c.p1||(c.p1=[0,0]);c.p2||(c.p2=c.p1);c.s1||(c.s1=[1,1]);c.s2||(c.s2=c.s1);d.scale.x=.55*c.s1[0];
d.scale.y=.55*c.s1[1];d.rotation=c.rot1;d.x=c.p1[0];d.y=c.p1[1];d.vx=0;d.vy=0;d.va=0;c.ease||(c.ease=Sine.easeOut);new TweenMax(d.scale,c.tweenTime,{x:.55*c.s2[0],y:.55*c.s2[1],delay:c.delay});(function(a,b){new TweenMax(a,b.tweenTime,{ease:b.ease,rotation:b.rot2,x:b.p2[0],y:b.p2[1],delay:b.delay,onComplete:function(){a.vx=b.vx;a.vy=b.vy;a.va=b.va}})})(d,c);c.delay||(c.delay=0);setVisible=function(a){c.alphaHide&&new TweenMax(a,.1,{delay:c.alphaHide+c.delay,alpha:0});TweenMax.delayedCall(c.delay,
function(){a.visible=!0})};setVisible(d)}};ComixStage.prototype.onHide=function(a){PIXI.TextureCache["2frame.png"].destroy(!0);rp(comixStage.comixContainer);comixStage.comixContainer=null;CObj.destroyAll()};
...
diff:7,prob:1},{mons:".b..bbb..bbbbb000bbbbbbb..",diff:7,prob:.1},{mons:".o.H.H..l..",diff:7,prob:1},{mons:".z..zz...zzz...zzzz.",diff:7,prob:1},{mons:".czgG.gFl...",diff:7,prob:1},{mons:"h..c.hsh.?.",diff:8,prob:1},{mons:".c.b.cbb..lb.gG.Gg..g.",diff:8,prob:1},{mons:"o...ss.s.s.d..o.o..",diff:8,prob:1},{mons:"Fz.Fz.zFz.",diff:8,prob:1},{mons:"bb..o..b.o.H.h..c",diff:9,prob:1}];this.bosses=[{cls:Boss1,dist:1E3},{cls:Boss2,dist:2E3}];this.monY=360;this.sNormal=1;this.sBoss=2;this.lastSpawnPlane=this.lastStep=
...
b+=this.patterns[h].mons;MM.debugArray.push({diff:this.patterns[h].diff,start:d,prob:(this.patterns[h].prob1-this.patterns[h].prob0)/g,probDiff:k});d+=this.patterns[h].mons.length}return b};
...
PlayerData.prototype.loadEnd=function(){PlayerData.inst.createAchProgress();window.dbinit=!0;checkDb();window.dbinit&&window.loaded&&assetsButSoundsLoaded();SM.inst.openStage(comixStage)};
...
window.prevW=window.innerWidth;window.prevH=window.innerHeight;window.loader=new PIXI.AssetLoader(assetsToLoader);document.body.appendChild(renderer.view);PIXI.scaleModes.DEFAULT=0;window.comixStage=new ComixStage;window.scoreStage=new ScoreStage;window.gameStage=new GameStage;window.mainMenu=new MainMenu;window.credStage=new Credits;window.achStage=new AchStage;window.levSel=new LevSel;window.shopStage=new ShopStage;window.charStage=new CharStage;window.pool=new ZPool;FRAME_DELAY=1E3/FRAME_RATE;
window.addEventListener("resize",onWindowResize,!1);window.addEventListener("resizeend",onWindowResize,!1);rescale();onWindowResize();window.lastLoop=0;loader.onComplete=function(){window.loaded=!0;window.dbinit&&window.loaded&&assetsButSoundsLoaded()};loader.load();loader.onProgress=onAssetsProgress}function onAssetsProgress(a){window.assetsLoaded++;a.json&&void 0!=a.json.objects&&(LevelManager.levels[a.url]=a.json)}
