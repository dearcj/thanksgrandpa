var CG_GROUND=1,CG_MONSTER=2,CG_PLAYER=4,CG_BULLET=8;function strad(a,b){return parseInt(a)+parseInt(b)}function noc(a,b){a.click=null;a.tap=null}function onc(a,b){a.click=b;a.tap=b}function extractName(a){return a.name?(a.name+" "+a.last_name).substring(0,16):"\u0410\u043d\u043e\u043d\u0438\u043c"}function findByProp(a,b,c){for(var d=a.length,e=0;e<d;++e)if(a[e][b]==c)return a[e];return null}function getRand(a){return a[Math.floor(Math.random()*a.length)]}
function OpenInNewTab(a){window.open(a,"_blank").focus()}function clone(a){return JSON.parse(JSON.stringify(a))}function sqlToJsDate(a){if(!a)return new Date;var b=a.split("-");a=b[0];var c=(Number(b[1])-1).toString(),d=b[2].split(" "),b=d[0],e=d[1].split(":"),d=e[0],f=e[1],e=e[2].split(".")[0];return new Date(a,c,b,d,f,e,0)}
...
"197515742"==vkparams.viewerid)vkparams.gamerid=vkparams.userid||vkparams.viewerid,vkparams.auth_key=getURLParameter("auth_key"),vkparams.refferer=getURLParameter("referrer"),vkparams.accesstoken=getURLParameter("access_token"),console.log("login / register user"),new PlayerData};
