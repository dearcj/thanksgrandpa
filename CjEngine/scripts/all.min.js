...
null;this.transStart=0;this.transTime=600;this.doTrans=!1;document.addEventListener("DOMMouseScroll",function(a){if(CObj.objects)for(var b=0;b<CObj.objects.length;++b)if(CObj.checkType(CObj.objects[b],CScrollbar),CObj.objects[b].mover)CObj.objects[b].onWheel(a);a.stopPropagation();a.stopImmediatePropagation();a.preventDefault()},!1)}SM.inst=new SM;
