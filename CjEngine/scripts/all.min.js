...
method:"post"}).done(function(a){a=a.result;for(var c=0;c<Math.min(5,a.length);++c)CObj.getById("tf"+(c+1).toString()+"2").text=(a[c].name+" "+a[c].last_name).substring(0,12),CObj.getById("tf"+(c+1).toString()+"3").text=a[c].maxdistance.toString(),b>a[c].maxdistance&&(CObj.getById("b"+(c+1).toString()).gfx.visible=!0,CObj.getById("b"+(c+1).toString()).text="\u042f \u0442\u0435\u0431\u044f \u0443\u0434\u0435\u043b\u0430\u043b",function(a,c){CObj.getById("b"+(a+1).toString()).click=function(){VK.api("wall.post",
{owner_id:c.vkapi,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b"+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432. "+c.name+" "+c.last_name+", \u044f \u0442\u0435\u0431\u044f \u0443\u0434\u0435\u043b\u0430\u043b!",attachments:["photo2882845_347400805","https://vk.com/app4654201"]},function(a){})}}(c,a[c]));for(a=c;5>a;++a)CObj.getById("b"+(a+1).toString()).gfx.visible=!0,CObj.getById("b"+(a+1).toString()).text="\u041f\u0440\u0438\u0433\u043b\u0430\u0441\u0438\u0442\u044c \u0432 \u0438\u0433\u0440\u0443",
...
CharStage.prototype.createFriendsPanel=function(){for(var a=new PIXI.DisplayObjectContainer,b="",c=[],d=charStage.skipFriends,e=0+d;e<5+d;++e){var f=new CButton(63+100*(e-d),5,"add friend"),g=f.gfx;g.parent.removeChild(g);f.fontFamily="dedgamedesc";f.fontSize=14;f.tint=16777215;g.anchor.x=.5;g.anchor.y=.5;f.hover=!0;f.deltaHoverY=17;vkparams.friendsIngame&&e<vkparams.friendsIngame.length&&(f.text=vkparams.friendsIngame[e].name+" "+vkparams.friendsIngame[e].last_name);f.addToSameLayer=!0;f.init();
a.addChild(g);!vkparams.friendsIngame||e>=vkparams.friendsIngame.length?g.click=function(){VK.callMethod("showInviteBox")}:(username=vkparams.friendsIngame[e].name,g.click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:username+", \u0432\u043e\u0437\u0432\u0440\u0430\u0449\u0430\u0439\u0441\u044f \u0432 \u0438\u0433\u0440\u0443 \u0434\u0440\u0443\u0436\u0438\u0449\u0435",attachments:["photo2882845_347400805","https://vk.com/app4654201"]},function(a){})},""!=b&&(b+=","),b+=vkparams.friendsIngame[e].vkapi.toString(),
g.vkapi=vkparams.friendsIngame[e].vkapi,c.push(g))}VK&&""!=b&&VK.api("users.get",{user_ids:b,fields:"photo"},function(a){if(a.response)for(var b=0;b<a.response.length;++b){var d=a.response[b].photo;if(!a.response||0==a.response.length)break;var e=c[b];e.loader=new PIXI.ImageLoader(d);(function(a,b){a.loader.onLoaded=function(){var c=new PIXI.Sprite(PIXI.TextureCache[b]);c.anchor.x=.5;c.anchor.y=.5;a.addChild(c);charStage.icons.push(c)}})(e,d);e.loader.load()}});a.x=215;a.y=SCR_HEIGHT-50;SM.inst.guiLayer.addChild(a);
return a};
...
ShopStage.prototype.onShowContinue=function(){CustomStage.prototype.onShow.call(this);CObj.getById("photo").click=function(){uploadPhoto(vkparams.viewerid,!1)};CObj.getById("ava").click=function(){uploadPhoto(vkparams.viewerid,!0)};shopStage.bar=new CScrollbar(610,335,"",380,524);shopStage.bar.gfx.parent.removeChild(shopStage.bar.gfx);SM.inst.ol.addChildAt(shopStage.bar.gfx,1);shopStage.updateStatsPanel();CObj.getById("bbuy1").click=charStage.openPremiumWindow;CObj.getById("bbuy2").click=charStage.openPremiumWindow;
CObj.getById("bback").click=function(){SM.inst.openStage(charStage)};CObj.getById("bstuff").click=function(){shopStage.updateBar("bstuff",tBoost)};CObj.getById("bweap").click=function(){shopStage.updateBar("bweap",tWeapon)};CObj.getById("bcloth").click=function(){shopStage.updateBar("bcloth",tApp)};shopStage.updateBar("bstuff",tBoost);var a=new CPlayer(180,430);shopStage.pl=a;shopStage.pl.updateAppearence(!0,!1,"breath",null,null);a.gfx.scale.x=.4;a.gfx.scale.y=.4;SM.inst.ol.addChild(a.gfx)};
function levelClick(a){gameStage.currentLevel=a.target.levelNum;SM.inst.openStage(gameStage)}ShopStage.prototype.onHide=function(a){shopStage.pl=null;CustomStage.prototype.onHide.call(this,null);CObj.destroyAll();CObj.processAll()};ShopStage.prototype.process=function(){CObj.processAll()};function ScoreStage(){CustomStage.apply(this)}extend(ScoreStage,CustomStage);
ScoreStage.prototype.updateFriends=function(){PlayerData.inst.savePlayerData();azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:scoreStage.showRecords,skip:scoreStage.skip},method:"post"}).done(function(a){scoreStage.updateSB(a.result)},function(a){})};ScoreStage.prototype.updateTotal=function(){azureclient.invokeApi("get_scores",{body:{filter:null,take:scoreStage.showRecords,skip:scoreStage.skip},method:"post"}).done(function(a){scoreStage.updateSB(a.result)},function(a){})};
...
CGrenade.makeBoom=function(a,b,c,d,e){ZSound.Play("grenade");var f=pool.Pop("expl");if(f){var g=new CObj(a,b,null);f.loop=!1;f.gotoAndPlay(0);g.allowTrackSpeed=!0;g.gfx=f;g.updateGraphics();SM.inst.fg.addChild(f);g.rotation=Math.random()-.5;f.animationSpeed=.85;g.updateGraphics();g.return2Pool=g.gfx;g.gfx.lifeTime=800;g.gfx.onComplete=function(){g.destroy()}}f=d*d;CMonster.list||(k=0);for(var k=CMonster.list.length,h=0;h<k;++h){var l=CMonster.list[h];if(!l.doRemove&&l!=e){var m=l.x-a,n=l.y-b,m=m*
...
gfx:"orden2.png"},{name:"Gold medal 7",desc:"\u0423\u0431\u0438\u043b \u043f\u0435\u0440\u0432\u043e\u0433\u043e \u0431\u043e\u0441\u0441\u0430",gfx:"orden.png"},{name:"Gold medal 8",desc:"3 \u0434\u043d\u044f \u0431\u0435\u0437 \u043f\u0435\u0440\u0435\u0440\u044b\u0432\u0430",gfx:"orden7.png"},{name:"Gold medal 9",desc:"10 \u0434\u043d\u0435\u0439 \u0431\u0435\u0437 \u043f\u0435\u0440\u0435\u0440\u044b\u0432\u0430",gfx:"orden2.png"},{name:"Gold medal 10",desc:"\u041d\u0430\u043a\u0430\u0437\u0430\u0442\u044c 100 \u0448\u043a\u043e\u043b\u044c\u043d\u0438\u043a\u043e\u0432",
gfx:"orden6.png"},{name:"Gold medal 11",desc:"\u041d\u0430\u043a\u0430\u0437\u0430\u0442\u044c 200 \u0448\u043a\u043e\u043b\u044c\u043d\u0438\u043a\u043e\u0432",gfx:"orden12.png"}]},{tbname:"tb_items",items:[{type:tWeapon,price:-1,pricecrys:-1,name:"Rifle",desc:"\u0420\u0443\u0436\u044c\u0438\u0448\u043a\u043e",gfx:"gun0",reqlvl:-1},{type:tWeapon,price:500,pricecrys:-1,name:"PPS",desc:"\u041f\u041f\u0428|\u041f\u0438\u0441\u0442\u043e\u043b\u0435\u0442-\u043f\u0443\u043b\u0435\u043c\u0451\u0442 \u0428\u043f\u0430\u0433\u0438\u043d\u0430",
...
getDedImage=function(a){if(a)var b=300,c=365,d=-55,e=-150;else b=SCR_WIDTH/2,c=SCR_HEIGHT,e=d=0;b=new PIXI.RenderTexture(b,c);a&&(CObj.getById("bgshopded").gfx.visible=!1);renderer.render(stage,!0);a=new PIXI.Matrix;a.translate(d,e);b.render(SM.inst.superStage,a);d=b.getBase64();b.destroy(!0);CObj.getById("bgshopded").gfx.visible=!0;return d};
uploadPhoto=function(a,b){var c=getDedImage(b),c=c.replace(/^data:image\/(png|jpg);base64,/,"");VK.api("photos.getWallUploadServer",{uid:a},function(a){a=a.response.upload_url;getParameterByName("hash",a);getParameterByName("rhash",a);$.ajax({type:"POST",url:"upload.php",data:{uploadUrl:a,photo:c},dataType:"text"}).success(function(a){a=JSON.parse(a);b?VK.api("photos.saveProfilePhoto",{server:a.server,photo:a.photo,hash:a.hash},function(a){console.log("SSS")},function(a){console.log("SSS")}):VK.api("photos.saveWallPhoto",
{uid:vkparams.viewerid,server:a.server,photo:a.photo,hash:a.hash},function(a){a.response&&VK.api("wall.post",{owner_id:vkparams.viewerid,message:"\u0421\u043f\u0430\u0441\u0438\u0431\u043e \u0434\u0435\u0434\u0443 \u0437\u0430 \u0441\u0435\u043b\u0444\u0438",attachments:a.response[0].id},function(a){console.log("SSS")},function(a){console.log("SSS")})});console.log("")}).error(function(a){console.log("")})})};
