...
CObj.getById("buy2").click=function(){orderFunc("item2")};CObj.getById("buy3").click=function(){orderFunc("item3")};CObj.getById("buy4").click=function(){orderFunc("item4")};CObj.getById("buy5").click=function(){orderFunc("item5")};CObj.getById("buy6").click=function(){orderFunc("item6")};CObj.getById("btnclose").click=close},SM.inst.fontLayer)};
...
getDedImage=function(a){shopStage.transScreen&&(shopStage.transScreen.visible=!1);if(a)var b=300,c=365,d=-55,e=-120;else b=SCR_WIDTH/2,c=SCR_HEIGHT,e=d=0;b=new PIXI.RenderTexture(b,c);a&&(CObj.getById("bgshopded").gfx.visible=!1);renderer.render(stage,!0);a=new PIXI.Matrix;a.translate(d,e);b.render(SM.inst.superStage,a);d=b.getBase64();b.destroy(!0);CObj.getById("bgshopded").gfx.visible=!0;shopStage.transScreen&&(shopStage.transScreen.visible=!0);return d};
