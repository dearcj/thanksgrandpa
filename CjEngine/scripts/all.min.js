...
.5;achObject.interactive=!0;c=CTextField.createTextField({text:c.desc,align:"center",fontSize:"17"});c.x=achObject.x-c.width/2;c.y=achObject.y+100;achStage.bar.container.addChild(c);achStage.bar.container.addChild(achObject)}achStage.bar.pos=0};AchStage.prototype.onHide=function(a){CustomStage.prototype.onHide.call(this,null);CObj.destroyAll();CObj.processAll()};
...
vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&VK||(MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);if("?p=LOCAL"==window.location.search||"CARLSON"==vkparams.viewerid||"2882845"==vkparams.viewerid||"282617259"==vkparams.viewerid||"197515742"==vkparams.viewerid){vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");
console.log("login / register user");this.loginPage="https://www.dedgame.ru/backendmysql/login.php";this.apiSource="https://www.dedgame.ru/backendmysql/dedapi.php";if("?p=LOCAL"==window.location.search)this.playerJSON='{"registered":false,"tokenJWT":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ2a2lkIjoiMjgyNjE3MjU5IiwidXNlcmlkIjoiNzhGNkY3Q0UtMjhFMy00QUVBLUIxNDMtMkJCQjJDQkVBNTREIn0.P-nWGsKp866LbgRrzuVhBut8p4ZaAZ8XZfhIchgsph4","playerItem":{"id":"78F6F7CE-28E3-4AEA-B143-2BBB2CBEA54D","ref":"282617259","vkapi":"282617259","xp":"256.94042397661","createDate":"2015-03-25 12:31:46","updateDate":"2015-04-17 00:50:13","userId":"Custom:F800A350-EE15-4F1C-9CCF-050B775A4CD9","money":"9639","crystals":"1000","maxdistance":"918","lvl":"3","energy":"10","name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0439","last_name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0447","rank":"2467","combodate":"2015-03-25 15:56:09","keys":null,"platformid":"282617259"}}',
...
PlayerData.prototype.createAchProgress=function(a){for(a=0;a<this.achs.length;++a){for(var b=!1,c=0;c<this.achs_progress.length;++c)if(this.achs[a].id==this.achs_progress[c].id_ach){b=!0;break}if(!b){var d={id_ach:this.achs[a].id,id_player:this.playerItem.id,progress:0};this.achs_progress.push(d);PlayerData.inst.callDedAPI("INSERT","tb_ach_player",null,d,function(a){d.id=a})}}};incMetric=function(a){};
...
"tb_items",null,null,function(b){PlayerData.inst.items=PlayerData.inst.intJSON(b);PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()});PlayerData.inst.callDedAPI("READ","tb_edevent_player",null,null,function(b){PlayerData.inst.eventsplayer=PlayerData.inst.intJSON(b);PlayerData.inst.loadCount++;console.log("events loaded");6==PlayerData.inst.loadCount&&a&&a()});PlayerData.inst.callDedAPI("READ","tb_ach_player",null,null,function(b){PlayerData.inst.achs_progress=PlayerData.inst.intJSON(b);
PlayerData.inst.createAchProgress();console.log("achs loaded");PlayerData.inst.loadCount++;3<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 26",1,!1);5<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 27",1,!1);10<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 28",1,!1);15<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 29",1,!1);20<=PlayerData.inst.frCount&&PlayerData.inst.progressAch("Gold medal 30",1,!1);6==PlayerData.inst.loadCount&&
