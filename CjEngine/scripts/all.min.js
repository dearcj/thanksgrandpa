...
PlayerData.prototype.updateEnergy=function(){var a=(new Date).getTime()-this.playerItem.updateDate.getTime();this.playerItem.updateDate=new Date;a=a/1E3/60;this.playerItem.energy+=a*this.epm;console.log(this.playerItem.energy);this.playerItem.energy>this.maxEnergy&&(this.playerItem.energy=this.maxEnergy);this.savePlayerData();SM.inst.currentStage!=charStage&&SM.inst.currentStage!=shopStage||shopStage.updateStatsPanel();setTimeout(function(){PlayerData.inst.updateEnergy()},PlayerData.inst.delayEnergyMS)};
