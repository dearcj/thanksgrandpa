...
c.push(LevelManager.objs[f].sAtlasName);LevelManager.onVeryComplete=b;a=[];for(f=0;f<c.length;++f)b="imgtps/"+c[f],PIXI.BaseTextureCache[b+".png"]||a.push(b+".json");if(0<a.length)c=new PIXI.AssetLoader(a),c.load(),c.onComplete=LevelManager.onComplete;else LevelManager.onComplete();return LevelManager.objs};LevelManager.inst=new LevelManager;LevelManager.levels={};
...
"rotatescreen.json",LevelManager.levFolder+"levchar.json",LevelManager.levFolder+"levscore.json",LevelManager.levFolder+"upperPanel.json",LevelManager.levFolder+"loading.json","imgtps/comix.json","imgtps/bg.json","imgtps/achs.json","imgtps/guiatlas.json","imgtps/pussyatlas.json","imgtps/dedgamedesc.xml","imgtps/dedgamecaps.xml","imgtps/dedgameXP.xml","imgtps/skeleton.json","imgtps/boss1.json","imgtps/bird.json"];window.prevW=window.innerWidth;window.prevH=window.innerHeight;window.loader=new PIXI.AssetLoader(assetsToLoader);
document.body.appendChild(renderer.view);PIXI.scaleModes.DEFAULT=0;window.charStage=new CharStage;window.comixStage=new ComixStage;window.gameStage=new GameStage;window.achStage=new AchStage;window.shopStage=new ShopStage;requestAnimFrame(animate);window.pool=new ZPool;FRAME_DELAY=1E3/FRAME_RATE;window.addEventListener("resize",onWindowResize,!1);window.addEventListener("resizeend",onWindowResize,!1);rescale();onWindowResize();window.lastLoop=0;assetsButSoundsLoaded();loader.onComplete=function(){window.loaded=
!0;console.log("gfx loaded");window.gfxLoaded=!0;onAssetsLoaded()};loader.load();loader.onProgress=onAssetsProgress}function onAssetsProgress(a){console.log(window.assetsLoaded.toString()+" asset loaded");window.assetsLoaded++;a.json&&void 0!=a.json.objects&&(LevelManager.levels[a.url]=a.json)}
