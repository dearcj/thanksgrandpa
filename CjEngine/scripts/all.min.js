...
CObj.getById("levnum").text=PlayerData.inst.playerItem.lvl.toString();CObj.getById("btnclose").click=function(){LevelManager.removeLastLevel();b?gameStage.unpause():(shopStage.updateStatsPanel(),charStage.closeEventsWnd(),PlayerData.inst.savePlayerData())}},SM.inst.fontLayer));SM.inst.currentStage==gameStage&&gameStage.updateXP()};
...
PlayerData.prototype.saveRunProgress=function(a){SM.inst.currentStage!=gameStage||gameStage.progressSaved||(a=Math.round(PlayerData.inst.playerItem.maxdistance),LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(a=Math.round(LauncherBG.inst.distance),PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=parseInt(a.rank)})),gameStage.progressSaved=!0,PlayerData.inst.playerItem.money+=Math.round(PlayerData.inst.score),PlayerData.inst.playerItem.maxdistance=a,gameStage.ari&&
(gameStage.ari.kill(),gameStage.ari=null),PlayerData.inst.saveScore())};
