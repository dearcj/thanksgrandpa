var CG_GROUND=1,CG_MONSTER=2,CG_PLAYER=4,CG_BULLET=8;function datetime(){return window.date}function ajaxCalltoGetTime(){PlayerData.inst.callDedAPI("GET_DATE",null,null,null,function(a){isNaN((new Date(a)).getTime())||(window.date=new Date(a))})}function startServerTimeTicker(){ajaxCalltoGetTime();setInterval(ajaxCalltoGetTime,1E4)}function getCookie2(a){return document.cookie.match(new RegExp("(?:^|; )"+a.replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"))[1]}
...
CObj.getById("tfprev").text=Math.round(LauncherBG.inst.distance).toString()+" \u043c";var b=Math.round(PlayerData.inst.playerItem.maxdistance);LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(b=Math.round(LauncherBG.inst.distance));CObj.getById("tfrec").text=b.toString()+" \u043c";CObj.getById("bmenu").click=function(){gameStage.doProcess=!0;SM.inst.openStage(charStage)};for(var c=1;5>=c;++c)CObj.getById("b"+c.toString()).gfx.visible=!1,CObj.getById("b"+c.toString()).text="";PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=
a.rank;PlayerData.inst.savePlayerData()});PlayerData.inst.saveRunProgress();CObj.getById("bshare").click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b "+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432.\nhttps://vk.com/app4654201",attachments:["photo-90523698_359515843","https://vk.com/app4654201"]},function(a){})};for(c=0;5>c;++c)a(c);PlayerData.inst.callDedAPI("GET_SCORES",null,null,{filter:vkparams.friendsFilter,take:5,skip:0},
function(a){for(var c=0;c<Math.min(5,a.length);++c){var f=a[c].maxdistance;f||(f=0);CObj.getById("tf"+(c+1).toString()+"2").text=extractName(a[c]);CObj.getById("tf"+(c+1).toString()+"3").text=f.toString();b>a[c].maxdistance&&(CObj.getById("b"+(c+1).toString()).gfx.visible=!0,CObj.getById("b"+(c+1).toString()).text="\u042f \u0442\u0435\u0431\u044f \u0443\u0434\u0435\u043b\u0430\u043b",function(a,c){CObj.getById("b"+(a+1).toString()).click=function(){VK.api("wall.post",{owner_id:c.platformid,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b "+
b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432. *id"+c.platformid+"("+c.name+") "+c.last_name+",  \u043d\u0438\u043a\u043e\u0433\u0434\u0430 \u043d\u0435 \u043f\u043e\u0431\u044c\u0435\u0448\u044c \u043c\u043e\u0439 \u0440\u0435\u043a\u043e\u0440\u0434!!\nhttps://vk.com/app4654201",attachments:["photo-90523698_359515827","https://vk.com/app4654201"]},function(a){})}}(c,a[c]))}for(a=c;5>a;++a)CObj.getById("b"+(a+1).toString()).gfx.visible=!0,CObj.getById("b"+(a+1).toString()).text="\u041f\u0440\u0438\u0433\u043b\u0430\u0441\u0438\u0442\u044c \u0432 \u0438\u0433\u0440\u0443",
...
xp:22E3},{crystals:3,money:3E3,xp:23E3},{crystals:3,money:3E3,xp:24E3},{crystals:3,money:3E3,xp:25E3},{crystals:3,money:3E3,xp:26E3},{crystals:3,money:3E3,xp:27E3},{crystals:3,money:3E3,xp:28E3},{crystals:3,money:3E3,xp:29E3},{crystals:3,money:3E3,xp:31E3},{crystals:3,money:3E3,xp:32E3},{crystals:3,money:3E3,xp:33E3},{crystals:3,money:3E3,xp:34E3},{crystals:3,money:3E3,xp:35E3}];this.items={};this.achs={};this.score=0;PlayerData.inst=this;console.log("dbInit start. Connecting to azure");window.vkparams=
{};vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&VK||(MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");if("?p=LOCAL"==window.location.search)this.playerJSON='{"registered":false,"tokenJWT":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ2a2lkIjoiMjgyNjE3MjU5IiwidXNlcmlkIjoiNzhGNkY3Q0UtMjhFMy00QUVBLUIxNDMtMkJCQjJDQkVBNTREIn0.P-nWGsKp866LbgRrzuVhBut8p4ZaAZ8XZfhIchgsph4","playerItem":{"id":"78F6F7CE-28E3-4AEA-B143-2BBB2CBEA54D","ref":"282617259","vkapi":"282617259","xp":"256.94042397661","createDate":"2015-03-25 12:31:46","updateDate":"2015-04-17 00:50:13","userId":"Custom:F800A350-EE15-4F1C-9CCF-050B775A4CD9","money":"9639","crystals":"1000","maxdistance":"918","lvl":"3","energy":"10","name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0439","last_name":"\u0413\u0435\u043d\u043d\u0430\u0434\u0438\u0447","rank":"2467","combodate":"2015-03-25 15:56:09","keys":null,"platformid":"282617259"}}',
this.loginPage="https://www.dedgame.ru/backendmysql/login.php",this.apiSource="https://www.dedgame.ru/backendmysql/dedapi.php",a=JSON.parse(this.playerJSON);else{"?p=MYSQL"==window.location.search?(this.loginPage="https://www.dedgame.ru/backendmysql/login.php",this.apiSource="https://www.dedgame.ru/backendmysql/dedapi.php"):(this.loginPage="https://www.dedgame.ru/backend/login.php",this.apiSource="https://www.dedgame.ru/backend/dedapi.php");var a=getCookie("LOGIN_DATA"),a=decodeURIComponent(a),a=
a.replace(/\+/g," "),a=a.replace(/@/g,"+"),a=JSON.parse(a)}vkparams.token=a.tokenJWT;vkparams.registered=a.registered;startServerTimeTicker();vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.playerItem.id;PlayerData.inst.playerItem=PlayerData.inst.intJSON(a.playerItem);vkparams.viewerid=PlayerData.inst.playerItem.platformid;PlayerData.inst.playerItem.money=Math.round(PlayerData.inst.playerItem.money);PlayerData.inst.playerItem.crystals||(PlayerData.inst.playerItem.crystals=
0);vkparams.id=PlayerData.inst.playerItem.id;PlayerData.inst.getVKfriends()};PlayerData.prototype.addNotification=function(a,b){};
...
PlayerData.prototype.updateEnergy=function(a){if(this.playerItem){isNaN((new Date(this.playerItem.updateDate)).getTime())&&(this.playerItem.updateDate=sqlDate(datetime()));var b=sqlToJsDate(this.playerItem.updateDate),b=datetime().getTime()-b.getTime();this.playerItem.updateDate=sqlDate(datetime());b=b/1E3/60;if(0<b){var c=this.playerItem.energy;this.playerItem.energy+=b*this.epm;console.log(this.playerItem.energy);this.playerItem.energy>this.maxEnergy&&(this.playerItem.energy=this.maxEnergy);0>this.playerItem.energy&&
(this.playerItem.energy=0);null==a&&Math.floor(c)!=Math.floor(this.playerItem.energy)&&this.savePlayerData()}SM.inst.currentStage!=charStage&&SM.inst.currentStage!=shopStage||shopStage.updateStatsPanel();setTimeout(function(){PlayerData.inst.updateEnergy()},PlayerData.inst.delayEnergyMS)}};
...
getDedImage=function(a){shopStage.transScreen&&(shopStage.transScreen.visible=!1);if(a)var b=300,c=365,d=-55,e=-120;else b=SCR_WIDTH/2,c=SCR_HEIGHT,e=d=0;var f=CObj.getById("bback"),g=CObj.getById("ava");f.textField.alpha=0;g.textField.alpha=0;a&&(CObj.getById("bback").gfx.visible=!1,CObj.getById("ava").gfx.visible=!1,CObj.getById("bgshopded").gfx.visible=!1);b=new PIXI.RenderTexture(b,c);renderer.render(stage,!0);c=new PIXI.Matrix;c.translate(d,e);b.render(SM.inst.superStage,c);d=b.getBase64();b.destroy(!0);
