...
PlayerData.prototype.getItemById=function(a){for(var b=0;b<this.items.length;++b)if(this.items[b].id==a)return this.items[b];return null};PlayerData.prototype.getType=function(a){for(var b=0;b<PlayerData.inst.items.length;++b)if(PlayerData.inst.items[b].id==a.id_item)return PlayerData.inst.items[b].type;return null};PlayerData.prototype.azureReadData=function(){PlayerData.inst.callDedAPI("AZURE_READ_DATA",null,null,{score:PlayerData.inst.score,dist:LauncherBG.inst.distance},function(a){console.log(a)})};
PlayerData.prototype.saveScore=function(){PlayerData.inst.callDedAPI("SAVE_SCORE",null,null,{score:PlayerData.inst.score,dist:LauncherBG.inst.distance},function(a){console.log(a)})};
