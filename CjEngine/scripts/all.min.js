...
uploadPhoto=function(a,b){var c=getDedImage(!1);window.location=c;c=c.replace(/^data:image\/(png|jpg);base64,/,"");VK.api("photos.getWallUploadServer",{uid:a},function(a){a=a.response.upload_url;getParameterByName("hash",a);getParameterByName("rhash",a);$.ajax({type:"POST",url:"upload.php",data:{uploadUrl:a,photo:c},dataType:"text"}).success(function(a){a=JSON.parse(a);b?VK.api("photos.saveProfilePhoto",{server:a.server,photo:a.photo,hash:a.hash},function(a){console.log("SSS")},function(a){console.log("SSS")}):
