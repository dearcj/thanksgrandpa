var CG_GROUND=1,CG_MONSTER=2,CG_PLAYER=4,CG_BULLET=8;function getCookie2(a){return document.cookie.match(new RegExp("(?:^|; )"+a.replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"))[1]}function getCookie(a){a+="=";for(var b=document.cookie.split(";"),c=0;c<b.length;c++){for(var d=b[c];" "==d.charAt(0);)d=d.substring(1);if(0==d.indexOf(a))return d.substring(a.length,d.length)}return""}function strad(a,b){return parseInt(a)+parseInt(b)}function noc(a,b){a.click=null;a.tap=null}
function onc(a,b){a.click=b;a.tap=b}function extractName(a){return a.name?(a.name+" "+a.last_name).substring(0,16):"\u0410\u043d\u043e\u043d\u0438\u043c"}function findByProp(a,b,c){for(var d=a.length,e=0;e<d;++e)if(a[e][b]==c)return a[e];return null}function getRand(a){return a[Math.floor(Math.random()*a.length)]}function OpenInNewTab(a){window.open(a,"_blank").focus()}function clone(a){return JSON.parse(JSON.stringify(a))}
...
new TweenMax(m.scale,.6,{y:.55,ease:Elastic.easeOut});new TweenMax(m.scale,.4,{x:.55,ease:Elastic.easeOut});c=a.desc.split("|");b=c[0];1<c.length&&(b=c[1]);c=CObj.getById("tfdescd");c.setTextSafe(b);c.item=a};m.mouseout=function(b){b=CObj.getById("tfdescd");b.item==a&&b.setTextSafe("");a.type!=tWeapon&&a.type!=tApp+tHat||shopStage.pl.updateAppearence(!0,!1,null,null,null);m.tint=16777215;m.currentFrame&&m.gotoAndStop(1);new TweenMax(m.scale,.3,{x:.5,y:.5,ease:Elastic.easeOut})};if(g)for(var n=0;5>
n;++n){var q=n<h?crsp("improve point on"):crsp("improve point off");q.x=25*(n-2);q.scale.x=.8;q.scale.y=.8;q.y=3;f.addChild(q)}n=this.checkOwned(a);q=this.checkEq(a);tftext="";g&&(l?tftext="":n||(tftext=0>a.pricecrys&&0>a.price?"":0<a.pricecrys?a.pricecrys.toString():a.price.toString()));var r,l="",p="buy button",t;!n||g?g&&5==h?p="equipped button":a.reqlvl>PlayerData.inst.playerItem.lvl?(r=c,p="unlock button",l="\u041c\u0418\u041d "+a.reqlvl.toString()+" \u0423\u0420.",t="price star.png",tftext=
a.pricecrys.toString()):(r=e,t="price coin.png",p="buy button",tftext=a.price.toString()):1==q?"bcloth"==shopStage.currentTab?(p="unwear button",r=b):p="equipped button":(r=d,p="wear button");h=new CButton(0,129,p);"equipped button"==p&&(h.gfx.mouseout=null,h.gfx.mouseover=null);h.fontSize=33;h.addToSameLayer=!0;h.gfx.anchor.x=.5;h.gfx.anchor.y=.5;h.gfx.scale.x=.8;h.gfx.scale.y=.8;h.init();h.gfx.parent.removeChild(h.gfx);h.item=g?PlayerData.inst.getItemById(k.idNext):a;h.gfx.btn=h;h.click=r;f.addChild(h.gfx);
...
CGrenade.makeBoom=function(a,b,c,d,e){ZSound.Play("grenade");var f=pool.Pop("expl");if(f){var g=new CObj(a,b,null);f.loop=!1;f.gotoAndPlay(0);g.allowTrackSpeed=!0;g.gfx=f;g.updateGraphics();SM.inst.fg.addChild(f);g.rotation=Math.random()-.5;f.animationSpeed=.85;g.updateGraphics();g.return2Pool=g.gfx;g.lifeTime=800;g.gfx.onComplete=function(){g.destroy()}}var f=d*d,k=0;CMonster.list&&(k=CMonster.list.length);for(var h=0;h<k;++h){var l=CMonster.list[h];if(!l.doRemove&&l!=e){var m=l.x-a,n=l.y-b,m=m*
m+n*n;m<f&&(m=Math.sqrt(m),l.dealDamage((d-(m+.01))/d*c));l.doRemove&&(h--,k--)}}this.owner!=gameStage.player&&(m=gameStage.player.x-a,n=gameStage.player.y-b,m*m+n*n<.25*d*d&&gameStage.player.dealDamage(1))};CGrenade.prototype.collide=function(a){this.owner!=gameStage.player&&a&&CObj.checkType(a,CMonster)||a==this.owner||(CGrenade.makeBoom(this.x,this.y,this.dmg,350,this.owner),this.destroy())};CGrenade.prototype.destroy=function(){CBullet.prototype.destroy.call(this)};
...
{};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&(vkparams.viewerid=vkparams.viewerid.toString());vkparams.viewerid&&VK||(vkparams.viewerid="CARLSON",MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);if("CARLSON"==vkparams.viewerid||"2882845"==vkparams.viewerid||"282617259"==vkparams.viewerid||"197515742"==vkparams.viewerid){vkparams.gamerid=vkparams.userid||vkparams.viewerid;
vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");var a=getCookie("LOGIN_DATA"),a=decodeURIComponent(a),a=a.replace(/\+/g," "),a=a.replace(/@/g,"+");window.decompress(a);a=JSON.parse(a);vkparams.token=a.tokenJWT;vkparams.registered=a.registered;vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.playerItem.id;PlayerData.inst.playerItem=
PlayerData.inst.intJSON(a.playerItem);PlayerData.inst.playerItem.crystals||(PlayerData.inst.playerItem.crystals=0);vkparams.id=PlayerData.inst.playerItem.id;PlayerData.inst.getVKfriends()}};PlayerData.prototype.addNotification=function(a,b){};
...
a&&a()});PlayerData.inst.callDedAPI("READ","tb_ach_player",null,null,function(b){PlayerData.inst.achs_progress=PlayerData.inst.intJSON(b);PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()});PlayerData.inst.callDedAPI("READ","tb_item_player",null,null,function(b){PlayerData.inst.items_enabled=PlayerData.inst.intJSON(b);PlayerData.inst.baseWeapIt=PlayerData.inst.getItemById("68AFAEDC-B3E0-401E-9E1A-E272084F2E11");PlayerData.inst.baseWeapItPl={id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",
id_player:PlayerData.inst.pid,equipped:!1};PlayerData.inst.items_enabled.push(PlayerData.inst.baseWeapItPl);PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()})};PlayerData.prototype.saveAllData=function(){this.savePlayerData();this.savePlayerItems();this.savePlayerEvents();this.savePlayerAchs()};
...
PlayerData.inst.getVKuserData(a)})};PlayerData.prototype.saveRunProgress=function(a){if(SM.inst.currentStage==gameStage&&!gameStage.progressSaved){var b=Math.round(PlayerData.inst.playerItem.maxdistance);LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(b=Math.round(LauncherBG.inst.distance));gameStage.progressSaved=!0;PlayerData.inst.playerItem.money+=PlayerData.inst.score;PlayerData.inst.playerItem.maxdistance=b;null==a&&PlayerData.inst.savePlayerData()}};
PlayerData.prototype.getVKfriends=function(){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";console.log("!!!!"+PlayerData.inst.playerItem.name);PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=parseInt(a);PlayerData.inst.savePlayerData()});console.log("Gettin vk friends");vkparams.friendsids=[];vkparams.friendsIngameIDs=[];vkparams.novk?"?lhst=1922"==window.location.search&&this.loadData(this.loadEnd):VK.api("friends.getAppUsers",{},function(a){vkparams.friendsIngameIDs=
