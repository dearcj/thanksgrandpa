...
uploadPhoto=function(a){var b=new PIXI.RenderTexture(SCR_WIDTH,SCR_HEIGHT);b.render(SM.inst.superStage);b.getBase64();VK.api("photos.getWallUploadServer",{uid:a},function(a){a=a.response.upload_url.replace("http://","https://");$.ajax({type:"POST",url:"upload.php",data:{uploadUrl:a},dataType:"json",success:function(a){console.log("")},error:function(a){console.log("")}})})};
