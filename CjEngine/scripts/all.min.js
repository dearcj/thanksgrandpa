...
ComixStage.prototype.goNext=function(){comixStage.dcNext&&comixStage.dcNext.kill();TweenMax.killAll(!0,!0,!0);var a=this.comixData.shift();a||SM.inst.openStage(charStage);for(var b=0;b<a.objects.length;++b){var c=a.objects[b],d=crsp(c.tex);comixStage.comixContainer.addChild(d);d.visible=!1;c.rot1||(c.rot1=0);c.rot2||(c.rot2=0);c.p1||(c.p1=[0,0]);c.p2||(c.p2=c.p1);c.s1||(c.s1=[1,1]);c.s2||(c.s2=c.s1);d.scale.x=1.1*c.s1[0];d.scale.y=1.1*c.s1[1];d.rotation=c.rot1;d.x=c.p1[0];d.y=c.p1[1];d.vx=0;d.vy=
0;d.va=0;c.ease||(c.ease=Sine.easeOut);new TweenMax(d.scale,c.tweenTime,{x:1.1*c.s2[0],y:1.1*c.s2[1],delay:c.delay});(function(a,b){new TweenMax(a,b.tweenTime,{ease:b.ease,rotation:b.rot2,x:b.p2[0],y:b.p2[1],delay:b.delay,onComplete:function(){a.vx=b.vx;a.vy=b.vy;a.va=b.va}})})(d,c);c.delay||(c.delay=0);setVisible=function(a){c.alphaHide&&new TweenMax(a,.1,{delay:c.alphaHide+c.delay,alpha:0});TweenMax.delayedCall(c.delay,function(){a.visible=!0})};setVisible(d)}};
...
function CPlayer(a,b,c,d){CLiveObj.apply(this,[a,b,null,d]);this.initialJumpSpeed=-21.5;this.gravPower=1.3;this.gfx=this.createDedGraphics();this.fireAngle=0;this.weapon=gameStage.curweapon;this.bar=CObj.getById("hpbar");this.ammobar=gameStage.ammobar;this.colGroup=CG_PLAYER;this.colMask=CG_MONSTER;this.hp=this.maxHp=5;this.baseY=this.y+=10;this.baseX=this.x;this.offsetY=-20;this.offsetX=-25;this.radius=this.gfx.width/2-35;this.sMoving=1;this.sDying=2;this.state=this.sMoving;this.playable=!1;this.lastUseExpl=
