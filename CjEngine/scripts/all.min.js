...
uploadPhoto=function(a){var b=new PIXI.RenderTexture(SCR_WIDTH,SCR_HEIGHT);b.render(SM.inst.superStage);b.getBase64();VK.api("photos.getWallUploadServer",{uid:a},function(a){$.ajax({type:"POST",url:"upload.php",data:{uploadUrl:a.response.upload_url},dataType:"text"}).success(function(a){JSON.parse(a);console.log("")}).error(function(a){console.log("")})})};
