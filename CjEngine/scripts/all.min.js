var CG_GROUND=1,CG_MONSTER=2,CG_PLAYER=4,CG_BULLET=8;function findByProp(a,b,c){for(var d=a.length,e=0;e<d;++e)if(a[e][b]==c)return a[e];return null}function getRand(a){return a[Math.floor(Math.random()*a.length)]}function OpenInNewTab(a){window.open(a,"_blank").focus()}function clone(a){return JSON.parse(JSON.stringify(a))}function superRand(a){for(var b=0,c=0;c<a;++c)b+=Math.random();return b/a}
...
take:5,skip:scoreStage.skip},method:"post"}).done(function(a){a=a.result;for(var c=0;c<Math.min(5,a.length);++c)CObj.getById("tf"+(c+1).toString()+"2").text=(a[c].name+" "+a[c].last_name).substring(0,16),CObj.getById("tf"+(c+1).toString()+"3").text=a[c].maxdistance.toString(),b>a[c].maxdistance&&(CObj.getById("b"+(c+1).toString()).gfx.visible=!0,CObj.getById("b"+(c+1).toString()).text="\u042f \u0442\u0435\u0431\u044f \u0443\u0434\u0435\u043b\u0430\u043b",function(a,c){CObj.getById("b"+(a+1).toString()).click=
function(){VK.api("wall.post",{owner_id:c.vkapi,message:"\u042f \u043f\u0440\u043e\u0435\u0445\u0430\u043b"+b.toString()+" \u043c\u0435\u0442\u0440\u043e\u0432. "+c.name+" "+c.last_name+",  \u043d\u0438\u043a\u043e\u0433\u0434\u0430 \u043d\u0435 \u043f\u043e\u0431\u044c\u0435\u0448\u044c \u043c\u043e\u0439 \u0440\u0435\u043a\u043e\u0440\u0434!!\nhttps://vk.com/app4654201",attachments:["photo282617259_360326329","https://vk.com/app4654201"]},function(a){})}}(c,a[c]));for(a=c;5>a;++a)CObj.getById("b"+
...
!vkparams.friendsIngame||e>=vkparams.friendsIngame.length?g.click=function(){VK.callMethod("showInviteBox")}:(username=vkparams.friendsIngame[e].name,g.click=function(){VK.api("wall.post",{owner_id:vkparams.viewerid,message:username+", \u0432\u043e\u0437\u0432\u0440\u0430\u0449\u0430\u0439\u0441\u044f \u0432 \u0438\u0433\u0440\u0443 \u0434\u0440\u0443\u0436\u0438\u0449\u0435",attachments:["photo2882845_347400805","https://vk.com/app4654201"]},function(a){})},""!=b&&(b+=","),b+=vkparams.friendsIngame[e].vkapi.toString(),
...
return a};
CharStage.prototype.openPremiumWindow=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);LevelManager.loadLevel("levelpremium",function(){close=function(){LevelManager.removeLastLevel();CObj.enableButtons(!0);a.parent.removeChild(a)};charStage.skipFriends=0;orderFunc=function(a){ZSound.Play("buy");order(a);shopStage.updateStatsPanel()};CObj.getById("btnfree").click=function(){VK.callMethod("showOrderBox",{type:"offers",currency:"true"})};CObj.getById("buy1").click=function(){orderFunc("item1")};
CObj.getById("buy2").click=function(){orderFunc("item2")};CObj.getById("buy3").click=function(){orderFunc("item3")};CObj.getById("buy4").click=function(){orderFunc("item4")};CObj.getById("buy5").click=function(){orderFunc("item5")};CObj.getById("buy6").click=function(){orderFunc("item6")};CObj.getById("btnclose").click=close;CObj.getById("btnfree").click=close},SM.inst.fontLayer)};
...
ShopStage.prototype.createItemBtn=function(a){function b(a){shopStage.buyItem(a,!0)}function c(b){PlayerData.inst.equipItem(a);shopStage.pl.updateAppearence(!0,!1,null,null,null);shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos)}function d(a){shopStage.buyItem(a,!1)}var e=new PIXI.DisplayObjectContainer,f="bstuff"==shopStage.currentTab;if(f){var g=PlayerData.inst.getUpgrade(a),k=g.upgr;g.id&&(a=PlayerData.inst.getItemById(g.id))}var h=crsp(a.gfx);h.x=0;h.scale.x=
.5;h.scale.y=.5;h.y=h.height/2;e.addChild(h);h.interactive=!0;h.mouseover=function(b){if(a.type==tWeapon||a.type==tApp+tHat){var c=b=null;a.type==tWeapon&&(c=a.gfx);a.type==tApp+tHat&&(b=a.gfx);shopStage.pl.updateAppearence(!0,!1,null,c,b)}TweenMax.killTweensOf(h.scale);h.tint=CButton.tintColor;new TweenMax(h.scale,.6,{y:.55,ease:Elastic.easeOut});new TweenMax(h.scale,.4,{x:.55,ease:Elastic.easeOut});c=a.desc.split("|");b=c[0];1<c.length&&(b=c[1]);c=CObj.getById("tfdescd");c.setTextSafe(b);c.item=
a};h.mouseout=function(b){b=CObj.getById("tfdescd");b.item==a&&b.setTextSafe("");a.type!=tWeapon&&a.type!=tApp+tHat||shopStage.pl.updateAppearence(!0,!1,null,null,null);h.tint=16777215;h.currentFrame&&h.gotoAndStop(1);new TweenMax(h.scale,.3,{x:.5,y:.5,ease:Elastic.easeOut})};if(f)for(var l=0;5>l;++l){var m=l<k?crsp("improve point on"):crsp("improve point off");m.x=25*(l-2);m.scale.x=.8;m.scale.y=.8;m.y=3;e.addChild(m)}var n=this.checkOwned(a),r=this.checkEq(a);tftext="";if(f&&5==k)tftext="";else if(!n||
f)tftext=0>a.pricecrys&&0>a.price?"":0<a.pricecrys?a.pricecrys.toString():a.price.toString();var p,l="",m="buy button";!n||f?f&&5==k?m="equipped button":a.reqlvl>PlayerData.inst.playerItem.lvl?(p=b,m="unlock button",l="\u041c\u0418\u041d "+a.reqlvl.toString()+" \u0423\u0420."):(p=d,m="buy button"):1==r?m="equipped button":(p=c,m="wear button");k=new CButton(0,129,m);"equipped button"==m&&(k.gfx.mouseout=null,k.gfx.mouseover=null);k.fontSize=33;k.addToSameLayer=!0;k.gfx.anchor.x=.5;k.gfx.anchor.y=
.5;k.gfx.scale.x=.8;k.gfx.scale.y=.8;k.init();k.gfx.parent.removeChild(k.gfx);k.item=f?PlayerData.inst.getItemById(g.idNext):a;k.gfx.btn=k;k.click=p;e.addChild(k.gfx);k.text&&(k.text=k.text);e.btn=k;if(tftext){if(0<a.price)var q="price coin.png";0<a.pricecrys&&(q="price star.png");q&&(f=crsp(q),f.x=0,f.y=80,f.scale.x=.75,f.scale.y=.75,e.addChild(f))}f=new CTextField;f.tint="0x333333";f.fontSize=15;f.align="center";f.init();e.infoTF=f;f.x=0;f.y=158;f.gfx.parent.removeChild(f.gfx);f.text=l;e.addChild(f.gfx);
f=new CTextField;f.tint="0x333333";f.fontSize=15;f.align="center";f.text=tftext;f.init();e.tfprice=f;f.x=10;f.y=70;f.gfx.parent.removeChild(f.gfx);e.addChild(f.gfx);f.text=f.text;e.destroy=function(){e.tfprice.destroy();e.btn&&(e.btn.destroy(),e.btn=null);e.tfprice=null;e.parent.removeChild(e)};return e};
...
CBooster.prototype.onActivate=function(){this.activate=!0;PlayerData.inst.progressAch("Gold medal 5",1,!1);this.startTime=window.time;this.lastTick=0;this.tf=CTextField.createTextField({fontFamily:"dedgamecaps",tint:"0xFFFFFF",text:"",fontSize:80,align:"center"});this.tf.x=this.tf.width/2;this.tf.y=-40;this.gfx.addChild(this.tf)};
CBooster.prototype.process=function(){if(this.activate&&!this.doRemove){if(this.tf){if(1E3<window.time-this.lastTick){this.lastTick=window.time;var a=Math.round(this.duration-(window.time-this.startTime)/1E3);0>a&&(a=0);this.tf.text=a.toString();this.tf.updateText()}this.tf.x=-this.tf.width/2}if(this.startTime&&window.time-this.startTime>1E3*this.duration)this.onDeactivate()}};extend(CDoubleBooster,CBooster,!0);function CDoubleBooster(a,b,c,d){CBooster.apply(this,[a,b,c,d]);this.duration=15+3*d}
CDoubleBooster.prototype.onActivate=function(){gameStage.player&&(CBooster.prototype.onActivate.call(this),gameStage.player.doubleBooster=2+.25*this.upgr)};CDoubleBooster.prototype.onDeactivate=function(){gameStage.player.doubleBooster=null;CBooster.prototype.onDeactivate.call(this)};extend(CHeartBooster,CBooster,!0);function CHeartBooster(a,b,c,d){CBooster.apply(this,[a,b,c,d]);this.duration=.1}
CHeartBooster.prototype.onActivate=function(){this.upgr&&(gameStage.player.hp+=this.upgr);gameStage.player&&CBooster.prototype.onActivate.call(this)};extend(CMagnetBooster,CBooster,!0);function CMagnetBooster(a,b,c,d){CBooster.apply(this,[a,b,c,d]);a=250+20*d;CMagnetBooster.mindist=a*a;this.duration=40+10*d}
...
CSupermanBooster.prototype.onDeactivate=function(){gameStage.player.jumping=!1;gameStage.player.gravityEnabled=!0;rp(this.fire1);rp(this.fire2);rp(this.fire3);this.fire3=this.fire2=this.fire1=null;gameStage.player.invulnerable++;var a=gameStage.player;TweenMax.delayedCall(1,function(){a.invulnerable--});CBooster.prototype.onDeactivate.call(this)};CSupermanBooster.prototype.process=function(){this.activate&&!this.doRemove&&(gameStage.player&&(gameStage.player.vy=.7*Math.cos(window.time/1E3)),CBooster.prototype.process.call(this))};
extend(CTabletsBooster,CBooster,!0);function CTabletsBooster(a,b,c,d){CBooster.apply(this,[a,b,c,d]);this.duration=4+d}CTabletsBooster.prototype.onActivate=function(){CBooster.prototype.onActivate.call(this);if(gameStage.player){this.lastUse=window.time;gameStage.player.invulnerable++;var a=gameStage.player;a.blink=!0;this.prevVel=LauncherBG.inst.maxVelocity;a.superMode=!0;new TweenMax(LauncherBG.inst,1.5,{maxVelocity:LauncherBG.inst.maxVelocity+25,ease:Linear.easeOut})}};
CTabletsBooster.prototype.onDeactivate=function(){new TweenMax(LauncherBG.inst,.3,{maxVelocity:this.prevVel,ease:Linear.easeOut});CBooster.prototype.onDeactivate.call(this);var a=gameStage.player;a.superMode=!1;a.resetBlink();a.invulnerable--;a.blink=!1};
...
gfx:"gun1",reqlvl:2},{type:tWeapon,price:1300,pricecrys:26,name:"AK-74",desc:"\u041a\u0430\u043b\u0430\u0448|\u0410\u041a-47 - \u0430\u0432\u0442\u043e\u043c\u0430\u0442 \u0431\u044b\u043b \u0441\u043a\u043e\u043d\u0441\u0442\u0440\u0443\u0438\u0440\u043e\u0432\u0430\u043d==\u0432 1947 \u0433\u043e\u0434\u0443 \u041c\u0438\u0445\u0430\u0438\u043b\u043e\u043c \u0422\u0438\u043c\u043e\u0444\u0435\u0435\u0432\u0438\u0447\u0435\u043c \u041a\u0430\u043b\u0430\u0448\u043d\u0438\u043a\u043e\u0432\u044b\u043c==\u043c\u0430\u0433\u0430\u0437\u0438\u043d 35 \u043f\u0430\u0442\u0440\u043e\u043d\u043e\u0432",
...
gfx:"gun3",reqlvl:7},{type:tWeapon,price:8E3,pricecrys:160,name:"Grenade launcher",desc:"\u0413\u0440\u0430\u043d\u0430\u0442\u043e\u043c\u0451\u0442 - \u0440\u0443\u0447\u043d\u043e\u0439 \u043c\u043d\u043e\u0433\u043e\u0437\u0430\u0440\u044f\u0434\u043d\u044b\u0439==\u043f\u043e\u043b\u0443\u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438\u0439 \u0433\u0440\u0430\u043d\u0430\u0442\u043e\u043c\u0435\u0442==6 \u0441\u043d\u0430\u0440\u044f\u0434\u043e\u0432",gfx:"gun4",
reqlvl:10},{type:tWeapon,price:3E4,pricecrys:600,name:"Plazma Cannon",desc:"\u041b\u0430\u0437\u0435\u0440\u043d\u0430\u044f \u0432\u0438\u043d\u0442\u043e\u0432\u043a\u0430 - \u044d\u043d\u0435\u0440\u0433\u0435\u0442\u0438\u0447\u0435\u0441\u043a\u043e\u0435 \u043e\u0440\u0443\u0436\u0438\u0435==\u0440\u0430\u0437\u0440\u0430\u0431\u043e\u0442\u0430\u043d\u043d\u043e\u0435 \u0432 \u0446\u0435\u043d\u0442\u0440\u0435 \u0421\u043a\u043e\u043b\u043a\u043e\u0432\u043e",gfx:"gun5",reqlvl:15},{type:tBoost,
price:100,pricecrys:-1,name:"Magnet",desc:"\u041c\u0430\u0433\u043d\u0438\u0442|\u041c\u0430\u0433\u043d\u0438\u0442: \u043f\u0440\u0438\u0442\u044f\u0433\u0438\u0432\u0430\u0435\u0442 \u043c\u043e\u043d\u0435\u0442\u044b \u043f\u0440\u044f\u043c\u043e \u0432 \u043a\u0430\u0440\u043c\u0430\u043d.==\u0414\u0435\u0439\u0441\u0442\u0432\u0443\u0435\u0442 40 \u0441\u0435\u043a\u0443\u043d\u0434.==[\u0423\u043b\u0443\u0447\u0448\u0435\u043d\u0438\u0435]==\u041f\u0440\u043e\u0434\u043e\u043b\u0436\u0438\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u044c + 5 \u0441\u0435\u043a\u0443\u043d\u0434==\u0414\u0438\u0441\u0442\u0430\u043d\u0446\u0438\u044f \u043f\u043e\u0434\u0431\u043e\u0440\u0430 \u0443\u0432\u0435\u043b\u0438\u0447\u0435\u043d\u0430.",
...
getDedImage=function(a){shopStage.transScreen&&(shopStage.transScreen.visible=!1);if(a)var b=300,c=365,d=-55,e=-150;else b=SCR_WIDTH/2,c=SCR_HEIGHT,e=d=0;b=new PIXI.RenderTexture(b,c);a&&(CObj.getById("bgshopded").gfx.visible=!1);renderer.render(stage,!0);a=new PIXI.Matrix;a.translate(d,e);b.render(SM.inst.superStage,a);d=b.getBase64();b.destroy(!0);CObj.getById("bgshopded").gfx.visible=!0;shopStage.transScreen&&(shopStage.transScreen.visible=!0);return d};
