...
!0;onAssetsLoaded()};loader.load();loader.onProgress=onAssetsProgress}function onAssetsProgress(a){window.assetsLoaded++;a.json&&void 0!=a.json.objects&&(LevelManager.levels[a.url]=a.json)}
function assetsButSoundsLoaded(){ZSound.soundLoadedFunction=onAssetsLoaded;ZSound.Init([{id:"m_room",src:"PostRoom.ogg"},{id:"m_ded",src:"Dedushka.ogg"},{id:"rifle",src:"rifle.ogg"},{id:"levelup",src:"levelup.ogg"},{id:"buy",src:"buy.ogg"},{id:"losing",src:"losing.ogg"},{id:"grenade",src:"grenade.ogg"},{id:"vzbodritsa",src:"vzbodritsa.ogg"}])}
