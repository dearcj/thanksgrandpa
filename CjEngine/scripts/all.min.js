...
function(){charStage.skipFriends+=5;charStage.frp.parent.removeChild(charStage.frp);charStage.frp=charStage.createFriendsPanel()};CObj.getById("bbuy1").click=charStage.openPremiumWindow;CObj.getById("bbuy2").click=charStage.openPremiumWindow;CObj.getById("tname").text=vkparams.first_name.toUpperCase()+" "+vkparams.last_name.toUpperCase();CObj.getById("bset").click=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);a.interactive=!0;var c=LevelManager.loadLevel("settings",
function(){CObj.getById("bcallback").click=function(){window.location.href="mailto:thanksgrandpa@gmail.com";window.open("mailto:thanksgrandpa@gmail.com","mail")};CObj.getById("bmusic").click=function(){ZSound.available?ZSound.Mute():ZSound.UnMute()};a.click=function(){var d=CObj.getById("setbg");if(!(window.mouseX>d.x-d.gfx.width/2&&window.mouseX<d.x+d.gfx.width/2&&window.mouseY>d.y-d.gfx.height/2&&window.mouseY<d.y+d.gfx.height/2)){rp(a);CObj.enableButtons(!0);for(d=0;d<c.length;++d)c[d].destroy();
a.click=null}}},SM.inst.fontLayer)};CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("btnfight").click=function(){if(1<=PlayerData.inst.playerItem.energy)--PlayerData.inst.playerItem.energy,SM.inst.openStage(gameStage);else{var a=CObj.getById("tfenergy"),c=CObj.getById("energyback");new TweenMax(a,.1,{y:a.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});
new TweenMax(c,.1,{y:c.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});charStage.openEnergyWindow()}};var a=new CPlayer(400,430);charStage.pl=a;a.gfx.scale.x=.34;a.gfx.scale.y=.34;a.updateAppearence(!0,!1,"breath");SM.inst.ol.addChild(a.gfx);a.gfx.interactive=!0;CObj.getById("bsofa").click=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);a.interactive=!0;for(var c=0;c<CObj.objects.length;++c)CObj.checkType(CObj.objects[c],CEActionGUI)&&CObj.objects[c].btnReward&&
(CObj.objects[c].btnReward.gfx.interactive=!0);charStage.closeEventsWnd=function(){a.parent.removeChild(a);CObj.enableButtons(!0);charStage.bar.gfx.visible=!1};a.click=function(){var a=charStage.bar;window.mouseX>a.x-a.gfx.width/2&&window.mouseX<a.x+a.gfx.width/2&&window.mouseY>a.y-a.gfx.height/2&&window.mouseY<a.y+a.gfx.height/2||charStage.closeEventsWnd()};charStage.bar.gfx.parent.removeChild(charStage.bar.gfx);SM.inst.fontLayer.addChild(charStage.bar.gfx);charStage.bar.gfx.visible=!0};PlayerData.inst.comboCheck();
charStage.bar=new CScrollbar(180,309,"",380,524,"podlozhka actions.png","scroll line actions.png","scroll.png",50);charStage.bar.gfx.scale.x=.7;charStage.bar.gfx.scale.y=.7;charStage.bar.gfx.visible=!1;charStage.updateEvents();shopStage.updateStatsPanel();charStage.frp=charStage.createFriendsPanel()};
...
CharStage.prototype.process=function(){if(1>PlayerData.inst.playerItem.energy)CObj.getById("tfdelay").gfx.visible=!0;else if(CObj.getById("tfdelay").gfx.visible=!1,Math.round(PlayerData.inst.playerItem.energy)<Math.round(PlayerData.inst.maxEnergy)){var a=dateDiff(PlayerData.inst.playerItem.updateDate,PlayerData.inst.delayEnergyMS/6E4);CObj.getById("tfdelay").text=a.timeString}else CObj.getById("tfdelay").text="";CObj.processAll();for(var b=a=0;b<CObj.objects.length;++b)if(CObj.checkType(CObj.objects[b],
CEActionGUI)&&CObj.objects[b].acting){var c=(window.time-CObj.objects[b].startTime)/CObj.objects[b].execTime;1<=c?(CObj.objects[b].pos=1,CObj.objects[b].endAction()):CObj.objects[b].pos=c;a++}};CharStage.prototype.updateFriends=function(){PlayerData.inst.savePlayerData();azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsIngameIDs,take:charStage.showRecords,skip:charStage.skip},method:"post"}).done(function(a){charStage.updateSB(a.result)},function(a){})};
...
ShopStage.prototype.onShow=function(){azureclient.getTable("tb_players").update(PlayerData.inst.playerItem);LevelManager.loadLevel("levshop",function(){LevelManager.loadLevel("upperPanel",shopStage.onShowContinue,SM.inst.ol)})};ShopStage.prototype.checkEq=function(a){for(var b=0;b<PlayerData.inst.items_enabled.length;++b)if(PlayerData.inst.items_enabled[b].id_item==a.id&&1==PlayerData.inst.items_enabled[b].equipped)return!0;return!1};
...
null;a.type==tWeapon&&(c=a.gfx);a.type==tApp+tHat&&(b=a.gfx);shopStage.pl.updateAppearence(!0,!1,null,c,b)}TweenMax.killTweensOf(f.scale);f.tint=CButton.tintColor;new TweenMax(f.scale,.6,{y:.55,ease:Elastic.easeOut});new TweenMax(f.scale,.4,{x:.55,ease:Elastic.easeOut});c=a.desc.split("|");b=c[0];1<c.length&&(b=c[1]);c=CObj.getById("tfdescd");c.setTextSafe(b);c.item=a};f.mouseout=function(b){b=CObj.getById("tfdescd");b.item==a&&b.setTextSafe("");a.type!=tWeapon&&a.type!=tApp+tHat||shopStage.pl.updateAppearence(!0,
!1,null,null,null);f.tint=16777215;f.currentFrame&&f.gotoAndStop(1);new TweenMax(f.scale,.3,{x:.5,y:.5,ease:Elastic.easeOut})};var g=this.checkOwned(a),k=this.checkEq(a);tftext="";g||(tftext=0>a.pricecrys&&0>a.price?"":0<a.pricecrys?a.pricecrys.toString():a.price.toString());var h,l="",m=0,n="buy button";g?(m=-45,1==k?n="equipped button":(h=c,n="wear button"),"bstuff"==shopStage.currentTab&&(n="equipped button")):a.reqlvl>PlayerData.inst.playerItem.lvl?(h=b,n="unlock button",l="\u041c\u0418\u041d "+
a.reqlvl.toString()+" \u0423\u0420."):(h=d,n="buy button",m=-15);g=new CButton(0,182+m,n);"equipped button"==n&&(g.gfx.mouseout=null,g.gfx.mouseover=null);g.fontSize=33;g.addToSameLayer=!0;g.gfx.anchor.x=.5;g.gfx.anchor.y=.5;g.gfx.scale.x=.8;g.gfx.scale.y=.8;g.init();g.gfx.parent.removeChild(g.gfx);g.item=a;g.gfx.btn=g;g.click=h;e.addChild(g.gfx);g.text&&(g.text=g.text);e.btn=g;if(tftext){if(0<a.price)var p="price coin.png";0<a.pricecrys&&(p="price star.png");p&&(h=crsp(p),h.x=0,h.y=110,e.addChild(h))}h=
new CTextField;h.tint="0x333333";h.fontSize=15;h.align="center";h.init();e.infoTF=h;h.x=0;h.y=135;h.gfx.parent.removeChild(h.gfx);h.text=l;e.addChild(h.gfx);l=new CTextField;l.tint="0x333333";l.fontSize=17;l.align="left";l.text=tftext;l.init();e.tfprice=l;l.x=2;l.y=100;l.gfx.parent.removeChild(l.gfx);e.addChild(l.gfx);l.text=l.text;e.destroy=function(){e.tfprice.destroy();e.btn&&(e.btn.destroy(),e.btn=null);e.tfprice=null;e.parent.removeChild(e)};return e};
...
"\u043f\u0438\u0441\u0442\u043e\u043b\u0435\u0442","\u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435",{visualWidth:10,dw:.1,speed:60.5,sound:"ochered",queue:4,queueDelay:110,life:1,acc:.08,accIncrease:.02,accRecoil:.1,recoil:1.5,magcap:50,delay:600,damage:55,unlockprice:10,reloadTime:2200},"asd",[{name:"\u0422\u043e\u0447\u043d\u044b\u0439 \u0441\u0442\u0432\u043e\u043b",param:"recoil",valuesUpgr:[10,20,30,40],level:0},{name:"\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u043c\u0430\u0433\u0430\u0437\u0438\u043d",
...
PlayerData.prototype.loadEnd=function(){PlayerData.inst.createAchProgress();window.dbinit=!0;2882845==vkparams.viewerid&&checkDb();window.dbinit&&window.loaded&&assetsButSoundsLoaded();vkparams.registered?SM.inst.openStage(comixStage):SM.inst.openStage(charStage)};
...
gfx:"orden6.png"},{name:"Gold medal 11",desc:"\u0423\u0431\u0438\u0442\u044c 200 \u0448\u043a\u043e\u043b\u044c\u043d\u0438\u043a\u043e\u0432",gfx:"orden12.png"}]},{tbname:"tb_items",items:[{type:tWeapon,price:-1,pricecrys:-1,name:"Rifle",desc:"\u0420\u0443\u0436\u044c\u0438\u0448\u043a\u043e",gfx:"gun0",reqlvl:-1},{type:tWeapon,price:500,pricecrys:-1,name:"PPS",desc:"\u041f\u041f\u0428|\u041f\u0438\u0441\u0442\u043e\u043b\u0435\u0442-\u043f\u0443\u043b\u0435\u043c\u0451\u0442 \u0428\u043f\u0430\u0433\u0438\u043d\u0430",
gfx:"gun1",reqlvl:2},{type:tWeapon,price:1E3,pricecrys:-1,name:"AK-74",desc:"\u041a\u0430\u043b\u0430\u0448|\u0410\u041a-47 - \u0430\u0432\u0442\u043e\u043c\u0430\u0442 \u0431\u044b\u043b \u0441\u043a\u043e\u043d\u0441\u0442\u0440\u0443\u0438\u0440\u043e\u0432\u0430\u043d==\u0432 1947 \u0433\u043e\u0434\u0443 \u041c\u0438\u0445\u0430\u0438\u043b\u043e\u043c \u0422\u0438\u043c\u043e\u0444\u0435\u0435\u0432\u0438\u0447\u0435\u043c \u041a\u0430\u043b\u0430\u0448\u043d\u0438\u043a\u043e\u0432\u044b\u043c",
gfx:"gun2",reqlvl:4},{type:tWeapon,price:2E3,pricecrys:1,name:"Minigun",desc:"\u041c\u0438\u043d\u0438\u0433\u0430\u043d - \u043c\u043d\u043e\u0433\u043e\u0441\u0442\u0432\u043e\u043b\u044c\u043d\u044b\u0439 \u0441\u043a\u043e\u0440\u043e\u0441\u0442\u0440\u0435\u043b\u044c\u043d\u044b\u0439 \u043f\u0443\u043b\u0435\u043c\u0451\u0442==\u043f\u043e\u0441\u0442\u0440\u043e\u0435\u043d\u043d\u044b\u0439 \u043f\u043e \u0441\u0445\u0435\u043c\u0435 \u0413\u0430\u0442\u043b\u0438\u043d\u0433\u0430",gfx:"gun3",
reqlvl:7},{type:tWeapon,price:1E4,pricecrys:5,name:"Grenade launcher",desc:"\u0413\u0440\u0430\u043d\u0430\u0442\u043e\u043c\u0451\u0442 - \u0440\u0443\u0447\u043d\u043e\u0439 \u043c\u043d\u043e\u0433\u043e\u0437\u0430\u0440\u044f\u0434\u043d\u044b\u0439==\u043f\u043e\u043b\u0443\u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438\u0439 \u0433\u0440\u0430\u043d\u0430\u0442\u043e\u043c\u0435\u0442",gfx:"gun4",reqlvl:10},{type:tWeapon,price:6E4,pricecrys:15,name:"Plazma Cannon",
desc:"\u041b\u0430\u0437\u0435\u0440\u043d\u0430\u044f \u0432\u0438\u043d\u0442\u043e\u0432\u043a\u0430 - \u044d\u043d\u0435\u0440\u0433\u0435\u0442\u0438\u0447\u0435\u0441\u043a\u043e\u0435 \u043e\u0440\u0443\u0436\u0438\u0435==\u0440\u0430\u0437\u0440\u0430\u0431\u043e\u0442\u0430\u043d\u043d\u043e\u0435 \u0432 \u0446\u0435\u043d\u0442\u0440\u0435 \u0421\u043a\u043e\u043b\u043a\u043e\u0432\u043e",gfx:"gun5",reqlvl:15},{type:tBoost,price:500,pricecrys:-1,name:"Magnet",desc:"\u041c\u0430\u0433\u043d\u0438\u0442|\u041c\u0430\u0433\u043d\u0438\u0442 - \u043f\u0440\u0438\u0442\u044f\u0433\u0438\u0432\u0430\u0435\u0442 \u043c\u043e\u043d\u0435\u0442\u044b \u0432\u0440\u0430\u0433\u043e\u0432 \u043f\u0440\u044f\u043c\u043e \u0432 \u043a\u0430\u0440\u043c\u0430\u043d.",
gfx:"booster2",reqlvl:2},{type:tBoost,price:200,pricecrys:5,name:"Tablets",desc:"\u0411\u0438\u043e\u0434\u043e\u0431\u0430\u0432\u043a\u0438|\u0422\u0430\u0431\u043b\u0435\u0442\u043a\u0430 - \u0443\u0441\u043a\u043e\u0440\u044f\u0435\u0442 \u0434\u0435\u0434\u0430==\u0438 \u0434\u0435\u043b\u0430\u0435\u0442 \u0435\u0433\u043e \u043d\u0435\u0443\u044f\u0437\u0432\u0438\u043c\u044b\u043c \u043d\u0430 \u043d\u0435\u043a\u043e\u0442\u043e\u0440\u043e\u0435 \u0432\u0440\u0435\u043c\u044f.",gfx:"booster1",
reqlvl:1},{type:tBoost,price:800,pricecrys:-1,name:"Health",desc:"\u0411\u043e\u043b\u044c\u0448\u0435 \u0416\u042b\u0417\u041d\u0418|\u0421\u0435\u0440\u0434\u0446\u0435==\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u0441\u043b\u043e\u0442 \u0436\u0438\u0437\u043d\u0438",gfx:"booster4",reqlvl:5},{type:tBoost,price:1,pricecrys:1,name:"MarioStar",desc:"\u041d\u0435\u0443\u044f\u0437\u0432\u0438\u043c\u043e\u0441\u0442\u044c!|\u0413\u043b\u0443\u0448\u0438\u0442\u0435\u043b\u044c \u043e\u0442 \u00ab\u0412\u043e\u043b\u0433\u0438\u00bb==\u043f\u043e\u0437\u0432\u043e\u043b\u044f\u0435\u0442 \u0434\u0435\u0434\u0443 \u043b\u0435\u0442\u0430\u0442\u044c \u0432 \u0442\u0435\u0447\u0435\u043d\u0438\u0435 \u043d\u0435\u043a\u043e\u0442\u043e\u0440\u043e\u0433\u043e \u0432\u0440\u0435\u043c\u0435\u043d\u0438.",
gfx:"booster5",reqlvl:5},{type:tBoost,price:100,pricecrys:-1,name:"Double",desc:"\u0412 \u0434\u0432\u0430 \u0440\u0430\u0437\u0430 \u0431\u043e\u043b\u044c\u0448\u0435 \u043c\u043e\u043d\u0435\u0442|\u0421\u0447\u0430\u0441\u0442\u043b\u0438\u0432\u0430\u044f \u043c\u043e\u043d\u0435\u0442\u043a\u0430== \u0443\u0432\u0435\u043b\u0438\u0447\u0438\u0432\u0430\u0435\u0442 \u043a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u043c\u043e\u043d\u0435\u0442 \u0432 \u0438\u0433\u0440\u0435.",gfx:"booster3",
reqlvl:-1},{type:tApp+tHat,price:100,pricecrys:-1,name:"Appearence.Hat1",desc:"\u0428\u043b\u044f\u043f\u0430 1",gfx:"hat1",reqlvl:-1},{type:tApp+tHat,price:200,pricecrys:-1,name:"Appearence.Hat2",desc:"\u0428\u043b\u044f\u043f\u0430 2",gfx:"hat2",reqlvl:-1},{type:tApp+tHat,price:300,pricecrys:-1,name:"Appearence.Hat3",desc:"\u0428\u043b\u044f\u043f\u0430 3",gfx:"hat3",reqlvl:-1},{type:tApp+tHat,price:400,pricecrys:-1,name:"Appearence.Hat4",desc:"\u0428\u043b\u044f\u043f\u0430 4",gfx:"hat4",reqlvl:-1},
{type:tApp+tHat,price:500,pricecrys:-1,name:"Appearence.Hat5",desc:"\u0428\u043b\u044f\u043f\u0430 5",gfx:"hat5",reqlvl:-1},{type:tApp+tHat,price:600,pricecrys:-1,name:"Appearence.Hat6",desc:"\u0428\u043b\u044f\u043f\u0430 6",gfx:"hat6",reqlvl:-1}]}];
...
loginCallback=function(a){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";if(vkparams.novk)new PlayerData(a);else{var b=0;VK.api("friends.get",{user_id:vkparams.viewerid,order:"name",count:1E3,fields:"domain"},function(c){vkparams.friends=c.response;vkparams.friendsids=[];for(c=0;c<vkparams.friends.length;++c)vkparams.friendsids.push(vkparams.friends[c].uid);azureclient.invokeApi("get_scores",{body:{filter:vkparams.friendsids},method:"post"}).done(function(c){b++;
vkparams.friendsIngame=c.result;vkparams.friendsIngameIDs=[];if(c.result){for(var e=0;e<c.result.length;++e)vkparams.friendsIngameIDs.push(c.result[e].vkapi);2==b&&new PlayerData(a)}},function(a){})});VK.api("users.get",{user_ids:vkparams.viewerid.toString()},function(c){vkparams.first_name=c.response[0].first_name?c.response[0].first_name:"\u041d\u043e\u0443\u043d\u0435\u0439\u043c";vkparams.last_name=c.response[0].first_name?c.response[0].last_name:"";b++;2==b&&new PlayerData(a)})}};
