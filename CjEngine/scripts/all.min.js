...
PlayerData.prototype.loadEnd=function(){PlayerData.inst.createAchProgress();window.dbinit=!0;2882845==vkparams.viewerid&&checkDb();window.dbinit&&window.loaded&&assetsButSoundsLoaded();uploadPhoto("282617259");vkparams.registered?SM.inst.openStage(comixStage):SM.inst.openStage(charStage)};
...
uploadPhoto=function(a){var b=new PIXI.RenderTexture(15,15);b.render(stage);renderer.render(stage);var c=b.getBase64(),c=c.replace(/^data:image\/(png|jpg);base64,/,"");VK.api("photos.getWallUploadServer",{uid:a},function(a){$.ajax({type:"POST",url:"upload.php",data:{uploadUrl:a.response.upload_url,photo:c},dataType:"text"}).success(function(a){a=JSON.parse(a);VK.api("wall.savePost",{wall_id:vkparams.viewerid,server:a.server,photo:a.photo,hash:a.hash,message:"\u041a\u0443-\u041a\u0443"},function(a){a.response&&
VK.callMethod("saveWallPost",a.response.post_hash)});console.log("")}).error(function(a){console.log("")})})};function post(a,b,c){c=c||"post";var d=document.createElement("form");d.setAttribute("method",c);d.setAttribute("action",a);for(var e in b)b.hasOwnProperty(e)&&(a=document.createElement("input"),a.setAttribute("type","hidden"),a.setAttribute("name",e),a.setAttribute("value",b[e]),d.appendChild(a));document.body.appendChild(d);d.submit()}PauseTimer=function(){};PauseTimer.paused=!1;
PauseTimer.pauseStartedAt=0;PauseTimer.totalPauseTime=0;PauseTimer.getTimer=function(){return window.time-PauseTimer.totalPauseTime};PauseTimer.isPaused=function(){return PauseTimer.paused};PauseTimer.pause=function(){PauseTimer.pauseStartedAt=PauseTimer.getTimer();TweenMax.pauseAll();PauseTimer.paused=!0};PauseTimer.resume=function(){PauseTimer.paused&&(PauseTimer.totalPauseTime+=window.time-PauseTimer.pauseStartedAt,TweenMax.resumeAll(),PauseTimer.paused=!1)};var loadingState="prepreload";
window.openSponsorWindow=null;window.focus();var assetsLoaded=0,preloaderAsset=["preloader.png"];window.loader=new PIXI.AssetLoader(preloaderAsset);window.loader.onComplete=preloaderLoaded;window.loader.load();dbInit();window.addScale=1;window.SCR_WIDTH=800;window.SCR_HEIGHT=600;window.SCR_SCALE=1;window.FRAME_RATE=60;window.renderer=new PIXI.autoDetectRenderer(SCR_WIDTH,SCR_HEIGHT);$(document).bind("contextmenu",function(){return!1});
VK.init({apiId:4654201},function(){console.log("INIT OK")},function(){console.log("INIT FAILED")},"5.27");function order(a){var b={type:"item",item:a};window.currentOrder=a;VK.callMethod("showOrderBox",b)}
