...
{};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&(vkparams.viewerid=vkparams.viewerid.toString());vkparams.viewerid&&VK||(vkparams.viewerid="CARLSON",MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");
console.log("login / register user");var a=getCookie("LOGIN_DATA"),a=decodeURIComponent(a),a=a.replace(/\+/g," "),a=a.replace(/@/g,"+"),a=JSON.parse(a);vkparams.token=a.tokenJWT;vkparams.registered=a.registered;vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.playerItem.id;PlayerData.inst.playerItem=PlayerData.inst.intJSON(a.playerItem);PlayerData.inst.playerItem.money=Math.round(PlayerData.inst.playerItem.money);PlayerData.inst.playerItem.crystals||
