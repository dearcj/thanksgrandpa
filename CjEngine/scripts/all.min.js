...
var ZSound={available:!1,loaded:!1,Init:function(a){ZSound.available=createjs.Sound.initializeDefaultPlugins();ZSound.available?(createjs.Sound.alternateExtensions=["mp3"],ZSound.loaded=0,ZSound.total=a.length,createjs.Sound.addEventListener("fileload",function(){ZSound.loaded++;ZSound.loaded==a.length&&ZSound.soundLoadedFunction&&(ZSound.loaded=!0,ZSound.soundLoadedFunction())}),createjs.Sound.registerSounds(a,"res/snd/")):ZSound.loaded=!0},PlayMusic:function(a){ZSound.loaded?ZSound.PlayMusicInner(a):
soundLoadedFunction=function(){ZSound.PlayMusicInner(a);ZSound.loaded=!0}},UnMute:function(){ZSound.available||(ZSound.available=!0,createjs.Sound.setMute(!1))},Mute:function(){ZSound.available=!1;createjs.Sound.setMute(!0)},PlayMusicInner:function(a){if(ZSound.musicInstanceName!=a||!ZSound.musicInstance){ZSound.musicInstance&&createjs.Sound.stop(ZSound.musicInstance);try{ZSound.musicInstanceName=a,ZSound.musicInstance=createjs.Sound.play(a,{interrupt:createjs.Sound.INTERRUPT_NONE,loop:999999})}catch(b){}}},
Play:function(a){if(ZSound.available)try{createjs.Sound.play(a,createjs.Sound.INTERRUPT_NONE,0,0,!1,1)}catch(b){}}};LevelManager=function(){};LevelManager.onComplete=function(){LevelManager.layer||(LevelManager.layer=SM.inst.ol);CObj.AssignTexturesToObjects(LevelManager.objs,LevelManager.layer);for(var a=0;a<LevelManager.objs.length;++a)LevelManager.objs[a].init();if(LevelManager.onVeryComplete)LevelManager.onVeryComplete()};
