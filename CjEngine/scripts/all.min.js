...
CObj.getById("bpubl").click=function(){OpenInNewTab("https://vk.com/thanksgradpa")};charStage.updateMusicButton(CObj.getById("bmusic"));CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("btnfight").click=function(){if(1<=PlayerData.inst.playerItem.energy)--PlayerData.inst.playerItem.energy,PlayerData.inst.savePlayerData(),SM.inst.openStage(gameStage);
else{var a=CObj.getById("tfenergy"),c=CObj.getById("energyback");new TweenMax(a,.1,{y:a.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});new TweenMax(c,.1,{y:c.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});charStage.openEnergyWindow()}};var a=new CPlayer(SCR_WIDTH/2,430);charStage.pl=a;a.gfx.scale.x=.34;a.gfx.scale.y=.34;a.updateAppearence(!0,!1,"breath");SM.inst.ol.addChild(a.gfx);a.gfx.interactive=!0;CObj.getById("bsofa").click=function(){CObj.enableButtons(!1);charStage.disableWnd=SM.inst.addDisableWindow(null,
SM.inst.fontLayer);charStage.disableWnd.interactive=!0;for(var a=0;a<CObj.objects.length;++a)CObj.checkType(CObj.objects[a],CEActionGUI)&&CObj.objects[a].btnReward&&(CObj.objects[a].btnReward.gfx.interactive=!0);charStage.closeEventsWnd=function(){rp(charStage.disableWnd);noc(charStage.disableWnd);CObj.enableButtons(!0);charStage.bar.gfx.visible=!1};onc(charStage.disableWnd,function(a){var b=charStage.bar;window.mouseX=a.global.x/SCR_SCALE;window.mouseY=a.global.y/SCR_SCALE;window.mouseX>b.x-b.gfx.width/
2&&window.mouseX<b.x+b.gfx.width/2&&window.mouseY>b.y-b.gfx.height/2&&window.mouseY<b.y+b.gfx.height/2||charStage.closeEventsWnd()});charStage.bar.gfx.parent.removeChild(charStage.bar.gfx);SM.inst.fontLayer.addChild(charStage.bar.gfx);charStage.bar.gfx.visible=!0;charStage.unreadActions=!1;charStage.updateNotifications()};PlayerData.inst.comboCheck();charStage.bar=new CScrollbar(180,309,"",380,524,"podlozhka actions.png","scroll line actions.png","scroll.png",50);charStage.bar.gfx.scale.x=.7;charStage.bar.gfx.scale.y=
.7;charStage.bar.gfx.visible=!1;charStage.updateEvents();shopStage.updateStatsPanel();MOBILE||(charStage.frp=charStage.createFriendsPanel())};
...
"energywindow.json",LevelManager.levFolder+"settings.json",LevelManager.levFolder+"levelpremium.json",LevelManager.levFolder+"levelup.json",LevelManager.levFolder+"levach.json",LevelManager.levFolder+"levshop.json",LevelManager.levFolder+"hud.json",LevelManager.levFolder+"plantPart1.json",LevelManager.levFolder+"plantPart2.json",LevelManager.levFolder+"levelmenu.json",LevelManager.levFolder+"levelwin.json",LevelManager.levFolder+"levelgameover.json",LevelManager.levFolder+"rotatescreen.json",LevelManager.levFolder+
"levchar.json",LevelManager.levFolder+"levscore.json",LevelManager.levFolder+"upperPanel.json",LevelManager.levFolder+"loading.json","imgtps/comix.json","imgtps/bg.json","imgtps/guiatlas.json","imgtps/pussyatlas.json","imgtps/dedgamedesc.xml","imgtps/dedgamecaps.xml","imgtps/dedgameXP.xml","imgtps/skeleton.json","imgtps/boss1.json","imgtps/bird.json"];window.prevW=window.innerWidth;window.prevH=window.innerHeight;window.loader=new PIXI.AssetLoader(assetsToLoader);document.body.appendChild(renderer.view);
PIXI.scaleModes.DEFAULT=0;window.charStage=new CharStage;window.comixStage=new ComixStage;window.scoreStage=new ScoreStage;window.gameStage=new GameStage;window.achStage=new AchStage;window.shopStage=new ShopStage;requestAnimFrame(animate);window.pool=new ZPool;FRAME_DELAY=1E3/FRAME_RATE;window.addEventListener("resize",onWindowResize,!1);window.addEventListener("resizeend",onWindowResize,!1);rescale();onWindowResize();window.lastLoop=0;assetsButSoundsLoaded();loader.onComplete=function(){window.loaded=
