var CG_GROUND=1,CG_MONSTER=2,CG_PLAYER=4,CG_BULLET=8;function getCookie(a){return(a=document.cookie.match(new RegExp("(?:^|; )"+a.replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)")))?decodeURIComponent(a[1]):void 0}function strad(a,b){return parseInt(a)+parseInt(b)}function noc(a,b){a.click=null;a.tap=null}function onc(a,b){a.click=b;a.tap=b}function extractName(a){return a.name?(a.name+" "+a.last_name).substring(0,16):"\u0410\u043d\u043e\u043d\u0438\u043c"}
...
vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");var a=getCookie("LOGIN_DATA"),a=JSON.parse(a);vkparams.token=a.tokenJWT;vkparams.registered=a.registered;vkparams.registered?console.log("user registered"):console.log("user logged in");PlayerData.inst.pid=a.playerItem.id;PlayerData.inst.playerItem=PlayerData.inst.intJSON(a.playerItem);PlayerData.inst.playerItem.crystals||
