...
null,null,{id:c.id,equipped:!0},function(a){console.log("SCORE UPDATED "+a);a&&a.crystals&&a.money&&(PlayerData.inst.playerItem.crystals=a.crystals,PlayerData.inst.playerItem.money=a.money,PlayerData.inst.items_enabled.push({id_item:c.id,id_player:PlayerData.inst.playerItem.id}),shopStage.updateStatsPanel(),PlayerData.inst.equipItem(c,"1"),shopStage.pl.updateAppearence(!0,!1,null,null,null),shopStage.updateBar(shopStage.currentTab,shopStage.currentFilter,shopStage.bar.pos),shopStage.updateStatsPanel());
shopStage.transScreen.parent.removeChild(shopStage.transScreen);shopStage.transScreen=null})):charStage.openPremiumWindow()};
...
PlayerData.prototype.equipItem=function(a,b){for(var c=a.id,d=!1,e=0;e<this.items_enabled.length;++e)this.items_enabled[e].id_item==c&&(d=!0);if(d)for(d=a.type,e=0;e<PlayerData.inst.items_enabled.length;++e)this.getType(PlayerData.inst.items_enabled[e])==d&&(PlayerData.inst.items_enabled[e].id_item==c?PlayerData.inst.items_enabled[e].equipped=b:"1"==PlayerData.inst.items_enabled[e].equipped&&(PlayerData.inst.items_enabled[e].equipped="0"),PlayerData.inst.callDedAPI("UPDATE","tb_item_player",null,
PlayerData.inst.items_enabled[e]))};
...
incMetric("ACH GAINED "+this.achs[d].name));return a};PlayerData.prototype.loadEnd=function(){console.log("LOAD END");window.dbinit=!0;console.log("DB intialized");onAssetsLoaded()};
...
a&&a()});PlayerData.inst.callDedAPI("READ","tb_ach_player",null,null,function(b){PlayerData.inst.achs_progress=PlayerData.inst.intJSON(b);PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()});PlayerData.inst.callDedAPI("READ","tb_item_player",null,null,function(b){PlayerData.inst.items_enabled=PlayerData.inst.intJSON(b);PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a();for(var c=b=!1,d=-1,e=0;e<PlayerData.inst.items_enabled.length;++e)"68AFAEDC-B3E0-401E-9E1A-E272084F2E11"==
PlayerData.inst.items_enabled[e].id_item&&(d=e,b=!0),"0"!=PlayerData.inst.items_enabled[e].equipped&&(c=!0);!c&&b&&(PlayerData.inst.items_enabled[d].equipped=!0);b||(c=!0,0<PlayerData.inst.items_enabled.length&&(c=!1),PlayerData.inst.items_enabled.push({id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.inst.pid,equipped:c}))})};PlayerData.prototype.saveAllData=function(){this.savePlayerData();this.savePlayerItems();this.savePlayerEvents();this.savePlayerAchs()};
...
PlayerData.dbInit=function(){console.log("dbInit start. Connecting to azure");window.vkparams={};vkparams.userid=getURLParameter("user_id");vkparams.sid=getURLParameter("sid");vkparams.viewerid=getURLParameter("viewer_id");vkparams.viewerid&&(vkparams.viewerid=vkparams.viewerid.toString());vkparams.viewerid&&VK||(vkparams.viewerid="2882845",MOBILE&&(vkparams.viewerid=Cocoon.Device.getDeviceId()),vkparams.novk=!0);if("2882845"==vkparams.viewerid||"282617259"==vkparams.viewerid||"197515742"==vkparams.viewerid)vkparams.gamerid=
vkparams.userid||vkparams.viewerid,vkparams.auth_key=getURLParameter("auth_key"),vkparams.refferer=getURLParameter("referrer"),vkparams.accesstoken=getURLParameter("access_token"),console.log("login / register user"),new PlayerData};
