...
PlayerData=function(a){console.log("PlayerData init");this.maxEnergy=10;this.epm=.1;this.delayEnergyMS=3E3;this.xpLevel=[{crystals:1,money:25,xp:0},{crystals:1,money:50,xp:250},{crystals:1,money:100,xp:500},{crystals:1,money:200,xp:1E3},{crystals:2,money:400,xp:2E3},{crystals:2,money:800,xp:2500},{crystals:2,money:1E3,xp:3500},{crystals:2,money:1500,xp:7E3},{crystals:3,money:2E3,xp:12E3},{crystals:3,money:2500,xp:18E3},{crystals:3,money:3E3,xp:19E3},{crystals:3,money:3E3,xp:2E4},{crystals:3,money:3E3,
xp:21E3},{crystals:3,money:3E3,xp:22E3},{crystals:3,money:3E3,xp:23E3},{crystals:3,money:3E3,xp:24E3},{crystals:3,money:3E3,xp:25E3},{crystals:3,money:3E3,xp:26E3},{crystals:3,money:3E3,xp:27E3},{crystals:3,money:3E3,xp:28E3},{crystals:3,money:3E3,xp:29E3},{crystals:3,money:3E3,xp:31E3},{crystals:3,money:3E3,xp:32E3},{crystals:3,money:3E3,xp:33E3},{crystals:3,money:3E3,xp:34E3},{crystals:3,money:3E3,xp:35E3}];this.items={};this.achs={};a&&(this.playerItem=a);this.score=0;PlayerData.inst=this;this.loadData(this.loadEnd);
window.onbeforeunload=function(a){PlayerData.inst.updateEnergy();PlayerData.inst.saveRunProgress()}};PlayerData.prototype.addNotification=function(a,b){window.azureclient.getTable("tb_notifications").insert({message:a,platformid:b})};
...
PlayerData.prototype.updateEnergy=function(){var a=(new Date).getTime()-this.playerItem.updateDate.getTime();this.playerItem.updateDate=new Date;a=a/1E3/60;0<a&&(this.playerItem.energy+=a*this.epm,console.log(this.playerItem.energy),this.playerItem.energy>this.maxEnergy&&(this.playerItem.energy=this.maxEnergy),0>this.playerItem.energy&&(this.playerItem.energy=0),this.savePlayerData());SM.inst.currentStage!=charStage&&SM.inst.currentStage!=shopStage||shopStage.updateStatsPanel();setTimeout(function(){PlayerData.inst.updateEnergy()},
...
PlayerData.getVKfriends=function(a){vkparams.first_name="\u0410\u043d\u043e\u043d\u0438\u043c";vkparams.last_name="";console.log("Gettin vk friends");vkparams.friendsids=[];vkparams.friendsIngameIDs=[];vkparams.novk?new PlayerData(a):VK.api("friends.getAppUsers",{},function(b){if(b.response&&b.response.length){console.log("friends.get data"+JSON.stringify(b.response));b=b.response;for(var c=0;c<b.length;++c)vkparams.friendsids.push(b[c].toString());console.log("VK friends+")}azureclient.invokeApi("get_scores",
{body:{filter:vkparams.friendsids,take:1E3},method:"post"}).done(function(b){vkparams.friendsIngame=b.result;vkparams.friendsIngameIDs=[];if(b.result){for(var c=0;c<b.result.length;++c)vkparams.friendsIngameIDs.push(b.result[c].platformid.toString());PlayerData.getVKuserData(a)}},function(b){PlayerData.getVKuserData(a)})})};
...
vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");PlayerData.azureLogin()};var tWeapon="weap",tPerk="perk",tBoost="boost",tApp="app.",tHat="hat";function checkDb(){}
