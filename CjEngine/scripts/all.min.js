...
xp:22E3},{crystals:3,money:3E3,xp:23E3},{crystals:3,money:3E3,xp:24E3},{crystals:3,money:3E3,xp:25E3},{crystals:3,money:3E3,xp:26E3},{crystals:3,money:3E3,xp:27E3},{crystals:3,money:3E3,xp:28E3},{crystals:3,money:3E3,xp:29E3},{crystals:3,money:3E3,xp:31E3},{crystals:3,money:3E3,xp:32E3},{crystals:3,money:3E3,xp:33E3},{crystals:3,money:3E3,xp:34E3},{crystals:3,money:3E3,xp:35E3}];this.items={};this.achs={};this.score=0;PlayerData.inst=this;PlayerData.inst.azureLogin();window.onbeforeunload=function(a){PlayerData.inst.updateEnergy();
PlayerData.inst.saveRunProgress();PlayerData.inst.updateScore()}};PlayerData.prototype.addNotification=function(a,b){window.azureclient.getTable("tb_notifications").insert({message:a,platformid:b})};
...
incMetric("ACH GAINED "+this.achs[d].name));return a};PlayerData.prototype.loadEnd=function(){PlayerData.inst.updateScore();PlayerData.inst.createAchProgress();window.dbinit=!0;console.log("DB intialized");onAssetsLoaded()};
PlayerData.prototype.updateEnergy=function(){if(this.playerItem){var a=(new Date).getTime()-this.playerItem.updateDate.getTime();this.playerItem.updateDate=new Date;a=a/1E3/60;if(0<a){var b=this.playerItem.energy;this.playerItem.energy+=a*this.epm;console.log(this.playerItem.energy);this.playerItem.energy>this.maxEnergy&&(this.playerItem.energy=this.maxEnergy);0>this.playerItem.energy&&(this.playerItem.energy=0);Math.floor(b)!=Math.floor(this.playerItem.energy)&&this.savePlayerData()}SM.inst.currentStage!=
...
b;PlayerData.inst.items.sort(function(a,b){return a.reqlvl-b.reqlvl});PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_item_player").read().done(function(b){PlayerData.inst.items_enabled=b;for(var c=b=!1,d=-1,e=0;e<PlayerData.inst.items_enabled.length;++e)"68AFAEDC-B3E0-401E-9E1A-E272084F2E11"==PlayerData.inst.items_enabled[e].id_item&&(d=e,b=!0),PlayerData.inst.items_enabled[e].equipped&&(c=!0);!c&&b&&(PlayerData.inst.items_enabled[d].equipped=
!0);b||(azureclient.invokeApi("buy_item",{body:{id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.inst.pid,equipped:c},method:"post"}).done(function(a){},function(a){}),c=!0,0<PlayerData.inst.items_enabled.length&&(c=!1),PlayerData.inst.items_enabled.push({id_item:"68AFAEDC-B3E0-401E-9E1A-E272084F2E11",id_player:PlayerData.inst.pid,equipped:c}));PlayerData.inst.loadCount++;6==PlayerData.inst.loadCount&&a&&a()},function(a){});window.azureclient.getTable("tb_edevent_player").read().done(function(b){PlayerData.inst.eventsplayer=
...
PlayerData.prototype.saveRunProgress=function(){if(SM.inst.currentStage==gameStage&&!gameStage.progressSaved){var a=Math.round(PlayerData.inst.playerItem.maxdistance);LauncherBG.inst.distance>PlayerData.inst.playerItem.maxdistance&&(a=Math.round(LauncherBG.inst.distance));gameStage.progressSaved=!0;PlayerData.inst.playerItem.money+=PlayerData.inst.score;PlayerData.inst.playerItem.maxdistance=a;PlayerData.inst.savePlayerData()}};
...
vkparams.novk=!0);vkparams.gamerid=vkparams.userid||vkparams.viewerid;vkparams.auth_key=getURLParameter("auth_key");vkparams.refferer=getURLParameter("referrer");vkparams.accesstoken=getURLParameter("access_token");console.log("login / register user");new PlayerData};var tWeapon="weap",tPerk="perk",tBoost="boost",tApp="app.",tHat="hat";function checkDb(){}
