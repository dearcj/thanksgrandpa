...
charStage.createFriendsPanel()},CObj.getById("frnext").click=function(){charStage.skipFriends+=5;charStage.frp.parent.removeChild(charStage.frp);charStage.frp=charStage.createFriendsPanel()});MOBILE&&(CObj.getById("bshop").deltaHoverY=46,CObj.getById("bsofa").deltaHoverY=30);CObj.getById("bbuy1").click=charStage.openPremiumWindow;CObj.getById("bbuy2").click=charStage.openPremiumWindow;CObj.getById("tname").text=vkparams.first_name.toUpperCase()+" "+vkparams.last_name.toUpperCase();CObj.getById("bpubl").click=
function(){OpenInNewTab("https://vk.com/thanksgradpa")};charStage.updateMusicButton(CObj.getById("bmusic"));CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("btnfight").click=function(){if(1<=PlayerData.inst.playerItem.energy)--PlayerData.inst.playerItem.energy,PlayerData.inst.savePlayerData(),SM.inst.openStage(gameStage);else{var a=
CObj.getById("tfenergy"),c=CObj.getById("energyback");new TweenMax(a,.1,{y:a.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});new TweenMax(c,.1,{y:c.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});charStage.openEnergyWindow()}};var a=new CPlayer(SCR_WIDTH/2,430);charStage.pl=a;a.gfx.scale.x=.34;a.gfx.scale.y=.34;a.updateAppearence(!0,!1,"breath");SM.inst.ol.addChild(a.gfx);a.gfx.interactive=!0;CObj.getById("bsofa").click=function(){CObj.enableButtons(!1);charStage.disableWnd=SM.inst.addDisableWindow(null,
...
CHPBar.prototype.init=function(){this.upperOfsY||(this.upperOfsY=0);this.space=parseInt(this.space);this.gfx?(this.gfx.anchor.x=0,this.gfx.anchor.y=0):this.gfx=new PIXI.DisplayObjectContainer;this.x-=.5*this.gfx.width;this.space||(this.space=0);if(this.upperImage){var a=PIXI.Texture.fromFrame(this.upperImage+".png");this.upperImageClip=this.tile?new PIXI.TilingSprite(a,a.width,a.height):new PIXI.Sprite(a);this.upperImageClip.anchor.x=0;this.upperImageClip.anchor.y=0;this.upperImageClip.height-=this.space;
this.gfx.addChild(this.upperImageClip)}this.prop=1;this.updateGraphics();CObj.prototype.init.call(this)};extend(CLiveObj,CObj,!0);function CLiveObj(a,b,c,d){CObj.debugView&&(this.debugGfx=new PIXI.Graphics,SM.inst.guiLayer.addChild(this.debugGfx));CObj.apply(this,[a,b,c,d]);this._maxHp=this._hp=100;this.bar=null}CLiveObj.prototype.process=function(){CObj.prototype.process.call(this)};CLiveObj.prototype.kill=function(){this.destroy();this.isKilled=!0};
