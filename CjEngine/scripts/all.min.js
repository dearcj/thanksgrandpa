...
.7,{delay:.8,x:a,y:130}),a=function(){e.onActivate()},c&&(a=function(){e.destroy()}),new TweenMax(e.gfx.scale,.7,{delay:.8,x:.3,y:.3,onComplete:a}),SM.inst.guiLayer.addChild(e.gfx))}};
