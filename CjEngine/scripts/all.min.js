...
this.doKeyUp);$(document).mousedown(null);$(document).mouseup(null)});CObj.destroyAll();gameStage.preWinText=null;gameStage.dragObject=null;stage.touchmove=null;stage.mousemove=null;stage.mousedown=null;stage.touchstart=null;stage.mouseup=null;stage.touchend=null;gameStage.pauseSprite&&(gameStage.pauseSprite.parent.removeChild(gameStage.pauseSprite),gameStage.pauseTexture.destroy(!0),gameStage.pauseTexture=null,gameStage.pauseSprite=null);gameStage.distText=null;LauncherBG.inst.destroy();LauncherBG.inst=
null};GameStage.prototype.loseGame=function(){};GameStage.prototype.remGfx=function(a){a&&a.parent&&a.parent.removeChild(a)};GameStage.prototype.updateXP=function(){gameStage.barXP.prop=PlayerData.inst.playerItem.xp/PlayerData.inst.xpLevel[PlayerData.inst.playerItem.lvl].xp};
...
d.name&&(e=CTabletsBooster);var f=new e(30+50*a,SCR_HEIGHT-40,null);f.gfx=crsp(d.gfx);f.gfx.scale.x=.3;f.gfx.scale.y=.3;f.updateGraphics();f.ieid=PlayerData.inst.items_enabled[c].id;var g;if(null==f.activate)f.gfx.tint=7833634;else{if("A"==f.key)var k=b[0];"S"==f.key&&(k=b[1]);"D"==f.key&&(k=b[2]);k&&(g=crsp(k.gfx),g.scale.x=3,g.scale.y=3,g.y=82,g.x=-50,f.gfx.addChild(g))}SM.inst.guiLayer.addChild(f.gfx);a++}d.type==tWeapon&&PlayerData.inst.items_enabled[c].equipped&&("Rifle"==d.name&&(gameStage.curweapon=
...
a.gfx.mouseout=function(b){a.gfx.tint=16777215;new TweenMax(a.gfx.scale,.3,{x:d,y:e,ease:Elastic.easeOut})};var f=new PIXI.Sprite(PIXI.Texture.fromFrame("bodrost star.png"));f.anchor.x=.5;f.anchor.y=.5;f.x=SCR_WIDTH/2;f.y=SCR_HEIGHT/2+120;SM.inst.guiLayer.addChild(f);var g=Math.round(2+LauncherBG.inst.distance/250),k=CTextField.createTextField({text:g.toString(),fontSize:22,align:"center"});k.tint=3355443;k.updateText();k.x=8+SCR_WIDTH/2;k.y=SCR_HEIGHT/2+107;SM.inst.guiLayer.addChild(k)}};
...
gameStage.visibleAllText=function(a){for(var b=0;b<SM.inst.fontLayer.children.length;++b)SM.inst.fontLayer.children[b].visible=a};gameStage.menuBtn=CObj.getById("menu");gameStage.menuBtn.click=function(){gameStage.doProcess&&gameStage.doPhys&&(gameStage.state="paused",gameStage.pause(),gameStage.fadeScreen(),gameStage.visibleAllText(!1),TweenMax.killTweensOf(gameStage.menuBtn,!0),LevelManager.loadLevel("levelmenu",gameStage.makePause,SM.inst.fontLayer))};var b=function(a){1==a.which&&(gameStage.fireState=
!0);3==a.which&&gameStage.rightReleased&&(gameStage.rightReleased=!1,gameStage.player.onJump())},c=function(a){3==a.which&&(gameStage.rightReleased=!0);1==a.which&&(gameStage.fireState=!1,gameStage.player&&gameStage.player.weapon.mouseUp())},d=gameStage.doKeyDown,e=gameStage.doKeyUp;$(function(){$(document).on("keydown",d);$(document).on("keyup",e);$(document).mousedown(b);$(document).mouseup(c)});gameStage.updateXP()};
...
LevelManager.loadLevel("settings",function(){CObj.getById("bcallback").click=function(){window.location.href="mailto:thanksgrandpa@gmail.com";window.open("mailto:thanksgrandpa@gmail.com","mail")};CObj.getById("bmusic").click=function(){ZSound.available?ZSound.Mute():ZSound.UnMute()};a.click=function(){var d=CObj.getById("setbg");if(!(window.mouseX>d.x-d.gfx.width/2&&window.mouseX<d.x+d.gfx.width/2&&window.mouseY>d.y-d.gfx.height/2&&window.mouseY<d.y+d.gfx.height/2)){rp(a);CObj.enableButtons(!0);for(d=
0;d<c.length;++d)c[d].destroy();a.click=null}}},SM.inst.fontLayer)};CObj.getById("bshop").click=function(){SM.inst.openStage(shopStage)};CObj.getById("bscore").click=function(){charStage.openScore()};CObj.getById("btnachs").click=function(){SM.inst.openStage(achStage)};CObj.getById("btnfight").click=function(){if(1<=PlayerData.inst.playerItem.energy)--PlayerData.inst.playerItem.energy,SM.inst.openStage(gameStage);else{var a=CObj.getById("tfenergy"),c=CObj.getById("energyback");new TweenMax(a,.1,{y:a.y-
10,repeat:3,yoyo:!0,ease:Linear.easeInOut});new TweenMax(c,.1,{y:c.y-10,repeat:3,yoyo:!0,ease:Linear.easeInOut});charStage.openEnergyWindow()}};var a=new CPlayer(400,430);charStage.pl=a;a.gfx.scale.x=.34;a.gfx.scale.y=.34;a.updateAppearence(!0,!1,"breath");SM.inst.ol.addChild(a.gfx);a.gfx.interactive=!0;CObj.getById("bsofa").click=function(){CObj.enableButtons(!1);var a=SM.inst.addDisableWindow(null,SM.inst.fontLayer);a.interactive=!0;for(var c=0;c<CObj.objects.length;++c)CObj.checkType(CObj.objects[c],
CEActionGUI)&&CObj.objects[c].btnReward&&(CObj.objects[c].btnReward.gfx.interactive=!0);charStage.closeEventsWnd=function(){a.parent.removeChild(a);CObj.enableButtons(!0);charStage.bar.gfx.visible=!1};a.click=function(){var a=charStage.bar;window.mouseX>a.x-a.gfx.width/2&&window.mouseX<a.x+a.gfx.width/2&&window.mouseY>a.y-a.gfx.height/2&&window.mouseY<a.y+a.gfx.height/2||charStage.closeEventsWnd()};charStage.bar.gfx.parent.removeChild(charStage.bar.gfx);SM.inst.fontLayer.addChild(charStage.bar.gfx);
charStage.bar.gfx.visible=!0};PlayerData.inst.comboCheck();charStage.bar=new CScrollbar(180,309,"",380,524,"podlozhka actions.png","scroll line actions.png","scroll.png",50);charStage.bar.gfx.scale.x=.7;charStage.bar.gfx.scale.y=.7;charStage.bar.gfx.visible=!1;charStage.updateEvents();shopStage.updateStatsPanel();charStage.frp=charStage.createFriendsPanel()};
...
CharStage.prototype.updateSB=function(a){for(;0<charStage.container.children.length;)rp(charStage.container.getChildAt(0));for(var b=[],c="",d=0;d<a.length;++d){var e=new PIXI.DisplayObjectContainer,f=CTextField.createTextField({tint:3355443,fontSize:15,text:(charStage.skip+d+1).toString()+"."}),g=CTextField.createTextField({tint:3355443,fontSize:15,text:a[d].name+" "+a[d].last_name}),k=CTextField.createTextField({tint:3355443,fontSize:15,text:Math.round(a[d].maxdistance).toString()+"\u043c."}),h=
crsp("buy small button");b.push(h);b[d].vkapi=a[d].vkapi;""!=c&&(c+=",");c+=a[d].vkapi;if(3>charStage.skip+d){var l;0==charStage.skip+d&&(l="1st place");1==charStage.skip+d&&(l="2nd place");2==charStage.skip+d&&(l="3rd place");var m=crsp(l);m.x=4;m.y=10;m.scale.x=.8;m.scale.y=.8;e.addChild(m)}h.y=10;h.x=35;e.x=20;e.y=15+28*d;g.x=55;k.x=370;e.addChild(h);e.addChild(g);e.addChild(f);e.addChild(k);charStage.container.addChild(e)}VK&&""!=c&&VK.api("users.get",{user_ids:c,fields:"photo"},function(a){if(a.response)for(var c=
...
c.item=a};f.mouseout=function(b){b=CObj.getById("tfdescd");b.item==a&&b.setTextSafe("");a.type!=tWeapon&&a.type!=tApp+tHat||shopStage.pl.updateAppearence(!0,!1,null,null,null);f.tint=16777215;f.currentFrame&&f.gotoAndStop(1);new TweenMax(f.scale,.3,{x:.5,y:.5,ease:Elastic.easeOut})};var g=this.checkOwned(a),k=this.checkEq(a);tftext="";g||(tftext=0>a.pricecrys&&0>a.price?"":0<a.pricecrys?a.pricecrys.toString():a.price.toString());var h,l="",m=0,n="buy button";g?(m=-45,1==k?n="equipped button":(h=c,
n="wear button"),"bstuff"==shopStage.currentTab&&(n="equipped button")):a.reqlvl>PlayerData.inst.playerItem.lvl?(h=b,n="unlock button",l="\u041c\u0418\u041d "+a.reqlvl.toString()+" \u0423\u0420."):(h=d,n="buy button",m=-15);g=new CButton(0,182+m,n);"equipped button"==n&&(g.gfx.mouseout=null,g.gfx.mouseover=null);g.fontSize=33;g.addToSameLayer=!0;g.gfx.anchor.x=.5;g.gfx.anchor.y=.5;g.gfx.scale.x=.8;g.gfx.scale.y=.8;g.init();g.gfx.parent.removeChild(g.gfx);g.item=a;g.gfx.btn=g;g.click=h;e.addChild(g.gfx);
g.text&&(g.text=g.text);e.btn=g;if(tftext){if(0<a.price)var p="price coin.png";0<a.pricecrys&&(p="price star.png");p&&(h=crsp(p),h.x=0,h.y=110,e.addChild(h))}h=new CTextField;h.tint="0x333333";h.fontSize=15;h.align="center";h.init();e.infoTF=h;h.x=0;h.y=135;h.gfx.parent.removeChild(h.gfx);h.text=l;e.addChild(h.gfx);l=new CTextField;l.tint="0x333333";l.fontSize=17;l.align="left";l.text=tftext;l.init();e.tfprice=l;l.x=2;l.y=100;l.gfx.parent.removeChild(l.gfx);e.addChild(l.gfx);l.text=l.text;e.destroy=
function(){e.tfprice.destroy();e.btn&&(e.btn.destroy(),e.btn=null);e.tfprice=null;e.parent.removeChild(e)};return e};
...
CBullet.prototype.collide=function(a){if(a&&this.prevVictim!=a){a.dealDamage(this.dmg);if(a.metall){var b=pool.Pop("fxsmallblink");b&&(b.animationSpeed=.45)}else if(b=pool.Pop("blood"))b.animationSpeed=.55;if(b){var c=new CObj(this.x,this.y,null);b.loop=!1;b.gotoAndPlay(0);c.gfx=b;c.updateGraphics();SM.inst.fg.addChild(b);c.return2Pool=c.gfx;c.gfx.lifeTime=800;c.gfx.onComplete=function(){c.destroy()}}this.life--;this.dmg*=.66;0>=this.life&&this.destroy();this.prevVictim=a}};
...
(this.maxVelocity+=this.speedUpCoef,this.speedUpCoef*=.95));MM.inst.currentBoss||(this.distance+=b);a=this.levCycles[0].layers.length;for(b=0;b<a;++b){var c=this.levCycles[0].layers[b];c.curDist+=c.velocity;c.rightBound-=c.velocity;for(var d=0;d<c.clip.children.length;++d){var e=c.clip.children[d];e.x-=c.velocity}for(d=0;d<c.clip.children.length;++d)e=c.clip.children[d],e.position.x+.5*e.width<this.x&&c.clip.removeChild(c.clip.getChildAt(d));for(var e=c.minx+c.curDist-Math.floor(c.curDist/c.width)*
c.width,f=e-c.velocity,d=0;d<c.objects.length;++d){var g=c.objects[d],k=g.x-g.scaleX*g.baseDim.x/2;k>=f&&k<e&&this.spawnClip(c,g,null,e,k-f)}if(4==b&&this.graves)for(d=this.graves.length,e=0;e<d;++e)this.distance>this.graves[e].dist-(SCR_WIDTH+100)*this.pixToDist&&(f=crsp("grave"),f.x=SCR_WIDTH+100,f.y=395,c.clip.addChild(f),g=CTextField.createTextField({fontFamily:"dedgamecaps",tint:"0xFFFFFFFF",text:this.graves[e].text+"\n"+this.graves[e].dist.toString()+" \u043c.",fontSize:30,align:"center"}),
g.x=-g.width/2,g.updateText(),f.addChild(g),this.graves.splice(e,1),e--,d--)}}};
...
CGrenade.prototype.addSmoke=function(a){if(!this.doRemove){var b=this;TweenMax.delayedCall(.02,function(){b.addSmoke()});if(a=pool.Pop("smoke")){var c=new CObj(this.x,this.y,null);c.gfx=a;c.updateGraphics();a.alpha=1;LauncherBG.inst.ol.addChild(c.gfx);c.return2Pool=c.gfx;c.gfx.lifeTime=800;new TweenMax(c.gfx,.2,{alpha:0,onComplete:function(){c.destroy()}})}}};
CGrenade.makeBoom=function(a,b,c,d,e){ZSound.Play("grenade");var f=pool.Pop("expl");if(f){var g=new CObj(a,b,null);f.loop=!1;f.gotoAndPlay(0);g.allowTrackSpeed=!0;g.gfx=f;g.updateGraphics();SM.inst.fg.addChild(f);g.rotation=Math.random()-.5;f.animationSpeed=.85;g.updateGraphics();g.return2Pool=g.gfx;g.gfx.lifeTime=800;g.gfx.onComplete=function(){g.destroy()}}for(var f=d*d,k=CMonster.list.length,h=0;h<k;++h){var l=CMonster.list[h];if(!l.doRemove&&l!=e){var m=l.x-a,n=l.y-b,m=m*m+n*n;m<f&&(m=Math.sqrt(m),
l.dealDamage((d-(m+.01))/d*c));l.doRemove&&(h--,k--)}}this.owner!=gameStage.player&&(m=gameStage.player.x-a,n=gameStage.player.y-b,m*m+n*n<.25*d*d&&gameStage.player.dealDamage(1))};CGrenade.prototype.collide=function(a){this.owner!=gameStage.player&&a&&CObj.checkType(a,CMonster)||a==this.owner||(CGrenade.makeBoom(this.x,this.y,this.dmg,350,this.owner),this.destroy())};CGrenade.prototype.destroy=function(){CBullet.prototype.destroy.call(this)};
...
100,ease:Sine.easeIn,onComplete:function(){rp(b)}});gameStage.updateScore();this.gravityEnabled=!1;this.vy=this.vx=0;this.allowTrackSpeed=!1;a=pool.Pop("coinCollect");ZSound.Play("coin");if(a){rp(a);rp(this.gfx);a.loop=!1;a.gotoAndStop(0);a.gotoAndPlay(0);this.gfx=a;this.updateGraphics();SM.inst.fg.addChild(a);a.animationSpeed=.5;this.updateGraphics();var c=this;c.return2Pool=c.gfx;c.gfx.lifeTime=800;c.gfx.onComplete=function(){c.destroy()}}else this.destroy()}};extend(CMonster,CLiveObj,!0);
...
CMonster.prototype.kill=function(){if(this&&!this.prekilled){if(this.spawnCoins){var a=5;gameStage.player.doubleBooster&&(a=10);for(var b=0;b<a;++b).3<Math.random()||CCoin.spawnCoin(this.x,this.y,this.coinAmount)}this.prekilled=!0;this.bar&&new TweenMax(this.bar.gfx,.2,{width:3*this.bar.gfx.width,height:0});PlayerData.inst.progressAch("Gold medal 10",.01,!1);PlayerData.inst.progressAch("Gold medal 11",.005,!1);PlayerData.inst.gainExp(this.xp);a=this.gfx.parent;a.removeChild(this.gfx);if(bloodgfx=
pool.Pop("bloodblow")){this.gfx=bloodgfx;this.gfx.anchor.x=.5;this.gfx.anchor.y=.5;this.gfx.scale.x=1.8;this.gfx.scale.y=1.8;this.gfx.animationSpeed=.6;this.updateGraphics();a.addChild(this.gfx);this.gfx.loop=!1;this.gfx.gotoAndPlay(0);var c=this;this.return2Pool=this.gfx;this.gfx.lifeTime=800;this.gfx.onComplete=function(){c.destroy()}}else CLiveObj.prototype.kill.call(this);this.updateGraphics()}};
...
function Boss2(a,b,c,d){Boss1.apply(this,[a,b,c,null]);this.hp=this.maxHp=1600;this.xp=700;this.gfx.skeleton.setAttachment("b_legs","b_legs1");this.gfx.skeleton.setAttachment("b_body","b_body1");this.gfx.skeleton.setAttachment("b_head","b_head1");this.gfx.skeleton.setAttachment("b_top_body","b_top_body1");this.gfx.skeleton.setAttachment("b_low_arm","b_low_arm1");this.gfx.skeleton.setAttachment("b_low_arm","b_low_arm1");this.gfx.skeleton.setAttachment("b_bomb","b_bomb");this.setRandDisp()}
...
MM=function(){this.patterns=[{mons:"f..f00szf..000",diff:1,prob:1},{mons:"s.s..ssc..ss000",diff:1,prob:1},{mons:".g..s.gs.l.l.",diff:1,prob:1},{mons:".s..s..s..c",diff:1,prob:1},{mons:".s00z00s..z",diff:1,prob:1},{mons:".b..b..c..b.b.",diff:1,prob:1},{mons:".ss..ss.s..l...ss..l.l..s",diff:1,prob:1},{mons:".l..zz.ss.c.",diff:1,prob:1},{mons:".c.gc..",diff:1,prob:1},{mons:".c..c..o000s.s.",diff:1,prob:1},{mons:".z...c.s.s.sc..",diff:2,prob:1},{mons:".z...c.z..",diff:2,prob:1},{mons:"j",diff:2,prob:.1},
{mons:".lbb..c.",diff:2,prob:1},{mons:".c..?.?.?.",diff:2,prob:1},{mons:".f...z...f..c.",diff:2,prob:1},{mons:".l.lz..c..z..c...c..s..l..s.l",diff:2,prob:1},{mons:".lsslss0000l00l.l..",diff:3,prob:1},{mons:".o..lo..l..",diff:3,prob:1},{mons:".c.g..gl",diff:3,prob:1},{mons:"..f..f.z.o..f..",diff:3,prob:1},{mons:"jd..df...f.",diff:4,prob:1},{mons:"..dz..d..z.z",diff:4,prob:1},{mons:".F..l.l.F..l.",diff:4,prob:1},{mons:".b.bf..",diff:4,prob:.1},{mons:"..s.sss..s..l",diff:4,prob:1},{mons:"l.l.l...ssl.lbl.l.",
diff:4,prob:1},{mons:"f..c.flf.c00",diff:5,prob:1},{mons:".c..c..z..s..sc..sc..sc..",diff:5,prob:1},{mons:".f.ffc..c..",diff:5,prob:1},{mons:".b..bbb..bbbbbbb..",diff:5,prob:.1},{mons:"gg.g...g..g..G.GG.",diff:5,prob:1},{mons:"zzz.z..G.GG.zzz.",diff:5,prob:1},{mons:"..ss..ss.s..lll.ss..l...l...s",diff:6,prob:1},{mons:".b.bf.?.",diff:6,prob:.1},{mons:".c..c.l..g.g00g",diff:6,prob:1},{mons:".c..c..l..g..g..g",diff:6,prob:1},{mons:"j",diff:6,prob:.1},{mons:"..s..s..dss",diff:6,prob:.1},{mons:"h.llH.lzh..H.l.l",
diff:7,prob:1},{mons:".b..bbb..bbbbb000bbbbbbb..",diff:7,prob:.1},{mons:".o.H.H..l..",diff:7,prob:1},{mons:".z..zz...zzz...zzzz.",diff:7,prob:1},{mons:".czgG.gFl...",diff:7,prob:1},{mons:"h..c.hsh.?.",diff:8,prob:1},{mons:".c.b.cbb..lb.gG.Gg..g.",diff:8,prob:1},{mons:"o...ss.s.s.d..o.o..",diff:8,prob:1},{mons:"Fz.Fz.zFz.",diff:8,prob:1},{mons:"bb..o..b.o.H.h..c",diff:9,prob:1}];this.bosses=[{cls:Boss2,dist:1E3},{cls:Boss2,dist:2E3}];this.monY=360;this.sNormal=1;this.sBoss=2;this.lastSpawnPlane=this.lastStep=
0;this.currentBoss=null;this.state=this.sNormal;this.stepDelay=330};MM.inst=new MM;MM.prototype.init=function(){this.simpleRandomSpawn=[this.spawnCoin,this.spawnDrone,this.spawnFatty,this.spawnFatty2,this.spawnGopnick,this.spawnGopnick2,this.spawnSimpleMonster,this.spawnSimpleMonster,this.spawnSimpleMonster];this.bossDistance=0;this.monsterQueue=MM.inst.generateMonsterQueue()};
...
MM.prototype.generateMonsterQueue=function(){MM.debugArray=[];for(var a=[],b=1;9>=b;++b)a.push({diff:b,prob0:0,prob1:0});for(var c=[],d=0,e=PlayerData.inst.playerItem.lvl/4.5-.5,f,b=0;3E3>b;++b){var g=d/200;g>a.length&&(g=a.length);for(var k=Math.sin(d/50)*(1+.05*g)+g+e,h=g=0;h<a.length;++h){var l=1/(Math.abs(a[h].diff-k)+1),l=Math.pow(l,1.7);0<h?(a[h].prob1=a[h-1].prob1+l,a[h].prob0=a[h-1].prob1):(a[h].prob1=l,a[h].prob0=0);g+=l}l=Math.random()*g;for(h=0;h<a.length&&!(l>a[h].prob0&&l<=a[h].prob1);++h);
for(var g=0,m=a[h].diff,k=a[h].prob1-a[h].prob0,h=0;h<this.patterns.length;++h)this.patterns[h].diff==m&&(l=this.patterns[h].prob,f?(this.patterns[h].prob1=f.prob1+l,this.patterns[h].prob0=f.prob1):(this.patterns[h].prob1=l,this.patterns[h].prob0=0),f=this.patterns[h],g+=l);f=null;l=Math.random()*g;for(h=0;h<this.patterns.length&&!(this.patterns[h].diff==m&&l>this.patterns[h].prob0&&l<=this.patterns[h].prob1);++h);c+=this.patterns[h].mons;MM.debugArray.push({diff:this.patterns[h].diff,start:d,prob:(this.patterns[h].prob1-
this.patterns[h].prob0)/g,probDiff:k});d+=this.patterns[h].mons.length}return c};MM.prototype.spawnObstacle=function(a,b,c,d){a=new CObstacle(SCR_WIDTH+240,450+2*b,a,!1);a.maxHp=1E8;a.hp=a.maxHp;a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.gfx.anchor.y=.5+b/(a.gfx.height/a.gfx.scale.y);a.radius=.94*(a.gfx.width/2-10);d&&(a.radius+=d);a.offsY=-c;a.colGroup=0;a.allowTrackSpeed=!0;this.lastSpawnSimple=(new Date).getTime();this.simpleMonsterDelay=1E3*Math.random()+2E3};
MM.prototype.spawnCoin=function(a){a=new CCoin(SCR_WIDTH+240,428,1);a.vy=0;a.gravityEnabled=!1};MM.prototype.spawnBarrel=function(a,b,c){a=new CBarrel(SCR_WIDTH+240,450+2*b,a,!0);a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.maxHp=70;a.hp=a.maxHp;a.gfx.anchor.y=.5+b/(a.gfx.height/a.gfx.scale.y);a.dmgExpl=250;a.dmg=1;a.radius=a.gfx.width/2+12;a.offsY=-c;a.allowTrackSpeed=!0};
...
MM.prototype.spawnDrone=function(a){a=new CDrone(SCR_WIDTH+100,80,"dron");a.gfx.anchor.x=.5;a.vx=-1;a.allowTrackSpeed=!1;a.gravityEnabled=!1;new TweenMax(a,1,{y:a.y+80,ease:Sine.easeInOut,yoyo:!0,repeat:10});a.maxHp=190;a.hp=a.maxHp;a.barOffsetX=10;a.xp=25+.01*LauncherBG.inst.distance};
MM.prototype.spawnDrone2=function(a){a=new CDrone2(SCR_WIDTH+100,a,"dron2");a.gfx.anchor.x=.5;a.vx=-4;a.allowTrackSpeed=!1;a.gravityEnabled=!1;new TweenMax(a,1,{y:a.y+30,ease:Sine.easeInOut,yoyo:!0,repeat:10});new TweenMax(a,.6,{vx:-12,ease:Sine.easeInOut,yoyo:!0,repeat:5});a.maxHp=100;a.hp=a.maxHp;a.barOffsetX=10;a.xp=25+.01*LauncherBG.inst.distance};
MM.prototype.spawnBonusGnome=function(a){var b=new BonusMonGnome(SCR_WIDTH+100,150,"enemy1_1");b.gfx.scale.x=.8;b.gfx.scale.y=.8;b.maxHp=400;b.hp=b.maxHp;b.xp=a+.01*LauncherBG.inst.distance};MM.prototype.spawnJumpMon=function(){var a=new JumpMon(SCR_WIDTH+120,this.monY-200,"enemy1_2");a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.av=.1*Math.random();a.longJump(1,.25,-1,-3,1.2);a.maxHp=170;a.hp=a.maxHp;a.xp=10+.01*LauncherBG.inst.distance};
MM.prototype.spawnFatty=function(){var a=new CMonster(SCR_WIDTH+100,this.monY,"enemy1");a.rollLeave=!0;a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.longJump(1,.13,-4,-13,1.2);new TweenMax(a,1.2,{rotation:-Math.PI/15});a.maxHp=100;a.hp=a.maxHp;a.xp=10+.01*LauncherBG.inst.distance};
...
MM.prototype.spawnGopnick=function(a){a=new CMonster(SCR_WIDTH+100,this.monY,"enemy3");a.rollLeave=!0;a.jumpTimeCoef=.7;a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.maxHp=60;a.hp=a.maxHp;new TweenMax(a,1.2,{rotation:-Math.PI/15});a.longJump(1,.2,-5-2*Math.random(),-16-2*Math.random(),1.1,0,38);a.xp=11+.01*LauncherBG.inst.distance};
MM.prototype.spawnGopnick2=function(a){a=new CMonster(SCR_WIDTH+100,this.monY,"enemy3_3");a.rollLeave=!0;a.jumpTimeCoef=.6;a.gfx.scale.x=.8;a.gfx.scale.y=.8;a.maxHp=80;a.hp=a.maxHp;new TweenMax(a,1.2,{rotation:-Math.PI/15});a.longJump(1,.2,-8-2*Math.random(),-21-2*Math.random(),.8,0,30);a.xp=17+.01*LauncherBG.inst.distance};MM.prototype.spawnRandomMonster=function(a){getRand(this.simpleRandomSpawn).call(this)};
...
MM.prototype.doStep=function(){var a=this.monsterQueue.charAt(0);this.monsterQueue=this.monsterQueue.slice(1);MM.totalD||(MM.totalD=0);MM.totalD++;for(var b=0;b<MM.debugArray.length;++b)MM.debugArray[b].start==MM.totalD&&console.log("PAT WITH DIFF "+MM.debugArray[b].diff.toString()+" WITH P = "+MM.debugArray[b].prob.toString()+" DIFF P = "+MM.debugArray[b].probDiff.toString());this.diff=LauncherBG.inst.distance/1E3;"s"==a&&this.spawnSimpleMonster(5);"f"==a&&this.spawnFatty();"F"==a&&this.spawnFatty2();
"G"==a&&this.spawnGopnick2();"g"==a&&this.spawnGopnick();"c"==a&&this.spawnCar("car",40,0);"l"==a&&this.spawnObstacle("luke",40,10);"z"==a&&this.spawnObstacle("conus",20,0,-9);"j"==a&&this.spawnBonusGnome(5);"d"==a&&this.spawnDrone();"h"==a&&this.spawnDrone2(120);"H"==a&&this.spawnDrone2(330);"b"==a&&this.spawnBarrel("barrel",20,0,-5);"?"==a&&this.spawnRandomMonster();"0"==a&&this.spawnCoin(440);"o"==a&&this.spawnJumpMon();0==this.monsterQueue.length&&(this.noMonsLeft=!0)};
MM.prototype.process=function(){var a=PauseTimer.getTimer(),b=Math.floor(LauncherBG.inst.distance/4);0==Math.floor(LauncherBG.inst.distance)%250&&.5>Math.random()&&6E4<a-this.lastSpawnPlane&&(this.spawnPlane(),this.lastSpawnPlane=a);b!=this.prevS&&(!this.currentBoss&&0<this.bosses.length&&4*this.prevS-this.bossDistance<this.bosses[0].dist&&LauncherBG.inst.distance-this.bossDistance>=this.bosses[0].dist?(this.currentBoss=new (this.bosses.shift().cls)(SCR_WIDTH+200,500,"imgtps/boss1.json"),this.currentBoss.showUpAnimation()):
...
BonusMonGnome.prototype.dealDamage=function(a){CMonster.prototype.dealDamage.call(this,a);200<PauseTimer.getTimer()-this.lastDrop&&(this.lastDrop=PauseTimer.getTimer(),gameStage.player.doubleBooster?CCoin.spawnCoin(this.x,this.y,6):CCoin.spawnCoin(this.x,this.y,3))};extend(CCoin,CObj,!0);
...
fontSize:17,align:"center"});this.timeleft.x=50;this.timeleft.y=27;this.gfx.addChild(this.timeleft);c=CTextField.createTextField({tint:"0x333333",text:c.toString(),fontSize:16,align:"center"});c.x=120;c.y=-11;this.gfx.addChild(c);var f=this,g=this.ico;g.interactive=!0;var k=g.scale.x,h=g.scale.y;g.mouseover=function(){new TweenMax(g.scale,.6,{y:h+.05,ease:Elastic.easeOut});new TweenMax(g.scale,.4,{x:k+.05,ease:Elastic.easeOut})};g.mouseout=function(){new TweenMax(g.scale,.6,{y:h,ease:Elastic.easeOut});
new TweenMax(g.scale,.4,{x:k,ease:Elastic.easeOut})};g.click=function(){f.ready&&!a.reward_ready&&f.startAction()};this.progressbg.interactive=!0;this.progressbg.click=this.onclick;this.progressbg.tap=this.onclick;null==this.eventpl.lastused&&(this.pos=1);c=CTextField.createTextField({fontFamily:"dedgamedesc",tint:"0x1111111",text:b.desc,fontSize:20,align:"center"});c.x=50;c.y=-55;this.gfx.addChild(c);this.eventpl.reward_ready&&this.addRewardButton();this.progressbg.visible=!1;this.progressfore.visible=
...
CBooster.prototype.onActivate=function(){this.activate=!1;PlayerData.inst.progressAch("Gold medal 5",1,!1);this.startTime=window.time;this.lastTick=0;this.tf=CTextField.createTextField({tint:"0xFFFFFF",text:"AAASA",fontSize:80,align:"center"});this.tf.x=this.tf.width/2;this.tf.y=-40;this.gfx.addChild(this.tf)};
CBooster.prototype.process=function(){if(this.tf){if(1E3<window.time-this.lastTick){this.lastTick=window.time;var a=Math.round(this.duration-(window.time-this.startTime)/1E3);0>a&&(a=0);this.tf.text=a.toString();this.tf.updateText()}this.tf.x=-this.tf.width/2}};extend(CDoubleBooster,CBooster,!0);function CDoubleBooster(a,b,c){CBooster.apply(this,[a,b,c]);this.duration=30;this.key="D";this.activate=!0}
...
CSupermanBooster.prototype.onActivate=function(){if(gameStage.player&&!gameStage.player.jumping){CBooster.prototype.onActivate.call(this);var a=this;new TweenMax(gameStage.player,.84,{y:200,ease:Linear.easeOut,onComplete:function(){gameStage.player.vy=-2;new TweenMax(gameStage.player,a.duration/24,{vy:2,yoyo:!0,repeat:24,ease:Sine.easeInOut})}});gameStage.player.jumping=!0;gameStage.player.gravityEnabled=!1;TweenMax.delayedCall(this.duration,function(){gameStage.player.jumping=!1;gameStage.player.gravityEnabled=
!0;rp(a.fire1);rp(a.fire2);rp(a.fire3);a.fire1=null;a.fire2=null;a.fire3=null;a.onDeactivate()});this.fire1=CObj.createMovieClip("firesmall");this.fire1.x=-314;this.fire1.y=-100;this.fire1.scale.x=3;this.fire1.scale.y=3;this.fire1.loop=!0;this.fire1.gotoAndPlay(0);gameStage.player.gfx.addChildAt(this.fire1,0);this.fire2=CObj.createMovieClip("firesmall");this.fire2.x=-140;this.fire2.y=20;this.fire2.scale.x=3;this.fire2.scale.y=3;this.fire2.loop=!0;this.fire2.gotoAndPlay(0);gameStage.player.gfx.addChildAt(this.fire2,
0);this.fire3=CObj.createMovieClip("firesmall");this.fire3.x=85;this.fire3.y=20;this.fire3.scale.x=3;this.fire3.scale.y=3;this.fire3.loop=!0;this.fire3.gotoAndPlay(0);gameStage.player.gfx.addChildAt(this.fire3,0);gameStage.player.state.setAnimationByName(0,"idle",!0)}};extend(CTabletsBooster,CBooster,!0);function CTabletsBooster(a,b,c){CBooster.apply(this,[a,b,c]);this.duration=4;this.key="A";this.activate=!0}
...
PlayerData.prototype.gainExp=function(a){this.playerItem.xp+=a;if(this.playerItem.xp>=this.xpLevel[this.playerItem.lvl].xp&&this.playerItem.lvl+1<this.xpLevel.length){this.playerItem.xp-=this.xpLevel[this.playerItem.lvl].xp;this.playerItem.crystals+=this.xpLevel[this.playerItem.lvl].crystals;this.playerItem.lvl++;ZSound.Play("levelup");this.score+=this.xpLevel[this.playerItem.lvl].money;if(SM.inst.currentStage==charStage){charStage.closeEventsWnd&&charStage.closeEventsWnd();CObj.enableButtons(!1);
var b=SM.inst.addDisableWindow(null,SM.inst.fontLayer);b.interactive=!0;charStage.closeEventsWnd=function(){b.parent.removeChild(b);CObj.enableButtons(!0)}}SM.inst.currentStage==gameStage&&(gameStage.updateScore(),gameStage.pause());LevelManager.loadLevel("levelup",function(){CObj.getById("moneytf").text=PlayerData.inst.xpLevel[PlayerData.inst.playerItem.lvl].money.toString();CObj.getById("crystalstf").text=PlayerData.inst.xpLevel[PlayerData.inst.playerItem.lvl].crystals.toString();CObj.getById("levnum").text=
PlayerData.inst.playerItem.lvl.toString();CObj.getById("btnclose").click=function(){for(var a=0;a<LevelManager.objs.length;++a)LevelManager.objs[a].destroy();LevelManager.objs=null;SM.inst.currentStage==gameStage?gameStage.unpause():(charStage.closeEventsWnd(),charStage.updateStatsPanel())}},SM.inst.fontLayer)}SM.inst.currentStage==gameStage&&gameStage.updateXP()};
...
a&&a()},function(a){});window.azureclient.getTable("tb_edevent").read().done(function(b){PlayerData.inst.events=b;PlayerData.inst.loadCount++;7==PlayerData.inst.loadCount&&a&&a()},function(a){})};PlayerData.prototype.savePlayerData=function(){this.savePlayerData();this.savePlayerItems();this.savePlayerEvents();this.savePlayerAchs()};
...
vkparams.accesstoken=getURLParameter("access_token");azureclient.invokeApi("login",{body:{vkapi:vkparams.viewerid,ref:vkparams.refferer},method:"post"}).done(function(a){PlayerData.pid=a.result.userId.split(":")[1];azureclient.currentUser={userId:a.result.userId,mobileServiceAuthenticationToken:a.result.token};vkparams.id=a.result.id;loginCallback(a.result)},function(a){})};PauseTimer=function(){};PauseTimer.paused=!1;PauseTimer.pauseStartedAt=0;PauseTimer.totalPauseTime=0;
PauseTimer.getTimer=function(){return window.time-PauseTimer.totalPauseTime};PauseTimer.isPaused=function(){return PauseTimer.paused};PauseTimer.pause=function(){PauseTimer.pauseStartedAt=PauseTimer.getTimer();TweenMax.pauseAll();PauseTimer.paused=!0};PauseTimer.resume=function(){PauseTimer.paused&&(PauseTimer.totalPauseTime+=window.time-PauseTimer.pauseStartedAt,TweenMax.resumeAll(),PauseTimer.paused=!1)};var loadingState="prepreload";window.openSponsorWindow=null;window.focus();
var assetsLoaded=0,preloaderAsset=["preloader.png"];window.loader=new PIXI.AssetLoader(preloaderAsset);window.loader.onComplete=preloaderLoaded;window.loader.load();dbInit();window.addScale=1;window.SCR_WIDTH=800;window.SCR_HEIGHT=600;window.SCR_SCALE=1;window.FRAME_RATE=60;window.renderer=new PIXI.autoDetectRenderer(SCR_WIDTH,SCR_HEIGHT);$(document).bind("contextmenu",function(){return!1});VK.init({apiId:4654201},function(){console.log("INIT OK")},function(){console.log("INIT FAILED")},"5.27");
