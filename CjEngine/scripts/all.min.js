...
PlayerData.inst.saveRunProgress(!0);PlayerData.inst.updateScore(function(a){PlayerData.inst.playerItem.rank=a.rank;PlayerData.inst.savePlayerData()});PlayerData.inst.savePlayerData()}};PlayerData.prototype.addNotification=function(a,b){window.azureclient.getTable("tb_notifications").insert({message:a,platformid:b})};
