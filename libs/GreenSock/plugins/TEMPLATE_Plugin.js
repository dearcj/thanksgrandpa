...
(window._gsQueue || (window._gsQueue = [])).push( function() {
	...
	window._gsDefine.plugin({
		 ...
		 *   3) tween [TweenLite] - the TweenLite (or TweenMax) inst that is managing this plugin inst. This can be useful if you need to check certain state-related properties on the tween (maybe in the set method) like its duration or time. Most of the time, however, you don't need to do anything with the tween. It is provided just in case you want to reference it.
		 *
